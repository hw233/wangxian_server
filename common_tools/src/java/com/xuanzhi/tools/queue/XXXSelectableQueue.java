...
public class XXXSelectableQueue extends DefaultQueue {


	protected long nextTimeout = System.currentTimeMillis();
	
	protected Object att;
	protected XXXQueueSelector selector;
	
	protected int readyNum = 1;
	protected long readyTimeout = 0;
	
	protected int indexOf = -1;
	
	public XXXSelectableQueue(int size) {
		super(size);
	}
	...
	public void register(XXXQueueSelector sel) {
