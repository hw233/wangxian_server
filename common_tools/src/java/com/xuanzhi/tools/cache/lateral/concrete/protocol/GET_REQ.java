 ...
 */
public class GET_REQ implements RequestMessage{
	 ...
	 * @param timeout
	 */
	public GET_REQ(long seqNum,String cacheName,int handleModel,Object key) throws Exception{
		this.seqNum = seqNum;
	 ...
	 * @param size 
	 */
	public GET_REQ(long seqNum,byte[] content,int offset,int size)throws Exception{
		this.seqNum = seqNum;
