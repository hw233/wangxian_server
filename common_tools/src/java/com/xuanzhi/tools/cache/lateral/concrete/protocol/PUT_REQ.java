 ...
 *    value			未知类型，根据实际情况判断
 */
public class PUT_REQ implements RequestMessage{
	 ...
	 * @param timeout
	 */
	public PUT_REQ(long seqNum,String identity,String cacheName,int handleModel,Object key,Object value) throws Exception{
		this.seqNum = seqNum;
	 ...
	 * @param size 
	 */
	public PUT_REQ(long seqNum,byte[] content,int offset,int size)throws Exception{
		this.seqNum = seqNum;
