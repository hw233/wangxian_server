 ...
 */
public class PUT_RES implements ResponseMessage{
	 ...
	 * @param timeout
	 */
	public PUT_RES(long seqNum,String message) throws Exception{
		this.seqNum = seqNum;
		this.result = 0;
	...
	public PUT_RES(long seqNum,Throwable exception) throws Exception{
		this.seqNum = seqNum;
		this.result = 1;
		this.message = null;
	 ...
	 * @param size 
	 */
	public PUT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
