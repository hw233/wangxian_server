 ...
 */
public class MODIFY_RES implements ResponseMessage{
	 ...
	 * @param timeout
	 */
	public MODIFY_RES(long seqNum,String message) throws Exception{
		this.seqNum = seqNum;
		this.result = 0;
	...
	public MODIFY_RES(long seqNum,Throwable exception) throws Exception{
		this.seqNum = seqNum;
		this.result = 1;
		this.message = null;
	 ...
	 * @param size 
	 */
	public MODIFY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
