		    	...
		    	<input type='submit' value='提交'></form>
		    	 ...
		    	 <a href="daoJuJingXiFenXi_vip.jsp">vip用户喝酒信息</a>|
					...
					if ("true".equals(flag)) {  //如果是刚打开页面，不查询
					 List<String []> lbai = daoJuManager.getDaoJuImportant(startDay,endDay,fenqu,daoJuName, "하얀색");  
                     List<String []> llv  = daoJuManager.getDaoJuImportant(startDay,endDay,fenqu,daoJuName, "초록");   
                     List<String []> llan = daoJuManager.getDaoJuImportant(startDay,endDay,fenqu,daoJuName, "파란색");   
                     List<String []> lzi  = daoJuManager.getDaoJuImportant(startDay,endDay,fenqu,daoJuName, "보라"); 
                     List<String []> lceng= daoJuManager.getDaoJuImportant(startDay,endDay,fenqu,daoJuName, "주황색");     
