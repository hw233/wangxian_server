  ...
  <%
    ...
    BufferedReader bufferedreader=new BufferedReader(new InputStreamReader(new  FileInputStream("D:\\ip1.txt"),"UTF-8")); 
    	  ...
    	  Connection con = null;
           ...
           PreparedStatement ps          = con.prepareStatement("insert into LINSHI_FUWU v (ids,username) values(?,?)");
		   try {
		    int i =-1;
		    long num=1L;
         ...
         String strs= instring.replaceAll("\t","").replaceAll("\r","").trim();
         System.out.println(strs);
			...
			con.commit();
			System.out.println("[总共更新充值渠道信息] [OK] [更新"+num+"条] [cost:"+(System.currentTimeMillis()-now)+"ms] 结束！！！");
