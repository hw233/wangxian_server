...
<%@ page
    ...
    <%
     ...
     if ("true".equals(flag)) {  //如果是刚打开页面，不产生下载文件
      ...
      ///////////////////////下载文件 ////////////////////////////////
        String spNumber=startDay+"gamechongzhiYinpiao";
        String basePath =getServletContext().getRealPath("/")+"excel";
         ...
         List<String []> ls=gameChongZhiManager.getGameChongZhiYinZi(startDay);
              for(int j = 0; j < ls.size();j++){
                  String [] strs=(String [])ls.get(j);
                  String contentStr=strs[0]+"\t"+strs[1]+"\t"+strs[2]+"\t"+strs[3]+"\t"+strs[4]+"\r\n";
...
<html>
	...
	<body>
		...
		下载统计日期：<input type='text' name='day' value='<%=startDay %>'>(格式：2012-06-18)
		  <br/><br/>
