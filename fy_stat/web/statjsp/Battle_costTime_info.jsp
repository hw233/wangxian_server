  ...
  <%
	...
	ArrayList<String []> fenQuList  =  (ArrayList<String []>) session.getAttribute("FENQU_LIST");
	  ...
	  if(fenQuList==null)
             ...
             String newsql="select to_char(t.createdate,'YYYY-MM-DD') datestr,t.fenqu,t.type,sum(t.haotiancount) dl,sum(t.wuhuangcount) wh,"
             +" sum(t.lingzuncount) lz,sum(t.guishacount) gs,round(avg(t.costtime)) avgt,min(t.costtime) min from stat_battle_costtime t "
             ...
             newsql +="group by to_char(t.createdate,'YYYY-MM-DD'),t.fenqu,t.type order by to_char(t.createdate,'YYYY-MM-DD'),t.fenqu,t.type";
		  ...
		  结束日期： <input type="text" name="endDay" id="endDay" class="nqz_input" style="width:80px;" readonly="readonly" onfocus="new Calendar(false,'yyyy-MM-dd').showTimePicker(this);" value="<%=endDay %>"/>
		   ...
		   <input type="hidden" name="today" id="today"  value="<%=today %>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                分区：<select name="fenqu">
					...
					out.print("<tr bgcolor='#EEEEBB'><td>日期</td><td>分区</td><td>模式</td><td>斗罗</td><td>巫皇</td><td>灵尊</td><td>鬼煞</td><td>最少耗时</td><td>平均耗时</td></tr>");
					...
					String[] chognzhi=(String[])chongZhiList.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+chognzhi[0]+"</td><td>"+chognzhi[1]+"</td><td>"+chognzhi[2]+"</td><td>"+chognzhi[3]+"</td><td>"+chognzhi[4]+"</td><td>"+chognzhi[5]+"</td><td>"+chognzhi[6]+"</td><td>"+chognzhi[7]+"</td><td>"+chognzhi[8]+"</td>");
						out.println("</tr>");
					}
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>"+moneysum+"</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>");
