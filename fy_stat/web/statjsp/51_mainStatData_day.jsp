...
<%@ page
  ...
  <%
	...
	if(qudao==null||"-1".equals(qudao)){ qudao="51yxsq_MIESHI','51yxsq2_MIESHI','51yxsq3_MIESHI','51yxsq4_MIESHI','51yxsq5_MIESHI','51yxsq6_MIESHI','51yxsq7_MIESHI','51yxsq8_MIESHI','51yxsq9_MIESHI','51yxsq10_MIESHI"; tqudao="-1";   }
	...
	realChannelList.add("游戏币库存");
		...
		if ("true".equals(flag)) {//如果是刚打开页面，不查询
         for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"51"+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        ...
                        <option value="51yxsq_MIESHI" 
                        <%  if("51yxsq_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq_MIESHI</option>
                        
                         <option value="51yxsq2_MIESHI" 
                        <%  if("51yxsq2_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq2_MIESHI</option>
                        
                        <option value="51yxsq3_MIESHI" 
                        <%  if("51yxsq3_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq3_MIESHI</option>
                        
                        <option value="51yxsq4_MIESHI" 
                        <%  if("51yxsq4_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq4_MIESHI</option>
                        
                        <option value="51yxsq5_MIESHI" 
                        <%  if("51yxsq5_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq5_MIESHI</option>
                        
                          <option value="51yxsq6_MIESHI" 
                        <%  if("51yxsq6_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq6_MIESHI</option>
                        
                          <option value="51yxsq7_MIESHI" 
                        <%  if("51yxsq7_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq7_MIESHI</option>
                          <option value="51yxsq8_MIESHI" 
                        <%  if("51yxsq8_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq8_MIESHI</option>
                          <option value="51yxsq9_MIESHI" 
                        <%  if("51yxsq9_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq9_MIESHI</option>
                          <option value="51yxsq10_MIESHI" 
                        <%  if("51yxsq10_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >51yxsq10_MIESHI</option>
