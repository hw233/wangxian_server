...
<%@ page
  ...
  <%
	...
	if(endDay == null) endDay = today;
		     ...
		     List chongZhiList=chongZhiManager.getQuDaoChongZhi(startDay,endDay,qudao,type,cardtype,fenqu);
%>
		...
		<br/><br/>
		       渠道：<select name="qudao">
                 ...
                 for(int i = 0 ; i < cardtypeList.size() ; i++){
					...
					out.print("<tr bgcolor='#EEEEBB'><td>渠道</td><td>独立付费人数</td><td>金额(分)</td></tr>");
					...
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+usercount+"&nbsp;</td><td>"+moneysum+"</td></tr>");
					for(int i = 0 ; i < chongZhiList.size() ; i++){
					String[] chognzhi=(String[])chongZhiList.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+chognzhi[0]+"</td><td>"+chognzhi[2]+"</td><td>"+chognzhi[1]+"</td>");
						out.println("</tr>");
					}
