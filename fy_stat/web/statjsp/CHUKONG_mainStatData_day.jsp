...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){      qudao="CHUKONG_MIESHI";
	                                          tqudao="-1";}
	...
	realChannelList.add("游戏币库存");
        ...
        for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"CHUKONG用户"+fenqu+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        <option value="CHUKONG_MIESHI" 
                        <%  if("CHUKONG_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >CHUKONG_MIESHI</option>
