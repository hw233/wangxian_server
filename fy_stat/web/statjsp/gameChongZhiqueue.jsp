...
import="java.util.*,com.xuanzhi.tools.queue.*,com.sqage.stat.server.*,com.xuanzhi.tools.text.*,
com.xuanzhi.stat.*,com.xuanzhi.stat.transport.*"%>
...
String name = request.getParameter("name");
		...
		queue=GameChongZhiService.getInstance().getGameChongZhiqueue();
