...
<%@ page
  ...
  <%
   String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){ qudao="xiaomiyx_MIESHI','XIAOMISDK_MIESHI','XIAOMISDK02_MIESHI"; tqudao="-1";   }
	...
	realChannelList.add("游戏币库存");
       ...
       synchronized(lock){
        ...
        for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"xiaomiyx_MIESHI用户"+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        ...
                        <option value="xiaomiyx_MIESHI" 
                        <%  if("xiaomiyx_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >xiaomiyx_MIESHI</option>
                        
                        <option value="XIAOMISDK_MIESHI" 
                        <%  if("XIAOMISDK_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >XIAOMISDK_MIESHI</option>
                        
                        <option value="XIAOMISDK02_MIESHI" 
                        <%  if("XIAOMISDK02_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >XIAOMISDK02_MIESHI</option>
