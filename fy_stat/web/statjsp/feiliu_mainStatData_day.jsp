...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){ qudao="feiliu_MIESHI','feiliu2_MIESHI','feiliu3_MIESHI','feiliu4_MIESHI','feiliu5_MIESHI','feiliu6_MIESHI"; tqudao="-1";   }
       ...
       synchronized(lock){
		...
		if ("true".equals(flag)) {//如果是刚打开页面，不查询
          for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"feiliu用户"+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        ...
                        <option value="feiliu_MIESHI" 
                        <%  if("feiliu_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >feiliu_MIESHI</option>
                        
                         <option value="feiliu2_MIESHI" 
                        <%  if("feiliu2_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >feiliu2_MIESHI</option>
                        
                         <option value="feiliu3_MIESHI" 
                        <%  if("feiliu3_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >feiliu3_MIESHI</option>
                        
                         <option value="feiliu4_MIESHI" 
                        <%  if("feiliu4_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >feiliu4_MIESHI</option>
                        
                         <option value="feiliu5_MIESHI" 
                        <%  if("feiliu5_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >feiliu5_MIESHI</option>
                        
                        
                        <option value="feiliu6_MIESHI" 
                        <%  if("feiliu6_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >feiliu6_MIESHI</option>
