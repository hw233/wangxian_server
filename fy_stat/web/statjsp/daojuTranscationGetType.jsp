...
<%@ page
  ...
  <%
	...
	ArrayList<String> daojuList=null;
              ...
              List<String []> ls=transactionManager.getDaoJuGetType(startDay,endDay,fenqu);
...
<html>
	...
	<body>
		...
		<br/><br/>
					...
					out.print("<tr bgcolor='#EEEEBB'><td>获取方式</td><td>发布数量</td><td>交易数量</td><td>交易金额(文)</td><td>交易成功率</td><td>交易量占比</td><td>交易额占比</td></tr>");
					Long zfabu=0L;
					Long zjiaoyi=0L;
					Long zongjine=0L;
					...
					if(zongjine!=0&&goumai[3]!=null){jiaoyieZhanB=(Long.parseLong(goumai[3])*100)/zongjine;}
					 ...
					 out.print("<tr bgcolor='#FFFFFF'><td>"+goumai[0]+"</td><td>"+(goumai[1]==null ? 0 :StringUtil.addcommas(Long.parseLong(goumai[1])))+"</td><td>"+(goumai[2] ==null ? 0 : StringUtil.addcommas(Long.parseLong(goumai[2])))+"</td><td>"+(goumai[3]==null ? 0 : StringUtil.addcommas(Long.parseLong(goumai[3])))+"</td><td>"+wanchenglv+"%</td><td>"+jiaoyiLiangZhanB+"%</td><td>"+jiaoyieZhanB+"%</td></tr>");
					}
					long zwanchenglv=0;
