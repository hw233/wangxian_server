  ...
  <%
	...
	List<Channel> channelList = (ArrayList<Channel>)session.getAttribute("QUDAO_LIST");
	  ...
	  if(fenQuList==null)
             ...
             String sql="select  t.articlename, count( case  when t.responseresult = 1 then 1 end) Dealcount, "
             ...
             sql+=" and t.tradetype='1' group by t.articlename ";
	...
	<body>
		...
		<br/><br/>
                ...
                分区：<select name="fenqu">
					...
					out.print("<tr bgcolor='#EEEEBB'><td>道具名称</td><td>成交笔数</td><td>成交金额</td><td>新挂单笔数</td><td>新挂单金额</td></tr>");
