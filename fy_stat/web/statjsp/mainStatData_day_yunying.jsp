...
<%@ page
  ...
  <%
	...
	**/
	...
	ArrayList<String[]> fenQuList = null;
              ...
              fenQuList= userManager.getFenQu(null);//获得现有的渠道信息
	...
	<body>
		...
		<br/><br/>
		       渠道：<select name="qudao">
                       ...
                       String _fenqu = fenQuList.get(i)[1];
                       %>
                        <option value="<%=_fenqu %>" 
                        <%
		    	...
		    	<input type='submit' value='提交'></form>
		    		...
		    		if(c!=11&&c!=12&&c!=13&&c!=14&&c!=15){	out.print("<td>"+realChannelList.get(c)+"</td>");}
		    		}
					out.println("</tr>");
