  ...
  <%
	...
	List<Channel> channelList = (ArrayList<Channel>)session.getAttribute("QUDAO_LIST");
	  ...
	  if(fenQuList==null)
             ...
             String sql="select   t.sellviplevel,count(case  when t.responseresult = 1 then 1 end) dealcount, "
		...
		<br/><br/>
               ...
               等级段划分： <input type="text" name="nlevel" id="daoju" class="nqz_input" style="width:100px;" value="<%=nlevel %>"/><font color='red'>每段包含的级别数</font>
                ...
                &nbsp;&nbsp; 
					...
					out.print("<tr bgcolor='#EEEEBB'><td>vipd等级</td><td>成交笔数</td><td>成交金额</td><td>新挂单笔数</td><td>新挂单金额</td></tr>");
