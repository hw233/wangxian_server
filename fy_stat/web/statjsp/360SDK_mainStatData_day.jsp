...
<%@ page
  ...
  <%
	...
	qudao="360SDK_MIESHI','360JIEKOU_MIESHI','360JIEKOU01_MIESHI"; tqudao="-1";   }
       ...
       synchronized(lock){
		...
		if ("true".equals(flag)) {//如果是刚打开页面，不查询
          for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"360"+fenqu+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        ...
                        <option value="360SDK_MIESHI" 
                        <%  if("360SDK_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >360SDK_MIESHI</option>
                        
                        <option value="360JIEKOU_MIESHI" 
                        <%  if("360JIEKOU_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >360JIEKOU_MIESHI</option>
                        
                        <option value="360JIEKOU01_MIESHI" 
                        <%  if("360JIEKOU01_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >360JIEKOU01_MIESHI</option>
