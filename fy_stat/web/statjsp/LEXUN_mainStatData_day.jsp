...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){      qudao="LEXUN01_MIESHI','LEXUN02_MIESHI";
	                                          tqudao="-1";}
	...
	realChannelList.add("游戏币库存");
        ...
        for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"LEXUN用户"+fenqu+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        <option value="LEXUN01_MIESHI" 
                        <%  if("LEXUN01_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >LEXUN01_MIESHI</option>
                         <option value=LEXUN02_MIESHI 
                        <%  if("LEXUN02_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >LEXUN02_MIESHI</option>
