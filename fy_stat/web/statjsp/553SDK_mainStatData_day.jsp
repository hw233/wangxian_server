...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){
	         qudao="553SDK_MIESHI','553SDK01_MIESHI','553SDK02_MIESHI','553SDK03_MIESHI','553SDK04_MIESHI','553SDK05_MIESHI','553SDK06_MIESHI',"+
	         "'553SDK07_MIESHI','553SDK08_MIESHI','553SDK09_MIESHI','553SDK10_MIESHI','553SDK11_MIESHI','553SDK12_MIESHI','553SDK13_MIESHI',"+
	         "'553SDK14_MIESHI','553SDK15_MIESHI','553SDK16_MIESHI','553SDK17_MIESHI','553SDK18_MIESHI','553SDK19_MIESHI','553SDK20_MIESHI',"+
	         "'553SDK21_MIESHI','553SDK22_MIESHI','553SDK23_MIESHI','553SDK24_MIESHI','553SDK25_MIESHI','553SDK26_MIESHI','553SDK27_MIESHI',"+
	         "'553SDK28_MIESHI','553SDK29_MIESHI','553SDK30_MIESHI";
	                                          tqudao="-1";}
	...
	realChannelList.add("游戏币库存");
        ...
        for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"553sdk用户"+fenqu+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        <option value="553SDK_MIESHI" 
                        <%  if("553SDK_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK_MIESHI</option>
                        
                        <option value="553SDK01_MIESHI" 
                        <%  if("553SDK01_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK01_MIESHI</option>
                        
                        <option value="553SDK02_MIESHI" 
                        <%  if("553SDK02_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK02_MIESHI</option>
                        
                        <option value="553SDK03_MIESHI" 
                        <%  if("553SDK03_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK03_MIESHI</option>
                        
                        <option value="553SDK04_MIESHI" 
                        <%  if("553SDK04_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK04_MIESHI</option>
                        
                         <option value="553SDK05_MIESHI" 
                        <%  if("553SDK05_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK05_MIESHI</option>
                        
                          <option value="553SDK06_MIESHI" 
                        <%  if("553SDK06_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK06_MIESHI</option>
                        
                          <option value="553SDK07_MIESHI" 
                        <%  if("553SDK07_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK07_MIESHI</option>
                        
                              <option value="553SDK08_MIESHI" 
                        <%  if("553SDK08_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK08_MIESHI</option>
                        
                              <option value="553SDK09_MIESHI" 
                        <%  if("553SDK09_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK09_MIESHI</option>
                              <option value="553SDK10_MIESHI" 
                        <%  if("553SDK10_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK10_MIESHI</option>
                              <option value="553SDK11_MIESHI" 
                        <%  if("553SDK11_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK11_MIESHI</option>
                        
                        
                                 <option value="553SDK12_MIESHI" 
                        <%  if("553SDK12_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK12_MIESHI</option>
                        
                              <option value="553SDK13_MIESHI" 
                        <%  if("553SDK13_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK13_MIESHI</option>
                        
                              <option value="553SDK14_MIESHI" 
                        <%  if("553SDK14_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK14_MIESHI</option>
                        
                        <option value="553SDK15_MIESHI" 
                        <%  if("553SDK15_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK15_MIESHI</option>
                        
                        
                         <option value="553SDK16_MIESHI" 
                        <%  if("553SDK16_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK16_MIESHI</option>

                       <option value="553SDK17_MIESHI" 
                        <%  if("553SDK17_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK17_MIESHI</option>

                        <option value="553SDK18_MIESHI" 
                        <%  if("553SDK18_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK18_MIESHI</option>
                        
                          <option value="553SDK19_MIESHI" 
                        <%  if("553SDK19_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK19_MIESHI</option>
                        
                        <option value="553SDK20_MIESHI" 
                        <%  if("553SDK20_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK20_MIESHI</option>
                        
                         <option value="553SDK21_MIESHI" 
                        <%  if("553SDK21_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK21_MIESHI</option>
                      
                        <option value="553SDK22_MIESHI" 
                        <%  if("553SDK22_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK22_MIESHI</option>
                      
                        <option value="553SDK23_MIESHI" 
                        <%  if("553SDK23_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK23_MIESHI</option>
                        
                      <option value="553SDK24_MIESHI" 
                        <%  if("553SDK24_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK24_MIESHI</option>
                        
                        <option value="553SDK25_MIESHI" 
                        <%  if("553SDK25_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK25_MIESHI</option>
                        
                        <option value="553SDK26_MIESHI" 
                        <%  if("553SDK26_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK26_MIESHI</option>
                        
                       <option value="553SDK27_MIESHI" 
                        <%  if("553SDK27_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK27_MIESHI</option>
                        
                       <option value="553SDK28_MIESHI" 
                        <%  if("553SDK28_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK28_MIESHI</option>
                        
                         <option value="553SDK29_MIESHI" 
                        <%  if("553SDK29_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK29_MIESHI</option>
                      
                       <option value="553SDK30_MIESHI" 
                        <%  if("553SDK30_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >553SDK30_MIESHI</option>
