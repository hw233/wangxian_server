  ...
  <%
	...
	**/
	ArrayList<String> daojuList=null;
             ...
             List<String []> ls= daoJuManager.getSensitiveDaoJuReasonType(startDay,endDay,fenqu,jixing,daojuname);
...
<html>
	...
	<body>
		...
		<input type="hidden" id="daojuname" name="daojuname" value="<%=daojuname %>"/>
		...
		<br/><br/>
		    		...
		    		<h3><%=daojuname %>  获取方式</h3>
		    		<%
		    		out.println("<table id='test2' align='center' width='90%' cellpadding='1' bgcolor='#000000' cellspacing='1' border='0'>");
					out.print("<tr bgcolor='#EEEEBB'><td>获取方式</td><td>产出数量</td><td>消耗数量</td></tr>");
					Long chansheng=0L;
					Long xiaohao=0L;
					...
					for(int i = 0 ; i < ls.size() ; i++){
					String [] goumai=(String[])ls.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+goumai[0]+"</td><td>"+goumai[1]+"</td><td>"+goumai[2]+"</td></tr>");
					}
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+chansheng+"</td><td>"+xiaohao+"</td></tr>");
