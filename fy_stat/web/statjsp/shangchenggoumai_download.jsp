...
<%@ page
  ...
  <%
	...
	if(username == null){ username = "全部";}else{spNumber+=username;}
		      ...
		      List<String[]> goumaiList=daoJuManager.getDaoJuGouMai(startDay,endDay,fenqu,huoBiType,gamelevel_search,wupintype,"商店购买",username_search);
         ...
         // String xls= basePath+"\\"+spNumber+".xls";
          ...
          jxl.write.WritableWorkbook wwb = Workbook.createWorkbook(f);
              ...
              //ws.addCell(labelC);
              //labelC = new jxl.write.Label(1, 0, "物品单价（文）");
              ws.addCell(labelC);
