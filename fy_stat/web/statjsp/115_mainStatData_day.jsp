...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){
	         qudao="115G_MIESHI','115G01_MIESHI','115G02_MIESHI";
	                                          tqudao="-1";}
	...
	realChannelList.add("游戏币库存");
        ...
        for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"115用户"+fenqu+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        <option value="115G_MIESHI" 
                        <%  if("115G_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >115G_MIESHI</option>
                        
                        <option value="115G01_MIESHI" 
                        <%  if("115G01_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >115G01_MIESHI</option>
                        
                        <option value="115G02_MIESHI" 
                        <%  if("115G02_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >115G02_MIESHI</option>
