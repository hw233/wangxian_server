	...
	<body>
		...
		<br/><br/>
		       货币类型：<select name="huoBiType">
					...
					out.print("<tr bgcolor='#EEEEBB'><td>物品名称</td><td>购买数量</td><td>总价格(文)</td><td>占比</td></tr>");
					Long moneysum=0L;
					Long count=0L;
					...
					if(count!=0){zhanbi=(Long.parseLong(goumai[2])*100)/count;}
						out.print("<tr bgcolor='#FFFFFF'><td>"+goumai[0]+"</td><td>"+goumai[2]+"</td><td>"+goumai[3]+"</td><td>"+zhanbi+"% &nbsp;</td>");
						out.println("</tr>");
					}
					
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+count+"</td><td>"+moneysum+"</td><td>&nbsp;</td></tr>");
