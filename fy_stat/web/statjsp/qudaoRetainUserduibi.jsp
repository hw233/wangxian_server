...
<%@ page
	...
	com.sqage.stat.commonstat.manager.Impl.*,java.math.BigDecimal,java.math.MathContext"
	%>
  	...
  	for (int tianshu = 0; tianshu < dateStr.length; tianshu++) {
  		...
  		BigDecimal dayNum=new BigDecimal("0");//指定日期留存人数
  			...
  			if (dateStr2.compareTo(DateUtil.formatDate(new Date(), "yyyy-MM-dd")) < 0) {
  				qudaoshuList_1 = playGameManager.getQuDaoRetainUserCount(_day, _day,fenqu,jixing);//注册当日留存
  				qudaoshuList_2 = playGameManager.getQuDaoRetainUserCount(_day, dateStr2,fenqu,jixing);//指定日期留存
		  ...
		  分区：<select name="fenqu">
		    ...
		    <br/>
		     ...
		     <table width="500"><tr>
		    		...
		    		<br/>
		    		<a href="qudaoRetainUserduibi2.jsp";>各分区注册并进入玩家K日留存对比</a>
		    		<br/>
