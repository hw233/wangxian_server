...
<%@ page
  ...
  <%
	...
	if(endDay == null) endDay = today;
		     ...
		     List<ChongZhi> chongZhiList=chongZhiManager.getChongZhi_unrecord(startDay,endDay,qudao,fenqu,type,cardtype,username_search,money_search,jixing,modeType);
		     long totalmoney=chongZhiManager.getChongZhi_totalMoney_unRecord(startDay,endDay,qudao,fenqu,type,cardtype,username_search,money_search,jixing,modeType);
                  ...
                  <br>
		    		...
		    		<display:table name="chongZhiList" pagesize="20" id="chognzhi" cellspacing="0" cellpadding="0"  size="100" 
                      ...
                      <display:column property="cost" title="手续费"/>
                       <display:column property="modelType" title="手机型号"/>
