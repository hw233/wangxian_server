...
synchronized(lock){
	...
	//List<String[]> ls=transaction_SpecialManager.getTransactionSpec_Total_fenQu2(startDay,endDay,fenqu);
      List<String[]> ls=daoJuManager.getGoDong_YinKuai_fenqu(startDay,endDay,fenqu);
%>
	...
	<body>
	   ...
	   展示方式：
		...
		<center>
					...
					out.print("<tr bgcolor='#EEEEBB'><td>分区</td><td>古董产出</td><td>古董消耗</td><td>银块产出</td><td>银块消耗</td></tr>");
