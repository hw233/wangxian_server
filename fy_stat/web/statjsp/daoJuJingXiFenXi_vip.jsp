...
<html>
	<head>
	 ...
	 <body>
		<center>
		<h2 style="font-weight:bold;">酒类道具vip跟踪</h2>
		<form  method="post">
		  ...
		  结束日期： <input type="text" name="endDay" id="endDay" class="nqz_input" style="width:100px;" readonly="readonly" onfocus="new Calendar(false,'yyyy-MM-dd').showTimePicker(this);" value="<%=endDay %>"/>
		    	...
		    	<input type='submit' value='提交'></form>
					...
					if ("true".equals(flag)) {  //如果是刚打开页面，不查询
					 List<String []> lbai = daoJuManager.getDaoJuByVip(startDay,endDay,fenqu,daoJuName, "白色");  
                     List<String []> llv  = daoJuManager.getDaoJuByVip(startDay,endDay,fenqu,daoJuName, "绿色");   
                     List<String []> llan = daoJuManager.getDaoJuByVip(startDay,endDay,fenqu,daoJuName, "蓝色");   
                     List<String []> lzi  = daoJuManager.getDaoJuByVip(startDay,endDay,fenqu,daoJuName, "紫色"); 
                     List<String []> lceng= daoJuManager.getDaoJuByVip(startDay,endDay,fenqu,daoJuName, "橙色");     
					
					////白色酒
					out.println("<br/>白色酒<br/>");
					out.println("<table id='test2' align='center' width='90%' cellpadding='1' bgcolor='#000000' cellspacing='1' border='0'>");
					out.print("<tr bgcolor='#EEEEBB'><td>vip</td><td>喝酒数</td></tr>");
					
					long[] bai=new long[5];
					for(int i = 0 ; i < lbai.size() ; i++){
					String [] barStr = lbai.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+barStr[0]+"</td><td>"+barStr[1]+"</td></tr>");
					...
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+bai[1]+"</td></tr>");
					...
					String [] lvStr = llv.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+lvStr[0]+"</td><td>"+lvStr[1]+"</td></tr>");
					...
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+lv[1]+"</td></tr>");
					...
					out.print("<tr bgcolor='#FFFFFF'><td>"+lanStr[0]+"</td><td>"+lanStr[1]+"</td></tr>");
					...
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+lan[1]+"</td></tr>");
					...
					String [] lziStr = lzi.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+lziStr[0]+"</td><td>"+lziStr[1]+"</td></tr>");
					...
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+zi[1]+"</td></tr>");
					...
					String [] lcengStr = lceng.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+lcengStr[0]+"</td><td>"+lcengStr[1]+"</td></tr>");
					...
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+ceng[1]+"</td></tr>");
