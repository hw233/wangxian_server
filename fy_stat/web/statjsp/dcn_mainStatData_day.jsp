...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){
	         qudao="DCN_MIESHI','DCN01_MIESHI','DCN02_MIESHI','DCN03_MIESHI','DCN04_MIESHI','DCN05_MIESHI','DCN06_MIESHI',"+
	         "'DCN07_MIESHI','DCN08_MIESHI','DCN09_MIESHI','DCN10_MIESHI','DCN11_MIESHI','DCN12_MIESHI','DCN13_MIESHI',"+
	         "'DCN14_MIESHI','DCN15_MIESHI','DCN16_MIESHI','DCN17_MIESHI','DCN18_MIESHI','DCN19_MIESHI','DCN20_MIESHI',"
	         +"'DCN21_MIESHI','DCN22_MIESHI','DCN23_MIESHI','DCN24_MIESHI','DCN25_MIESHI";
	                                          tqudao="-1";}
	...
	realChannelList.add("游戏币库存");
        ...
        for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"dcn用户"+fenqu+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        <option value="DCN_MIESHI" 
                        <%  if("DCN_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN_MIESHI</option>
                        
                        <option value="DCN01_MIESHI" 
                        <%  if("DCN01_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN01_MIESHI</option>
                        
                        <option value="DCN02_MIESHI" 
                        <%  if("DCN02_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN02_MIESHI</option>
                        
                        <option value="DCN03_MIESHI" 
                        <%  if("DCN03_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN03_MIESHI</option>
                        
                        <option value="DCN04_MIESHI" 
                        <%  if("DCN04_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN04_MIESHI</option>
                        
                        <option value="DCN05_MIESHI" 
                        <%  if("DCN05_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN05_MIESHI</option>
                        
                        <option value="DCN06_MIESHI" 
                        <%  if("DCN06_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN06_MIESHI</option>
                        
                         <option value="DCN07_MIESHI" 
                        <%  if("DCN07_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN07_MIESHI</option>
                        
                        <option value="DCN08_MIESHI" 
                        <%  if("DCN08_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN08_MIESHI</option>
                        
                        <option value="DCN09_MIESHI" 
                        <%  if("DCN09_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN09_MIESHI</option>
                        
                        <option value="DCN10_MIESHI" 
                        <%  if("DCN10_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN10_MIESHI</option>
                        
                         <option value="DCN11_MIESHI" 
                        <%  if("DCN11_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN11_MIESHI</option>
                        
                        <option value="DCN12_MIESHI" 
                        <%  if("DCN12_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN12_MIESHI</option>
                        
                        <option value="DCN13_MIESHI" 
                        <%  if("DCN13_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN13_MIESHI</option>
                        
                         <option value="DCN14_MIESHI" 
                        <%  if("DCN14_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN14_MIESHI</option>
                        
                         <option value="DCN15_MIESHI" 
                        <%  if("DCN15_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN15_MIESHI</option>
                        
                         <option value="DCN16_MIESHI" 
                        <%  if("DCN16_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN16_MIESHI</option>
                        
                        <option value="DCN17_MIESHI" 
                        <%  if("DCN17_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN17_MIESHI</option>
                        
                        <option value="DCN18_MIESHI" 
                        <%  if("DCN18_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN18_MIESHI</option>
                        
                        <option value="DCN19_MIESHI" 
                        <%  if("DCN19_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN19_MIESHI</option>
                        
                        <option value="DCN20_MIESHI" 
                        <%  if("DCN20_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN20_MIESHI</option>
                        
                       <option value="DCN21_MIESHI" 
                        <%  if("DCN21_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN21_MIESHI</option>
                        
                        <option value="DCN22_MIESHI" 
                        <%  if("DCN22_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN22_MIESHI</option>
                        
                        <option value="DCN23_MIESHI" 
                        <%  if("DCN23_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN23_MIESHI</option>
                        
                        <option value="DCN24_MIESHI" 
                        <%  if("DCN24_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN24_MIESHI</option>
                        <option value="DCN25_MIESHI" 
                        <%  if("DCN25_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >DCN25_MIESHI</option>
