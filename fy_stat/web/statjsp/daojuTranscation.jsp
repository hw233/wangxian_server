...
<%@ page
  ...
  <%
	...
	ArrayList<String> daojuList=null;
              ...
              List<String []> ls=transactionManager.getDaoJuJiaoYi(startDay,endDay,fenqu);
...
<html>
	<head>
     ...
     <script language="JavaScript">
	     ...
	     function searchDaoJuName(dataStr) {
		     // document.getElementById("daojuname").value=daojuname;
		      $('form1').action="daojuTranscationDaoJuName.jsp";
		      $('form1').submit();
	        }
	...
	<body>
		...
		<br/><br/>
					...
					out.print("<tr bgcolor='#EEEEBB'><td>时间</td><td>发布数量</td><td>交易数量</td><td>交易金额(文)</td><td>交易成功率</td><td>交易方式</td><td>交易物品</td></tr>");
					Long zfabu=0L;
					Long zjiaoyi=0L;
					Long zongjine=0L;
					...
					if(goumai[1]!=null&&!"0".equals(goumai[1])&&goumai[2]!=null){ wanchenglv= (Long.parseLong(goumai[2])*100) / Long.parseLong(goumai[1]); }
					 ...
					 out.print("<tr bgcolor='#FFFFFF'><td>"+goumai[0]+"</td><td>"+(goumai[1]==null? 0 : StringUtil.addcommas(Long.parseLong(goumai[1])))+"</td><td>"+(goumai[2]==null ? 0 : StringUtil.addcommas(Long.parseLong(goumai[2])))+"</td><td>"+(goumai[3]==null? 0 : StringUtil.addcommas(Long.parseLong(goumai[3])))+"</td><td>"+wanchenglv+"%</td><td><a href=javascript:searchGetType('"+goumai[0]+"')>点击查看</a></td><td><a href=javascript:searchDaoJuName('"+goumai[0]+"')>点击查看</a></td></tr>");
					}
					long zwanchenglv=0;
					if(zfabu!=0){zwanchenglv=(zjiaoyi*100)/zfabu;}
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+StringUtil.addcommas(zfabu)+"</td><td>"+StringUtil.addcommas(zjiaoyi)+"</td><td>"+StringUtil.addcommas(zongjine)+"</td><td>&nbsp;"+zwanchenglv+"%</td><td>&nbsp;</td><td>&nbsp;</td></tr>");
