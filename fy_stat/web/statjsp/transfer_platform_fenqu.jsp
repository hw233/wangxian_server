  ...
  <%
	...
	List<Channel> channelList = (ArrayList<Channel>)session.getAttribute("QUDAO_LIST");
	  ...
	  if(fenQuList==null)
             ...
             String sql="select   t.servername,count(case  when t.responseresult = 1 then 1 end) dealcount, "
	...
	<body>
		...
		<br/><br/>
                  ...
                  排序：<select name="order">
					...
					out.print("<tr bgcolor='#EEEEBB'><td>分区</td><td>成交笔数</td><td>成交金额</td><td>新挂单笔数</td><td>新挂单金额</td></tr>");
