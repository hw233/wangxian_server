...
<%@ page
  ...
  <%
	...
	if(endDay == null) endDay = today;
		     ...
		     List chongZhiList=chongZhiManager.getFenQuChongZhi(startDay,endDay,qudao,type,cardtype,fenqu);
		...
		<br/><br/>
		       渠道：<select name="qudao">
                 ...
                 for(int i = 0 ; i < cardtypeList.size() ; i++){
					...
					out.print("<tr bgcolor='#EEEEBB'><td>分区</td><td>独立付费次数</td><td>独立付费人数</td><td>金额(分)</td></tr>");
