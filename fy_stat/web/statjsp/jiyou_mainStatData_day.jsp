...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){ qudao="jiyou_MIESHI','jiyou1_MIESHI','jiyou2_MIESHI','jiyou3_MIESHI','jiyou4_MIESHI','jiyou5_MIESHI','jiyou6_MIESHI"; tqudao="-1";   }
	...
	if ("true".equals(flag)) {//如果是刚打开页面，不查询
       for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"jiyou"+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        <option value="jiyou_MIESHI" 
                        <%  if("jiyou_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >jiyou_MIESHI</option>
                        
                        <option value="jiyou2_MIESHI" 
                        <%  if("jiyou2_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >jiyou2_MIESHI</option>
                        
                         <option value="jiyou3_MIESHI" 
                        <%  if("jiyou3_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >jiyou3_MIESHI</option>
                        
                          <option value="jiyou4_MIESHI" 
                        <%  if("jiyou4_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >jiyou4_MIESHI</option>
                        
                        
                          <option value="jiyou5_MIESHI" 
                        <%  if("jiyou5_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >jiyou5_MIESHI</option>
                        
                        
                          <option value="jiyou6_MIESHI" 
                        <%  if("jiyou6_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >jiyou6_MIESHI</option>
