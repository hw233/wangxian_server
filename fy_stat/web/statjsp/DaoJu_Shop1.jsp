...
<%@ page
    ...
    <%
     ...
     if ("true".equals(flag)) {  //如果是刚打开页面，不产生下载文件
      ...
      ///////////////////////下载文件 ////////////////////////////////
        String spNumber=startDay+"daoJushop";
        String basePath =getServletContext().getRealPath("/")+"excel";
         ...
         List<String []> ls=daoJuManager.getDaoJushop(startDay);
              for(int j = 0; j < ls.size();j++){
                  String [] strs=(String [])ls.get(j);
                  String contentStr=strs[0]+"\t"+strs[1]+"\t"+strs[2]+"\t"+strs[3]+"\t"+strs[4]+"\t"+strs[5]+"\t"+strs[6]+"\t"+strs[7]+"\r\n";
