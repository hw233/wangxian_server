...
<%@ page
  ...
  <%
	...
	String lastday = DateUtil.formatDate(s,"yyyy-MM-dd");
		    ...
		    List chongZhiList= gameChongZhiManager.getChongZhiStat_reasontype(lastday,startDay,fenqu,null,null,null,"1",username);
	...
	<body>
		...
		<br/><br/>
		       渠道：<select name="qudao">
					...
					out.print("<tr bgcolor='#EEEEBB'><td>消费方式</td><td>消费金额(文)</td></tr>");
					...
					String[] chognzhi=(String[])chongZhiList.get(i);
						out.print("<tr bgcolor='#FFFFFF'><td>"+chognzhi[0]+"</td><td>"+chognzhi[1]+"</td>");
						out.println("</tr>");
					}
					out.print("<tr bgcolor='#EEEEBB'><td>总计</td><td>"+moneysum+"&nbsp;</td></tr>");
