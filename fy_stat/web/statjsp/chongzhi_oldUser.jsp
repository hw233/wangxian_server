		...
		<br/><br/>
		       渠道：<select name="qudao">
		    	...
		    	<input type='submit' value='提交'></form>
					...
					out.print("<tr bgcolor='#EEEEBB'><td>日期</td><td>充值人次</td><td>充值角色数</td><td>充值金额(分)</td></tr>");
				    long usercont   = 0L;
				    long playercont   = 0L;
				    long totalMoney = 0L;
					for(int i = 0 ; i < dayList.size() ; i++){
					  List <String []> vip0 = chongZhiManager.getOldPlayerChongzhi(dayList.get(i), qudao, fenqu, jixing);// vip0
