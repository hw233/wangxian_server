  ...
  <%
	...
	ArrayList<String> daojuList=new ArrayList<String>();
             ...
             System.out.println("lost:"+lost);
		      ...
		      List goumaiList=daoJuManager.getDaoJuXiaoHao(startDay,endDay,fenqu,huoBiType,gamelevel_search,wupintype,lost,username_search);
%>
		...
		<br/><br/>
		       货币类型：<select name="huoBiType">
		    		...
		    		<input type="button" name="download" onclick="downloads();" value="下&nbsp;载" >
		    		 ...
		    		 <a href="daojuxiaohao_color.jsp">有颜色的道具消耗</a>
		    		<br/>
		    		<h3>道具消耗</h3>
		    		<%
		    		out.println("<table id='test2' align='center' width='90%' cellpadding='1' bgcolor='#000000' cellspacing='1' border='0'>");
					out.print("<tr bgcolor='#EEEEBB'><td>物品名称</td><td>别名</td><td>消耗数量</td><td>总价格(文)</td><td>占比</td></tr>");
					Long moneysum=0L;
					Long count=0L;
