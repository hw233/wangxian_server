...
<%@ page
  ...
  <%
  	...
  	channelList.add("xiaomiyx_MIESHI");
  	...
  	for (int tianshu = 0; tianshu < dateStr.length; tianshu++) {
  		...
  		BigDecimal dayNum=new BigDecimal("0");//指定日期留存人数
  			...
  			if (dateStr2.compareTo(DateUtil.formatDate(new Date(), "yyyy-MM-dd")) < 0) {
  				qudaoshuList_1 = playGameManager.getQuDaoRetainUserCount(_day, _day,null,null);//注册当日留存
  				qudaoshuList_2 = playGameManager.getQuDaoRetainUserCount(_day, dateStr2,null,null);//指定日期留存
