...
<%@ page
  ...
  <%
	...
	if(qudao==null||"-1".equals(qudao)){ qudao="SHENGDA1_MIESHI','SHENGDA2_MIESHI','SHENGDA3_MIESHI','SHENGDA4_MIESHI','SHENGDA5_MIESHI','SHENGDA6_MIESHI','SHENGDA7_MIESHI','SHENGDA8_MIESHI"; tqudao="-1";   }
	...
	realChannelList.add("游戏币库存");
		...
		if ("true".equals(flag)) {//如果是刚打开页面，不查询
         for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"SHENGDA"+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        ...
                        <option value="SHENGDA1_MIESHI" 
                        <%  if("SHENGDA1_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA1_MIESHI</option>
                       
                         <option value="SHENGDA2_MIESHI" 
                        <%  if("SHENGDA2_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA2_MIESHI</option>
                       
                        <option value="SHENGDA3_MIESHI" 
                        <%  if("SHENGDA3_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA3_MIESHI</option>
                       
                        <option value="SHENGDA4_MIESHI" 
                        <%  if("SHENGDA4_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA4_MIESHI</option>
                       
                        <option value="SHENGDA5_MIESHI" 
                        <%  if("SHENGDA5_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA5_MIESHI</option>
                       
                       <option value="SHENGDA6_MIESHI" 
                        <%  if("SHENGDA6_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA6_MIESHI</option>
                       
                        <option value="SHENGDA7_MIESHI" 
                        <%  if("SHENGDA7_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA7_MIESHI</option>
                        
                        <option value="SHENGDA8_MIESHI" 
                        <%  if("SHENGDA8_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >SHENGDA8_MIESHI</option>
