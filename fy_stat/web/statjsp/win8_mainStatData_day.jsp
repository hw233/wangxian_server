...
<%@ page
  ...
  String flag = null;
	...
	if(qudao==null||"-1".equals(qudao)){
	         qudao="WIN8DCN_MIESHI','WIN8STORE_MIESHI','WIN8SONY_MIESHI','WIN8WP8_MIESHI','WP8_557NET_MIESHI','WP8_MIESHI','WP8_WPAPPS_MIESHI";
	...
	realChannelList.add("游戏币库存");
        ...
        for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"win8用户"+fenqu+jixing;}
				else{
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        <option value="WIN8DCN_MIESHI" 
                        <%  if("WIN8DCN_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >WIN8DCN_MIESHI</option>
                        
                        <option value="WIN8STORE_MIESHI" 
                        <%  if("WIN8STORE_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >WIN8STORE_MIESHI</option>
                        
                        <option value="WIN8SONY_MIESHI" 
                        <%  if("WIN8SONY_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >WIN8SONY_MIESHI</option>
                        
                         <option value="WIN8WP8_MIESHI" 
                        <%  if("WIN8WP8_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >WIN8WP8_MIESHI</option>
                        
                        <option value="WP8_557NET_MIESHI" 
                        <%  if("WP8_557NET_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >WP8_557NET_MIESHI</option>
                        
                        <option value="WP8_MIESHI" 
                        <%  if("WP8_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >WP8_MIESHI</option>
                        
                        <option value="WP8_WPAPPS_MIESHI" 
                        <%  if("WP8_WPAPPS_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >WP8_WPAPPS_MIESHI</option>
