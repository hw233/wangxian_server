...
<%@ page
  ...
  <%
	...
	qudao="UC_MIESHI','UC01_MIESHI','UC02_MIESHI','UC03_MIESHI','UC04_MIESHI','UC05_MIESHI','UC06_MIESHI','UC07_MIESHI','UC08_MIESHI','UC09_MIESHI',"
	+"'UC10_MIESHI','UC11_MIESHI','UC12_MIESHI','UC13_MIESHI','UC14_MIESHI','UC15_MIESHI','UC16_MIESHI','UC17_MIESHI','UC18_MIESHI','UCNEWSDK_MIESHI','UCSDK_MIESHI"; 
	tqudao="-1";   }
	...
	if ("true".equals(flag)) {//如果是刚打开页面，不查询
          ...
          for(int k = 0 ; k < dayList.size() ; k++){
				...
				String key="";
				if("null".equals(qudao)||"-1".equals(tqudao)){key=_day+"UC用户"+fenqu+jixing;}
		...
		<br/><br/>
		       渠道：<select name="qudao" style="width:150px" >
                       <option  value="-1">全部</option>
                        ...
                        <option value="UC_MIESHI" 
                        <%  if("UC_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC_MIESHI</option>
                        
                        
                        <option value="UC01_MIESHI" 
                        <%  if("UC01_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC01_MIESHI</option>
                        
                           <option value="UC02_MIESHI" 
                        <%  if("UC02_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC02_MIESHI</option>
                        
                           <option value="UC03_MIESHI" 
                        <%  if("UC03_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC03_MIESHI</option>
                        
                        
                           <option value="UC04_MIESHI" 
                        <%  if("UC04_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC04_MIESHI</option>
                        
                         <option value="UC05_MIESHI" 
                        <%  if("UC05_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC05_MIESHI</option>

                        <option value="UC06_MIESHI" 
                        <%  if("UC06_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC06_MIESHI</option>
                        
                         <option value="UC07_MIESHI" 
                        <%  if("UC07_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC07_MIESHI</option>
                        
                        <option value="UC08_MIESHI" 
                        <%  if("UC08_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC08_MIESHI</option>
                        
                        <option value="UC09_MIESHI" 
                        <%  if("UC09_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC09_MIESHI</option>
                        
                        <option value="UC10_MIESHI" 
                        <%  if("UC10_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC10_MIESHI</option>
                        
                        <option value="UC11_MIESHI" 
                        <%  if("UC11_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC11_MIESHI</option>
                        
                        <option value="UC12_MIESHI" 
                        <%  if("UC12_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC12_MIESHI</option>
                        
                        <option value="UC13_MIESHI" 
                        <%  if("UC13_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC13_MIESHI</option>
                        
                        <option value="UC14_MIESHI" 
                        <%  if("UC14_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC14_MIESHI</option>
                        
                        <option value="UC15_MIESHI" 
                        <%  if("UC15_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC15_MIESHI</option>
                        
                        <option value="UC16_MIESHI" 
                        <%  if("UC16_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC16_MIESHI</option>
                        
                         <option value="UC17_MIESHI" 
                        <%  if("UC17_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC17_MIESHI</option>
                        
                           <option value="UC18_MIESHI" 
                        <%  if("UC18_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UC18_MIESHI</option>
                        
                         <option value="UCNEWSDK_MIESHI" 
                        <%  if("UCNEWSDK_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UCNEWSDK_MIESHI</option>
                        
                        
                        
                         <option value="UCSDK_MIESHI" 
                        <%  if("UCSDK_MIESHI".equals(qudao)){ out.print(" selected=\"selected\"");  } %>
                        >UCSDK_MIESHI</option>
                </select> &nbsp;&nbsp;
