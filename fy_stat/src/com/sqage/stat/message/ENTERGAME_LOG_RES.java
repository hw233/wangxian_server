 ...
 * </table>
 */
public class ENTERGAME_LOG_RES implements ResponseMessage{
	...
	public ENTERGAME_LOG_RES(long seqNum,byte result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public ENTERGAME_LOG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
