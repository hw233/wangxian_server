 ...
 * </table>
 */
public class FUMO_LOG_RES implements ResponseMessage{
	...
	public FUMO_LOG_RES(long seqNum,byte result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public FUMO_LOG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
