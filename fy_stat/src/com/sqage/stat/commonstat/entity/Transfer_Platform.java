 ...
 * 
 */
public class Transfer_Platform {
	...
	private String		tradeType	;	    //	交易类型 道具类型1  银锭类型2
	private String		responseResult	;	//	订单交易结果		//发布 -1;充值失败 0;	充值成功 1;退款成功 2;上架 3;	
	...
	private String   articleSalePaySilver="";   //挂单
	private String   cancelSaleSilver="";       //提前银锭交易撤单扣除银两

	
	
	  private String column1="";/// 表示银两挂单提前扣掉的手续费用
	...
	public String toString() {
		return "Transfer_Platform [articleColor:" + articleColor + "] [articleId:" + articleId + "] [articleName:" + articleName
