...
public interface GameChongZhiDao {
	 ...
	 * @return
	 */
	public List<String[]> getPlayerActionWatch(String startDateStr,String endDateStr,String startNum,String endNum,String fenQu,String quDao,String gameLevel, String currencyType,String reasontype,String action);
