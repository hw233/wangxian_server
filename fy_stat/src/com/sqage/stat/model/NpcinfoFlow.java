 ...
 * 
 */
public class NpcinfoFlow implements Serializable {
	
	private static final long serialVersionUID = -9203088531016193193L;

	public static Logger logger = Logger.getLogger(NpcinfoFlow.class);
	private Long id;
	...
	public String toString() {
		return "NpcinfoFlow [award:" + award + "] [career:" + career + "] [column1:" + column1 + "] [column2:" + column2 + "] [createDate:"
				+ createDate + "] [fenQu:" + fenQu + "] [gameLevel:" + gameLevel + "] [getDaoJu:" + getDaoJu + "] [getWuPin:" + getWuPin
				+ "] [getYOuXiBi:" + getYOuXiBi + "] [id:" + id + "] [jixing:" + jixing + "] [npcName:" + npcName + "] [taskType:" + taskType
				+ "] [userName:" + userName + "]";
	}
	public Long getId() {
		return id;
