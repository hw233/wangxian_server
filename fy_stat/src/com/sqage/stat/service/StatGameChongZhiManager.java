...
public class StatGameChongZhiManager implements Executable {

    protected static StatGameChongZhiManager m_self = null;
	protected static final Log logger = LogFactory.getLog(StatGameChongZhiManager.class);
	public static StatGameChongZhiManager getInstance() {
			return m_self;
		}
