<%@page import="com.xuanzhi.tools.servlet.HttpUtils"%><%@page import="java.net.URL"%><%@page import="java.util.HashMap"%><%@ page language="java" contentType="text/html; charset=UTF-8"    pageEncoding="UTF-8"%><%
	...
	if ("send".equals(send)) {
	String contentP = "selectstat="+selectstat+"&checkeds="+checkeds+"&content="+content+"&name="+name+"&contentInner="+contentInner+"&beginTime="+beginTime+"&endTime="+endTime+"&authorize.username=wangtianxin&authorize.password=123321";
