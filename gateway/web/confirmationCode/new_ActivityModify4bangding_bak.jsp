...
<%!
	void sendToReceiver(String eMail,List<ConfirmationCode> codeList, GameActivity gameActivity ,String mailNotice) {
		StringBuffer showContent = new StringBuffer();
		int conls = 15;
		...
		if (false){
			...
			if (codeList.size() % conls != 0) {
				showContent.append("</tr>");
			}
		}
		showContent.append("</table>");
		sendMail2(title, showContent.toString(),eMail);
}
%>
<%!
