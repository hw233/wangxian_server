...
<body>
<form action="./activityModify.jsp?option=<%=option%>" method="post">
	<table border="1">
		<tr class="sortable-onload-5-6r rowstyle-alt colstyle-alt no-arrow">
			...
			<td >激活码名字</td><td><input name="name" type="text" value="<%=gameActivity.getName()%>"></td>
		</tr>
		<tr>
			<td >激活码级别</td>
			<td>免费<input name="functionType" value="0" <%=gameActivity.getFunctionLevel()==0 ? "checked" : "" %> type="radio">
				福利:<input name="functionType" value="1" <%=gameActivity.getFunctionLevel()==1 ? "checked" : "" %> type="radio">
				特权:<input name="functionType" value="2" <%=gameActivity.getFunctionLevel()==2 ? "checked" : "" %> type="radio">
				收费:<input name="functionType" value="3" <%=gameActivity.getFunctionLevel()==3 ? "checked" : "" %> type="radio">
			</td>
		</tr>
		<tr>
