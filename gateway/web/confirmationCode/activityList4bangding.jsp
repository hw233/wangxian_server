...
<div style="text-align: right;"> <a href="./activity4bangding.jsp?option=add">增加新的活动</a>
	<form name="activity" action="">
		...
		%>
			...
			%> </span></td>
				<td><a
					href="./activity4bangding.jsp?activeId=<%=ga.getId() %>&option=modify">详细</a>
				</td>
			</tr>
			<%
			}
		...
		<BR /> <a href="./activity4bangding.jsp?option=add">增加新的活动</a>
	</form>
</body>
</html>
<script>
