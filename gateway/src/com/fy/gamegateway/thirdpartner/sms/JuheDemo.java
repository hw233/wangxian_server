...
public class JuheDemo {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="214a3b6e6f84cecbf7f606dfed726939";
    ...
    /**
     * 接口返回成功不代表接收成功，具体接收状态只能由运营商查询；
     * 运营商限制同1个号码同1个签名的内容1分钟内只能接收1条，1小时内只能接收3条，
     * 一天最多接收10条，否则可能会被运营商屏蔽，短信api接口本身不限制发送频率，具体发送频率需要用户自行设置。
     */
    //2.发送短信
    public static void getRequest2(String phoneNum,String code){
        ...
        Map params = new HashMap();//请求参数
            ...
            params.put("tpl_id","63074");//短信模板ID，请参考个人中心短信模板设置
