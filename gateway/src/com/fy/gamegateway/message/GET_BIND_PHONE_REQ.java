 ...
 * </table>
 */
public class GET_BIND_PHONE_REQ implements RequestMessage{
	...
	public GET_BIND_PHONE_REQ(long seqNum,String username,String passwd){
		this.seqNum = seqNum;
		this.username = username;
		this.passwd = passwd;
	}

	public GET_BIND_PHONE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
