 ...
 * </table>
 */
public class USER_QUERY_PROTECT_QUESTION_REQ implements RequestMessage{
	...
	public USER_QUERY_PROTECT_QUESTION_REQ(){
	}

	public USER_QUERY_PROTECT_QUESTION_REQ(long seqNum,String clientId,String username){
		this.seqNum = seqNum;
		this.clientId = clientId;
		this.username = username;
	}

	public USER_QUERY_PROTECT_QUESTION_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "USER_QUERY_PROTECT_QUESTION_REQ";
	}
