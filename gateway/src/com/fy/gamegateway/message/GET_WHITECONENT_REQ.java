 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>whitecontent.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>whitecontent</td><td>String</td><td>whitecontent.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class GET_WHITECONENT_REQ implements RequestMessage{
	...
	public GET_WHITECONENT_REQ(long seqNum,String clientId,String username,String password,String whitecontent){
		this.seqNum = seqNum;
	...
	public GET_WHITECONENT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
