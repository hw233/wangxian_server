 ...
 * </table>
 */
public class QUERY_CLIENT_INFO_RES implements ResponseMessage{
	...
	public QUERY_CLIENT_INFO_RES(){
	}

	public QUERY_CLIENT_INFO_RES(long seqNum,String serverName,String username,String clientId,String channel,String uuid,String deviceId,String platform,String network,String phoneType,String programVersion){
		this.seqNum = seqNum;
	...
	public QUERY_CLIENT_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
