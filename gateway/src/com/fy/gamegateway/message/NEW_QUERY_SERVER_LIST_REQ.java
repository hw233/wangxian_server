 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>authCode.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>authCode</td><td>String</td><td>authCode.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class NEW_QUERY_SERVER_LIST_REQ implements RequestMessage{
	...
	public NEW_QUERY_SERVER_LIST_REQ(){
	}

	public NEW_QUERY_SERVER_LIST_REQ(long seqNum,String clientId,String username,String password,String authCode){
		this.seqNum = seqNum;
	...
	public NEW_QUERY_SERVER_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "NEW_QUERY_SERVER_LIST_REQ";
	}
