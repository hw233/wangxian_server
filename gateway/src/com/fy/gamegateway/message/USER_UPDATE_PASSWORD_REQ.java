 ...
 * </table>
 */
public class USER_UPDATE_PASSWORD_REQ implements RequestMessage{
	...
	public USER_UPDATE_PASSWORD_REQ(){
	}

	public USER_UPDATE_PASSWORD_REQ(long seqNum,String clientId,String username,String passwd,String newpasswd){
		this.seqNum = seqNum;
	...
	public USER_UPDATE_PASSWORD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "USER_UPDATE_PASSWORD_REQ";
	}
