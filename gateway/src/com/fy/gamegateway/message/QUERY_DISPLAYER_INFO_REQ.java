 ...
 * </table>
 */
public class QUERY_DISPLAYER_INFO_REQ implements RequestMessage{
	...
	public QUERY_DISPLAYER_INFO_REQ(){
	}

	public QUERY_DISPLAYER_INFO_REQ(long seqNum,String platform,String channel){
		this.seqNum = seqNum;
		this.platform = platform;
		this.channel = channel;
	}

	public QUERY_DISPLAYER_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_DISPLAYER_INFO_REQ";
	}
