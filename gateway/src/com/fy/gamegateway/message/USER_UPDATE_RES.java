 ...
 * </table>
 */
public class USER_UPDATE_RES implements ResponseMessage{
	...
	public USER_UPDATE_RES(){
	}

	public USER_UPDATE_RES(long seqNum,byte result,String message){
		this.seqNum = seqNum;
		this.result = result;
		this.message = message;
	}

	public USER_UPDATE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
