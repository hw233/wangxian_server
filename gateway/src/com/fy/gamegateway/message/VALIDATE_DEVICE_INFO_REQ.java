 ...
 * </table>
 */
public class VALIDATE_DEVICE_INFO_REQ implements RequestMessage{
	...
	public VALIDATE_DEVICE_INFO_REQ(){
	}

	public VALIDATE_DEVICE_INFO_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public VALIDATE_DEVICE_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "VALIDATE_DEVICE_INFO_REQ";
	}
