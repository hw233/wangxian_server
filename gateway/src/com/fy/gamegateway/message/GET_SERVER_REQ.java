 ...
 * </table>
 */
public class GET_SERVER_REQ implements RequestMessage{
	...
	public GET_SERVER_REQ(long seqNum,String clientId,String username,String password,String authCode){
		this.seqNum = seqNum;
	...
	public GET_SERVER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
