 ...
 * </table>
 */
public class GET_REGISTER_IMAGE_REQ implements RequestMessage{
	...
	public GET_REGISTER_IMAGE_REQ(){
	}

	public GET_REGISTER_IMAGE_REQ(long seqNum,String clientId){
		this.seqNum = seqNum;
		this.clientId = clientId;
	}

	public GET_REGISTER_IMAGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
