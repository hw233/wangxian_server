 ...
 * </table>
 */
public class DO_SOME_RES implements ResponseMessage{
	...
	public DO_SOME_RES(long seqNum,long create){
		this.seqNum = seqNum;
		this.create = create;
	}

	public DO_SOME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
