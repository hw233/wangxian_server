 ...
 * </table>
 */
public class USER_GET_PASSWORD_PROTECT_INFO_REQ implements RequestMessage{
	...
	public USER_GET_PASSWORD_PROTECT_INFO_REQ(){
	}

	public USER_GET_PASSWORD_PROTECT_INFO_REQ(long seqNum,String clientId,String username,String passwd){
		this.seqNum = seqNum;
	...
	public USER_GET_PASSWORD_PROTECT_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "USER_GET_PASSWORD_PROTECT_INFO_REQ";
	}
