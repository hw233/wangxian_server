 ...
 * </table>
 */
public class NOTIFY_USER_LEAVESERVER_REQ implements RequestMessage{
	...
	public NOTIFY_USER_LEAVESERVER_REQ(){
	}

	public NOTIFY_USER_LEAVESERVER_REQ(long seqNum,String servername,String username,String MACADDRESS,String ipAddress){
		this.seqNum = seqNum;
	...
	public NOTIFY_USER_LEAVESERVER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "NOTIFY_USER_LEAVESERVER_REQ";
	}
