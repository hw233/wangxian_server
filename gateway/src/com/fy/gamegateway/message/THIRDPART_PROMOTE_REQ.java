 ...
 * </table>
 */
public class THIRDPART_PROMOTE_REQ implements RequestMessage{
	...
	public THIRDPART_PROMOTE_REQ(){
	}

	public THIRDPART_PROMOTE_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public THIRDPART_PROMOTE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
