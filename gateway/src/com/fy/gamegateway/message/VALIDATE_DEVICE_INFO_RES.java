 ...
 * </table>
 */
public class VALIDATE_DEVICE_INFO_RES implements ResponseMessage{
	...
	public VALIDATE_DEVICE_INFO_RES(){
	}

	public VALIDATE_DEVICE_INFO_RES(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public VALIDATE_DEVICE_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "VALIDATE_DEVICE_INFO_RES";
	}
