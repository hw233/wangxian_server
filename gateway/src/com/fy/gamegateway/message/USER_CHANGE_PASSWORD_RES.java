 ...
 * </table>
 */
public class USER_CHANGE_PASSWORD_RES implements ResponseMessage{
	...
	public USER_CHANGE_PASSWORD_RES(){
	}

	public USER_CHANGE_PASSWORD_RES(long seqNum,byte result,String message){
		this.seqNum = seqNum;
		this.result = result;
		this.message = message;
	}

	public USER_CHANGE_PASSWORD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "USER_CHANGE_PASSWORD_RES";
	}
