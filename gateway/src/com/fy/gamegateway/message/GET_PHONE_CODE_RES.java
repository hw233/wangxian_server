 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>phoneCode</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class GET_PHONE_CODE_RES implements ResponseMessage{
	...
	public GET_PHONE_CODE_RES(){
	}

	public GET_PHONE_CODE_RES(long seqNum,int phoneCode,String result){
		this.seqNum = seqNum;
		this.phoneCode = phoneCode;
		this.result = result;
	}

	public GET_PHONE_CODE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
