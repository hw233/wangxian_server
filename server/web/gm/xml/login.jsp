...
<%
	...
	if(players ==  null){
		...
		for(int i = 0 ; i < players.length ; i++){
			out.println("<tr align='center' bgcolor='#FFFFFF'><td><a href='./login.jsp?pid="+players[i].getId()+"&action=select_player'>"+players[i].getId()+"</a></td><td>"+players[i].getName()+"</td><td>"+players[i].getRmbyuanbao()+"</td><td>"+players[i].getMoney()+"</td></tr>");
		}
		out.println("</table>");
	}
