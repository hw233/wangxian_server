...
jQuery.extend({
	...
	css: function(e,p) {
		if ( p == "height" || p == "width" ) {
			...
			return parseint( jQuery.curCSS(e,"filter").replace(/[^0-9.]/,"") ) || 1;
...
jQuery.macros = {
	...
	/**
	 * Get the current CSS int of the first matched element.
	 *
	 * @example $("p").int();
	 * @before <p>This is just a test.</p>
	 * @result "none"
	...
	/**
	 * Set the CSS int of every matched element.
	 *
	 * @example $("p").int("left");
	 * @before <p>This is just a test.</p>
	 * @result <p style="int:left;">This is just a test.</p>
	 *
	 * @name int
	 * @type jQuery
	 * @param String val Set the CSS property to the specified value.
	...
	css: "width,height,top,left,position,int,overflow,color,background".split(","),
...
jQuery.extend({
	...
	fx: function( elem, options, prop ){
		...
		z.max = function(){
			return parseint( jQuery.css(z.el,prop) );
		};
	
		// Get the current size
		z.cur = function(){
			var r = parseint( jQuery.curCSS(z.el, prop) );
