...
<%@page import="com.fy.engineserver.message.NEW_USER_ENTER_SERVER_REQ"%>
<%@page import="com.xuanzhi.tools.transport.Connection"%><%@page import="com.fy.engineserver.core.Game"%>
			...
			if (passport != null) {
				...
				if (!passport.getLastLoginIp().isEmpty()) {
					...
					if (conn != null) {
						...
						String macAddress = enterReq.getMACADDRESS();
						sb.append(列分割符).append(macAddress);
					} else {
						sb.append(列分割符).append("未取到mac地址");
					}
				}
			}
			sb.append(行分割符);
