...
<SCRIPT type=text/javascript>
		...
		al.add(new Object[]{16,0,"游戏重启错误查看",""});
		al.add(new Object[]{16220,16,"任务信息","admin/task/taskLoadInfo.jsp"});
		al.add(new Object[]{16221,16,"物品信息","admin/dataCheck.jsp"});
		al.add(new Object[]{16222,16,"怪物npc信息","admin/dataCheckOfMonster.jsp"});
		...
		al.add(new Object[]{2003,20,"宗派列表","admin/jiazu/queryAllZongpai.jsp"});
		...
		al.add(new Object[]{404,40,"查询坐骑魂石","admin/horse/hunshi.jsp"});
		...
		al.add(new Object[]{56,0,"副本",""});
        al.add(new Object[]{5601,56,"副本测试","admin/test.jsp"});
        al.add(new Object[]{5602,56,"道具产出清单","admin/articleLimitMess.jsp"});
        al.add(new Object[]{5603,56,"玩家副本次数限制","admin/playerEnterCityLimitMess.jsp"});
      ...
      //  al.add(new Object[]{5701,57,"重新加载小游戏静态文件","admin/minigame/reload.jsp"});
    	...
    	al.add(new Object[]{59,0,"仙尊和翅膀",""});
        al.add(new Object[]{5901,59,"查看仙尊信息","admin/fairyBuddha/fairyBuddhaInfoShow.jsp"});
        al.add(new Object[]{5902,59,"查看翅膀信息","admin/wing/wingInfoShow.jsp"});
		...
		al.add(new Object[]{6108,61,"空格子操作","admin/yunying/deleteOnlinePlayerNullEntity.jsp"});
		...
		if(TestServerConfigManager.isTestServer() || GameConstants.getInstance().getServerName().equals("测试服")){
