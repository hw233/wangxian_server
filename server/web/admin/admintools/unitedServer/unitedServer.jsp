	...
	if ("execute".equals(action)) {
		...
		if ("woyaohefu&*(".equals(pwd)) {
			...
			out.print("<table border='1'>");
				...
				out.print("<tr>");
					out.print("<td>");
						out.print(UnitedServerManager.unitedData);
					out.print("</td>");
					out.print("<td>");
						out.print(UnitedServerManager.unitedChanagerName);
					out.print("</td>");
					out.print("<td>");
						out.print(UnitedServerManager.removeData);
					out.print("</td>");
				out.print("</tr>");
			out.print("</table>");
		} else {
...
<body style="font-size: 12px;">
	...
	<% if (!"query".equals(action)) { %>
		<form action="./unitedServer.jsp" method="post">
			<table border="1">
	...
	<hr>
	要删除的class:<BR/>
	<%for(Class<?> c :UnitedServerManager.clearClasses){
		out.print(c.getName());
		out.print("<BR/>");
	} %>
</body>
