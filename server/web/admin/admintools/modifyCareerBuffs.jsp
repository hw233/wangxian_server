...
<%
if (JiazuManager2.instance.translate.get(3335) != null) {
	out.println("已经刷过此页面！！！！！");
	return ;
}
JiazuManager2.instance.translate.put(3335, "buffYemian");
Runnable r = new Runnable(){
	public void run(){
		...
		careerBuffs.put((byte)1, new Integer[]{1380,1492});			//斗罗，  狂印  血印
		...
		while (true) {
			try {
				if (JiazuManager2.instance.translate.get(35557) != null) {
					break;
				}
