...
<%
	...
	for (Data data : thisServer) {
		try {
			...
			if (p != null) {
				...
				//out.print(p.getLogString() + "从【仓库】删除" + articleName + ",需要删除" + data.removeNum + "个，实际删除了：" + 实际删除数_仓库 + "<br>");
	...
	out.print("<B>" + serverName + ".删除" + articleName + ",颜色:" + color + "完毕,总人数:" + thisServer + "[" + thisServerRemoveNum + "/" + thisServerTotalNum + "]</B>");
%>
