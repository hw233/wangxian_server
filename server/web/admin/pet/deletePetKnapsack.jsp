		...
		if(name == null || name.equals("")){
			...
			for(Cell c:cells){
				...
				if(ae == null){
					c.entityId = -1;
					k.setModified(true);
					PetManager.logger.error("[后台修改宠物背包] [物品null] [删除] ["+player.getLogString()+"] [物品:"+id+"]");
				}else{
					if(ae instanceof PetPropsEntity ){
						...
						if(pet != null){
							...
							c.entityId = -1;
							k.setModified(true);
							PetManager.logger.error("[后台修改宠物背包] [宠物null] [删除] ["+player.getLogString()+"] [物品id:"+id+"] [petId:"+petId+"]");
							out.print("删除成功"+"<br/>");
						}
					}
				}
