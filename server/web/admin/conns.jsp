...
<tr bgcolor="#00FFFF" align="center"><td>名称</td><td>别名</td><td><%=dcs.isClientModel()?"服务器":"客户端"%>地址</td><td>Checkout</td><td>状态</td><td>发送-接收</td><td>使用/空闲时间</td><td width="15%">滑动窗口</td><td width="10%">发送缓冲区</td><td width="10%">接收缓冲区</td></tr>
<%
