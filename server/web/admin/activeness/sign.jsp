		...
		if (player != null) {
			if (pai != null) {
				if (!TestServerConfigManager.isTestServer()) {
					...
					if ("".equals(pwd) || pwd == null || !pwd.equals("pwd")) {
						out.print("密码不正确");
					}
				}
...
<form action="">角色名：<input type="text" name="playerName" /><br />
签到日期（用英文逗号间隔）：<input type="text" name="days" /><br />
清除签到日期（用英文逗号间隔）：<input type="text" name="days2" /><br />
