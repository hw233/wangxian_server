	...
	<body>
		...
		<%
			...
			if(st != null && !st.equals("")){
				...
				//飞行坐骑活动
				String dateString = LogRecordManager.sdf.format(new Date(SystemTime.currentTimeMillis()+5*60*1000));
				out.print("设置在5分钟后打印活动日志"+dateString+"<br/>");
				...
				out.print("滚屏公告会在2分钟后滚动");
				return;
			}
		%>
		
		<form action="">
			设置(飞行坐骑活动):<input type="text" name="id" />
