...
<body>
	...
	<%
		...
		if(ex != null && !ex.equals("")){
			...
			if(o != null){
				...
				pr.setLastOnlineReceiveTime(System.currentTimeMillis() - 1l*24*60*60*1000);
			}else{
				out.print("dish player null");
			}
			out.print("设置成功<br/>");
			return;
		}
	...
	<form action="">
		腾讯在线设置上次接受时间playerName:<input type="text" name="server" >
