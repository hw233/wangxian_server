<%@ page language="java" pageEncoding="utf-8" contentType="text/html;charset=utf-8" import="java.util.*,com.xuanzhi.tools.cache.diskcache.concrete.*"%><%@ page import="com.xuanzhi.tools.text.StringUtil" %><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
	...
	<tr>
		<%
			...
			for(int j = 0 ; j < al.size() ; j++){
				...
				int rate = (int)(db.length * 100f/totalLen);
