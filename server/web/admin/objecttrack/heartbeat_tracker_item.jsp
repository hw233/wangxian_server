...
%>
<%
	long start = now-HeartbeatTrackerServiceHelper.getTrackDurationInSeconds()*1000+index*step*1000;
	long end = start + step*1000;
		ArrayList<HeartBeatTracker.HeartBeatItem> al = oct.getStatOperationItems(start,end);
...
<script language="JavaScript">
	...
	<body>
		...
		for(int i = 0 ; i < al.size() ; i++){
			HeartBeatTracker.HeartBeatItem oi = al.get(i);
