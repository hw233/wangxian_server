...
<%for(int i = 0; i < dependencys.length; i++){ 
	...
	if(depStr != null){
		if(i != (dependencys.length - 1)){
%>
<tr>
<td class="tdtable width align borderbottom"><a href="TasksView.jsp?dependency=<%=depStr %>" ><%=(depStr.indexOf("（旧）")>= 0 ? "<font color='red'>"+depStr+"</font>":depStr) %></a></td>
</tr>
<%
	}else{
		%>
		<tr>
		<td class="tdtable width align"><a href="TasksView.jsp?dependency=<%=depStr %>" ><%=(depStr.indexOf("（旧）")>= 0 ? "<font color='red'>"+depStr+"</font>":depStr) %></a></td>
		</tr>
		<%
	}
	}
...
<tr align="center">
  				...
  				<td colspan="8" class="righttd" width="360" align="center" style="word-wrap: break-word;">任务奖励</td>
  				</tr>
  				<tr>
	  			<td>钱</td>
				<td>经验</td>
