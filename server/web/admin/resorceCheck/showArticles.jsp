...
<div class="clearfix">
	...
	if(null==type||"".equals(type)){
		...
		out.print("<table style='font-size: 12px; text-align:left;width:600px;position:relative;left:2px' border='1'><tr id='tbhead'><td>物品名</td><td>等级</td><td>颜色</td><td>描述</td></tr>");
		while(iter.hasNext()){
			Article aa = iter.next();
			out.print("<tr class='color"+aa.getColorType()+"'><td><a href='../ArticleByName.jsp?articleName="+aa.getName()+"'>"+aa.getName()+"</td><td>"+aa.getArticleLevel()+"</td><td>"+aa.getColorType()+"</td><td>"+aa.getDescription()+"</td>");
		}
	}
