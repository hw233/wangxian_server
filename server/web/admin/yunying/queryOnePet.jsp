...
<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@page
	import="java.util.*,com.xuanzhi.tools.text.*,com.fy.engineserver.datasource.article.manager.*,com.fy.engineserver.datasource.article.data.props.*,com.fy.engineserver.datasource.article.data.entity.*,com.fy.engineserver.util.*,com.fy.engineserver.sprite.*,com.fy.engineserver.sprite.pet.*,com.fy.engineserver.datasource.skill2.GenericBuff"%>
...
%>
<form action="">输入宠物id:<input type="text" name="petId"></input> <br />
...
<input type="submit" value="sumit"></input></form>
...
<%
		...
		if (pet != null) {
			...
			while (b != null) {
				out.print(" 技能名称 ");
				out.print(b.srcSkName);
				out.print(" attId ");
				out.print(b.attId);
				out.print(" 属性名称 ");
				out.print(b.attName + ":" + id2name.get(b.attId));
				out.print(" 值 ");
				out.print(b.v);
				out.print(" 是否百分比 ");
				out.print(b.percent);
				...
				out.print(" paramInt ");
				out.print(b.paramInt);
				out.print(" paramIntB ");
				out.print(b.paramIntB);
				out.print(" <br/> ");
				b = b.next;
			}
			out.print(" $ ");
