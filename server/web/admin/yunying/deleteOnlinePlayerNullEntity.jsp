		...
		for (int i = 0; i < cells.length; i++) {
			...
			if (entityId > 0) {
				...
				if (ae == null) {
					...
					sbf.append("[发现不存在的物品] [aeId:" + entityId + "][数量:" + cell.getCount() + "]<br>");
					count++;
...
<%@page import="com.fy.engineserver.datasource.article.data.magicweapon.huntLife.instance.HuntLifeEntity"%><html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>查看在线玩家空格子</title>
</head>
<body>
<form action="deleteOnlinePlayerNullEntityAction.jsp" method="post"><input
	type="hidden" name="action" value="delete"><input
	type="password" name="password" value=""> <input type="submit"
	value="清除在线玩家空格子"></form>
</body>
</html>