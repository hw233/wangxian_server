...
<%
	...
	List<Data> list = new ArrayList<Data>();
	{
		if (PlatformManager.getInstance().isPlatformOf(Platform.官方)) {
			...
			list.add(new Data("众仙归来", 1114000000000004641L, 891));
			list.add(new Data("众仙归来", 1114000000000118704L, 990));
			list.add(new Data("华山之巅", 1111000000000001109L, 743));
			list.add(new Data("幽冥山谷", 1103000000000122895L, 99));
			list.add(new Data("幽冥山谷", 1103000000000054752L, 594));
			list.add(new Data("幽冥山谷", 1103000000000127133L, 297));
			list.add(new Data("幽冥山谷", 1103000000000024722L, 495));
			list.add(new Data("幽冥山谷", 1103000000000088676L, 891));
			list.add(new Data("幽冥山谷", 1103000000000045243L, 792));
			list.add(new Data("幽冥山谷", 1103000000000054348L, 1683));
			list.add(new Data("幽冥山谷", 1103000000000087511L, 2772));
			list.add(new Data("幽冥山谷", 1103000000000008715L, 396));
			list.add(new Data("幽冥山谷", 1103000000000014077L, 396));
			list.add(new Data("幽冥山谷", 1103000000000013684L, 99));
			list.add(new Data("幽冥山谷", 1103000000000156026L, 1287));
			list.add(new Data("幽冥山谷", 1103000000000022582L, 891));
			list.add(new Data("幽冥山谷", 1103000000000107001L, 1881));
			list.add(new Data("幽冥山谷", 1103000000000103787L, 99));
			list.add(new Data("幽冥山谷", 1103000000000102634L, 1683));
			list.add(new Data("幽冥山谷", 1103000000000129620L, 99));
			list.add(new Data("幽冥山谷", 1103000000000121037L, 6138));
			list.add(new Data("幽冥山谷", 1103000000000111327L, 8118));
			list.add(new Data("幽冥山谷", 1103000000000078677L, 1584));
			list.add(new Data("幽冥山谷", 1103000000000073514L, 495));
			list.add(new Data("幽冥山谷", 1103000000000087287L, 693));
			list.add(new Data("幽冥山谷", 1103000000000001926L, 198));
			list.add(new Data("幽冥山谷", 1103000000000147638L, 99));
			list.add(new Data("幽冥山谷", 1103000000000066682L, 99));
			list.add(new Data("幽冥山谷", 1103000000000092232L, 7425));
			list.add(new Data("幽冥山谷", 1103000000000137366L, 2871));
			list.add(new Data("幽冥山谷", 1103000000000089844L, 2376));
			list.add(new Data("幽冥山谷", 1103000000000120569L, 8415));
			list.add(new Data("幽冥山谷", 1103000000000122153L, 891));
			list.add(new Data("幽冥山谷", 1103000000000106590L, 8316));
			list.add(new Data("幽冥山谷", 1103000000000088404L, 99));
			list.add(new Data("幽冥山谷", 1103000000000129842L, 99));
			list.add(new Data("幽冥山谷", 1103000000000052698L, 12969));
			list.add(new Data("幽冥山谷", 1103000000000100561L, 792));
			list.add(new Data("幽冥山谷", 1103000000000015787L, 5643));
			list.add(new Data("幽冥山谷", 1103000000000072057L, 1782));
			list.add(new Data("幽冥山谷", 1103000000000109311L, 198));
			list.add(new Data("幽冥山谷", 1103000000000105874L, 495));
			list.add(new Data("幽冥山谷", 1103000000000055772L, 99));
			list.add(new Data("幽冥山谷", 1103000000000081666L, 198));
			list.add(new Data("幽冥山谷", 1103000000000111310L, 99));
			list.add(new Data("幽冥山谷", 1103000000000155672L, 2178));
			list.add(new Data("幽冥山谷", 1103000000000065419L, 396));
			list.add(new Data("幽冥山谷", 1103000000000047575L, 99));
			list.add(new Data("幽冥山谷", 1103000000000019436L, 1089));
			list.add(new Data("幽冥山谷", 1103000000000156089L, 396));
			list.add(new Data("幽冥山谷", 1103000000000007779L, 1980));
			list.add(new Data("幽冥山谷", 1103000000000044360L, 495));
			list.add(new Data("幽冥山谷", 1103000000000120881L, 99));
			list.add(new Data("幽冥山谷", 1103000000000124038L, 99));
			list.add(new Data("幽冥山谷", 1103000000000008533L, 1386));
			list.add(new Data("幽冥山谷", 1103000000000031549L, 1584));
			list.add(new Data("幽冥山谷", 1103000000000079867L, 99));
			list.add(new Data("幽冥山谷", 1103000000000080600L, 396));
			list.add(new Data("幽冥山谷", 1103000000000024554L, 4158));
			list.add(new Data("幽冥山谷", 1103000000000067036L, 594));
			list.add(new Data("幽冥山谷", 1103000000000140310L, 297));
			list.add(new Data("幽冥山谷", 1103000000000017274L, 99));
			list.add(new Data("幽冥山谷", 1103000000000083474L, 693));
			list.add(new Data("幽冥山谷", 1103000000000156764L, 2475));
			list.add(new Data("幽冥山谷", 1103000000000035593L, 891));
			list.add(new Data("幽冥山谷", 1103000000000012283L, 594));
			list.add(new Data("幽冥山谷", 1103000000000137324L, 198));
			list.add(new Data("幽冥山谷", 1103000000000013470L, 99));
			list.add(new Data("幽冥山谷", 1103000000000072275L, 396));
			list.add(new Data("幽冥山谷", 1103000000000122039L, 99));
			list.add(new Data("幽冥山谷", 1103000000000042957L, 594));
			list.add(new Data("幽冥山谷", 1103000000000139469L, 3960));
			list.add(new Data("幽冥山谷", 1103000000000065624L, 1980));
			list.add(new Data("幽冥山谷", 1103000000000062472L, 2376));
			list.add(new Data("幽冥山谷", 1103000000000113451L, 693));
			list.add(new Data("幽冥山谷", 1103000000000137326L, 198));
			list.add(new Data("幽冥山谷", 1103000000000135288L, 3564));
			list.add(new Data("霸气乾坤", 1105000000000203759L, 396));
			list.add(new Data("霸气乾坤", 1105000000000128012L, 990));
			list.add(new Data("霸气乾坤", 1105000000000128650L, 594));
			list.add(new Data("烟雨清山", 1107000000000042042L, 198));
	...
	for (Data data : thisServer) {
		...
		try {
			...
			int removeNum = 0;
			if (p != null) {
				List<Mail> mails = mmanager.getAllMails(p);
				if (mails != null && mails.size() > 0) {
					Iterator<Mail> itor = mails.iterator();
					while (itor.hasNext()) {
						Mail mail = itor.next();
						if (!mail.getContent().contains("恭喜您获得灵兽内丹奖励")) {
							continue;
						}
						Cell cell = mail.getCells()[0];
						if (cell != null) {
							long aeId = cell.getEntityId();
							ArticleEntity ae = ArticleEntityManager.getInstance().getEntity(aeId);
							if (ae != null && articleName.equals(ae.getArticleName()) && ae.getColorType() == color && ae.isBinded()) {
								mmanager.deleteMail((mail.getId()));
								itor.remove();
								removeNum++;
							}
						}
				...
				out.print("[" + serverName + "]删除玩家灵兽内丹邮件:[" + p.getLogString() + "] [删除数量:" + removeNum + "]<BR/>");
				thisServerRemoveNum += removeNum;
			}
		} catch (Exception e) {

		}
	}
	out.print("<font color=red><b>[" + serverName + "]删除玩家灵兽内丹邮件 [总删除数量:" + thisServerRemoveNum + "]</b></font><BR/>");
	
%>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title><%="删除邮件" + GameConstants.getInstance().getServerName() %></title>
</head>
<body>
