...
<%@page import="java.io.OutputStream"%><%@page import="java.net.URLEncoder"%><%@page import="com.xuanzhi.boss.game.GameConstants"%><%@page import="com.fy.engineserver.activity.TransitRobbery.TransitRobberyManager"%><%@page import="com.fy.engineserver.sprite.pet.PetFlyState"%><%@page	import="com.fy.engineserver.activity.fairyRobbery.FairyRobberyEntityManager"%><%@page	import="com.fy.engineserver.activity.fairyRobbery.instance.FairyRobberyEntity"%><%@page import="com.fy.engineserver.talent.FlyTalentManager"%><%@page import="com.fy.engineserver.talent.TalentData"%><%@page import="com.fy.engineserver.datasource.article.data.articles.InlayArticle"%><%@page import="com.fy.engineserver.datasource.article.manager.ArticleManager"%><%@page	import="com.fy.engineserver.datasource.article.data.articles.Article"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.BaoShiXiaZiData"%><%@page	import="com.fy.engineserver.datasource.article.data.magicweapon.huntLife.instance.HuntArticleExtraData"%><%@page	import="com.fy.engineserver.articleEnchant.EnchantEntityManager"%><%@page import="com.fy.engineserver.articleEnchant.EnchantData"%><%@page	import="com.fy.engineserver.datasource.article.concrete.DefaultArticleEntityManager"%><%@page	import="com.fy.engineserver.datasource.article.data.magicweapon.huntLife.HuntLifeEntityManager"%><%@page	import="com.fy.engineserver.datasource.article.data.magicweapon.huntLife.instance.HuntLifeEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.HuntLifeArticleEntity"%><%@page import="com.xuanzhi.tools.simplejpa.SimpleEntityManager"%><%@page import="java.util.Iterator"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.NewMagicWeaponEntity"%><%@page import="com.fy.engineserver.activity.dig.DigPropsEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.YinPiaoEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.QiLingArticleEntity"%><%@page	import="com.fy.engineserver.sprite.pet.SingleForPetPropsEntity"%><%@page	import="com.fy.engineserver.activity.explore.ExploreResourceMapEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.Special_2EquipmentEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.Special_1EquipmentEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.PropsEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.PetPropsEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.PetEggPropsEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.MagicWeaponEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.FateActivityPropsEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.ExchangeArticleEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.BottlePropsEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.BiWuArticleEntity"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.EquipmentEntity"%><%@page	import="com.xuanzhi.tools.simplejpa.impl.SimpleEntityManagerFactoryImpl"%><%@page import="com.xuanzhi.tools.simplejpa.SimpleEntityManagerFactory"%><%@page import="com.fy.engineserver.wing.WingManager"%><%@page import="com.fy.engineserver.wing.WingPanel"%><%@page	import="com.fy.engineserver.homestead.faery.service.FaeryManager"%><%@page import="com.fy.engineserver.homestead.cave.Cave"%><%@page	import="com.fy.engineserver.playerAims.instance.PlayerAimsEntity"%><%@page	import="com.fy.engineserver.playerAims.manager.PlayerAimeEntityManager"%><%@page	import="com.fy.engineserver.sprite.horse2.manager.Horse2EntityManager"%><%@page	import="com.fy.engineserver.sprite.horse2.instance.Horse2RelevantEntity"%><%@page import="com.fy.engineserver.newtask.NewDeliverTaskManager"%><%@page import="com.fy.engineserver.newtask.NewDeliverTask"%><%@page import="com.fy.engineserver.buffsave.BufferSaveManager"%><%@page import="com.fy.engineserver.buffsave.BuffSave"%><%@page	import="com.fy.engineserver.activity.TransitRobbery.TransitRobberyEntityManager"%><%@page	import="com.fy.engineserver.activity.TransitRobbery.TransitRobberyEntity"%><%@page	import="com.fy.engineserver.datasource.skill.master.SkEnhanceManager"%><%@page import="com.fy.engineserver.datasource.skill.master.SkBean"%><%@page	import="com.fy.engineserver.articleProtect.PlayerArticleProtectData"%><%@page	import="com.fy.engineserver.articleProtect.ArticleProtectData"%><%@page import="com.fy.engineserver.minigame.MiniGameEntityManager"%><%@page import="com.fy.engineserver.minigame.MiniGameEntity"%><%@page	import="com.fy.engineserver.activity.activeness.ActivenessManager"%><%@page	import="com.fy.engineserver.activity.activeness.PlayerActivenessInfo"%><%@page import="com.fy.engineserver.sprite.pet2.Pet2Manager"%><%@page import="com.fy.engineserver.sprite.pet2.PetsOfPlayer"%><%@page	import="com.fy.engineserver.activity.worldBoss.WorldBossRankManager"%><%@page import="com.fy.engineserver.activity.worldBoss.WBossBean"%><%@page import="com.fy.engineserver.sprite.pet.Pet"%><%@page import="com.fy.engineserver.sprite.pet.PetManager"%><%@page import="com.xuanzhi.tools.text.JsonUtil"%><%@page import="com.fy.engineserver.sprite.horse.Horse"%><%@page import="com.fy.engineserver.sprite.horse.HorseManager"%><%@page import="com.fy.engineserver.hotspot.HotspotManager"%><%@page import="com.fy.engineserver.hotspot.HotspotInfo"%><%@page import="com.fy.engineserver.hotspot.Hotspot"%><%@page import="java.util.List"%><%@page import="com.fy.engineserver.achievement.AchievementEntity"%><%@page import="java.util.HashMap"%><%@page import="com.fy.engineserver.achievement.AchievementManager"%><%@page import="com.fy.engineserver.achievement.GameDataRecord"%><%@page import="com.fy.engineserver.newtask.TaskEntityManager"%><%@page import="com.fy.engineserver.newtask.TaskEntity"%><%@page	import="com.fy.engineserver.newtask.service.DeliverTaskManager"%><%@page import="com.fy.engineserver.newtask.DeliverTask"%><%@page	import="com.fy.engineserver.datasource.article.manager.ArticleEntityManager"%><%@page	import="com.fy.engineserver.datasource.article.data.entity.ArticleEntity"%><%@page import="com.fy.engineserver.sprite.Soul"%><%@page import="com.fy.engineserver.qiancengta.QianCengTa_Ceng"%><%@page import="com.fy.engineserver.qiancengta.QianCengTa_Dao"%><%@page import="com.fy.engineserver.qiancengta.QianCengTaManager"%><%@page import="com.fy.engineserver.qiancengta.QianCengTa_Ta"%><%@page import="java.util.HashSet"%><%@page import="java.util.ArrayList"%><%@page import="com.fy.engineserver.sprite.PlayerManager"%><%@page import="com.fy.engineserver.sprite.Player"%><%@page import="com.xuanzhi.tools.text.ParamUtils"%><%@page import="java.util.LinkedHashMap"%><%@page import="java.util.Map"%><%@ page language="java" contentType="text/html; charset=UTF-8"	pageEncoding="UTF-8"%>
<%
...
<%!public String queryPlayerInfos(long playerId) throws Exception {
		...
		if (player != null) {
			...
			ArrayList<HorseEquInlay> horseInlays = new ArrayList<HorseEquInlay>();	//坐骑装备镶嵌神匣
			ArrayList<BaoShiXiaZiData> baoshixiazis = new ArrayList<BaoShiXiaZiData>(); //宝石匣子
			ArrayList<PetSuitArticleEntity> petSuits = new ArrayList<PetSuitArticleEntity>(); //宠物饰品
					...
					for (int i=0; i<player.getPetKnapsack().size(); i++) {
						try {
							if (player.getPetKnapsack().getCell(i) != null) {
								if (player.getPetKnapsack().getCell(i).getEntityId() > 0) {
									articleIds.add(player.getPetKnapsack().getCell(i).getEntityId());
								}
							}
						} catch (Exception e) {
						}
			...
			{	//获取玩家灵髓
				...
				if (soulpithentity != null) {
					...
					for (PlayerSoulpithInfo info : soulpithentity.getPithInfos()) {
			...
			{		//仙灵
				PlayerXianLingData xianlingData = XianLingManager.xianlingEm.find(player.getId());
				if (xianlingData != null) {
					returnHashMap.put("xianlingData", xianlingData);
				}
			...
			//获取玩家的Pet
			{
				...
				QuerySelect<Pet> querySelect = new QuerySelect<Pet>();
				List<Pet> allJiazu = querySelect.selectAll(Pet.class, "ownerId=" + player.getId() + " and delete='F' or (delete='T' and rarity >= 3)", new Object[] {}, null, PetManager.getInstance().em);
				...
				for (Pet pet : list) {
					...
					for (int k=0; k<pet.getOrnaments().length; k++) {
						if (pet.getOrnaments()[k] <= 0) {
							continue;
						}
						PetSuitArticleEntity pae = (PetSuitArticleEntity)ArticleEntityManager.getInstance().getEntity(pet.getOrnaments()[k]);	
						if (pae != null) {
							petSuits.add(pae);
						}
					}
			...
			{	//家族修理
				...
				if (jm2 != null) {
					returnHashMap.put("JiazuMember2", jm2);
				}
			}
			...
			for (Long articleId : articleIds) {
				...
				if (articleEntity.getClass().equals(NewMagicWeaponEntity.class)) {
				...
				} else if (articleEntity.getClass().equals(PetSuitArticleEntity.class)) {
					petSuits.add((PetSuitArticleEntity)articleEntity);
					...
					{	//检测坐骑装备镶嵌情况
						HorseEquInlay hei = HorseEquInlayEntityManager.getInst().getEntity(equipmentEntity);
						if (hei != null) {
							horseInlays.add(hei);
							for (int k=0; k<hei.getInlayArticleIds().length; k++) {
								if (hei.getInlayArticleIds()[k] > 0) {
									moreArticleIds.add(hei.getInlayArticleIds()[k]);
								}
							}
						}
					}
			...
			returnHashMap.put(PetSuitArticleEntity.class.getName(), petSuits);
			...
			returnHashMap.put(HorseEquInlay.class.getName(), horseInlays);
