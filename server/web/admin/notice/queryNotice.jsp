...
<body>
	...
	<%
		...
		List<Notice> list1 =  nm.getCircleList();
		...
		<table cellspacing="1" cellpadding="2" border="1" >
			<tr>
 			...
 			<tr>
 				...
 				<td><%= endTime%></td>
 				<td><%=effectSt %></td>
 				<td><a href="queryOneLoginNotice.jsp?id=<%=n.getId() %>">查看</a><%="||" %><a href="deleteNotice.jsp?id=<%=n.getId() %>">删除</a></td>
 			</tr>
			...
			out.print("<a href=\"setLoginNotice.jsp\">设置登陆公告</a>");
		}
	%>
