...
<body>
	...
	<%
		...
		List<Notice> list1 =  nm.getActivityList();
		if(list1 != null && list1.size() > 0){
			
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			
			Notice effect = nm.getActivityNotice();
			String beginTime = "";
			String endTime = "";
		...
		<table cellspacing="1" cellpadding="2" border="1" >
			<tr>
 				...
 				<th>公告失效时间(2011-01-11 00:00:00)</th>
 				<th>正在起作用</th>
 				<th>操作</th>
 			</tr>
 			...
 			<tr>
 				...
 				<td><%= endTime%></td>
 				<td><%=effectSt %></td>
 				<td><a href="queryOneActivityNotice.jsp?id=<%=n.getId() %>">查看</a><%="||" %><a href="deleteNotice.jsp?id=<%=n.getId() %>">删除</a></td>
 			</tr>
			...
			out.print("现在还没有公告<br/>");
			out.print("<a href=\"setActivityNotice.jsp\">设置活动公告</a>");
		}
	%>
