...
<%
	...
	String[] articleNames = new String[]{"杏花村","屠苏酒","妙沁药酒","仙露琼浆","诸神玉液"};
		...
		for (String str : articleNames) {
			if (str.equalsIgnoreCase(a.getName())) {
				if (a instanceof Lasting_For_Compose_Props) {
					((Lasting_For_Compose_Props)a).setBuffLastingTime(200);
					out.println(a.getName() + " = buff持续时间:" + (((Lasting_For_Compose_Props)a).getBuffLastingTime()) + "秒<br>");
				}
			}
		}
