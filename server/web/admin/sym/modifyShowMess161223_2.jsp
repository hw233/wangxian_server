...
<%
	for (ActivityShowInfo asi : ActivityManagers.getInstance().infos) {
		if (asi.activityId == 1743) {
			asi.activityTitle = "双蛋节单属性宝石合成季";
			asi.activityName = "双蛋节单属性宝石合成季";
			asi.activityName_stat = "双蛋节单属性宝石合成季";
			asi.activityContent = asi.activityContent.replaceAll("狂雷单、疾风、阳炎、寒冰属性", "狂雷、疾风、阳炎、寒冰单属性");
			out.println(asi.activityTitle);
		}
	}
