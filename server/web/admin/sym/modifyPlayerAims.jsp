...
<%@ page language="java" contentType="text/html; charset=UTF-8"
        pageEncoding="UTF-8"%>
<%
	PlayerAimManager.instance.aimMaps.get(422).setNum(100);
	PlayerAimManager.instance.aimMaps.get(422).setDisplay(false);
	PlayerAimManager.instance.aimMaps.get(423).setNum(100);
	PlayerAimManager.instance.aimMaps.get(423).setDisplay(false);
	out.println("刷宠物技能ok!!");
%>
