...
<%
	...
	for (Article a : ArticleManager.getInstance().getAllArticles()) {
		if (a.getName().equals("仙之宝石袋(3级)")) {
			((RandomPackageProps)a).setOpenBindType((byte)0);
		} else if (a.getName().equals("仙之宝石袋(4级)")) {
			((RandomPackageProps)a).setOpenBindType((byte)0);
		} else if (a.getName().equals("仙之宝石袋(5级)")) {
			((RandomPackageProps)a).setOpenBindType((byte)0);
		}
