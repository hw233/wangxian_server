...
//家族实力榜
public class JiazuPowerAllBillboard extends Billboard {
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(Jiazu.class, " ",new Object[]{},"warScore desc",1,BillboardsManager.实际条数+1);
		if(ids != null){
...
//			List<JiazuSimpleInfo> list = new ArrayList<JiazuSimpleInfo>();
//			for(int i =0;i<ids.length;i++){
//				if(i >= 200){
//					break;
//				}
...
//				if(ids[i] > 0){
//					jiazu = BillboardsManager.getInstance().getJiazuSimpleInfo(ids[i]);
//					if(jiazu != null){
//						list.add(jiazu);
//					}
//				}
...
//			Collections.sort(list, new JiazuCompare());
	...
	static class JiazuCompare implements Comparator<Jiazu>{
