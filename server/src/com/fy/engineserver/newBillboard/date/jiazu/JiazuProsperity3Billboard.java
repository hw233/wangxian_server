...
//苍月
public class JiazuProsperity3Billboard extends Billboard {
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(Jiazu.class, " country = ? ",new Object[]{3},"prosperity desc",1,BillboardsManager.实际条数+1);
		if(ids != null){
