...
//昆仑
public class PeekCountry1Billboard extends Billboard {
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(BillboardStatDate.class, " country = ? ",new Object[]{1},"peekNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
