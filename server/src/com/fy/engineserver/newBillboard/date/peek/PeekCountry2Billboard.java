package com.fy.engineserver.newBillboard.date.peek;
...
//九州
public class PeekCountry2Billboard extends Billboard {
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(BillboardStatDate.class, " country = ? ",new Object[]{2},"peekNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
