...
//九州
public class BrickCountry2Billboard extends Billboard {
...
//	于title对应
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(BillboardStatDate.class, " country = ? ",new Object[]{2},"brickNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
