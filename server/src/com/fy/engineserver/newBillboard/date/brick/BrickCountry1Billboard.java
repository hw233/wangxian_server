...
//昆仑
public class BrickCountry1Billboard extends Billboard {
...
//	于title对应
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(BillboardStatDate.class, " country = ? ",new Object[]{1},"brickNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
