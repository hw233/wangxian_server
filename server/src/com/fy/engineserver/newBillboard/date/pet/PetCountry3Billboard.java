...
//万法
public class PetCountry3Billboard extends Billboard {
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(Pet.class, " delete = ? AND country = ? ",new Object[]{"F",3},"qualityScore desc ",1,BillboardsManager.实际条数+1);
//		long[] ids = em.queryIds(Pet.class, "country = ? ",new Object[]{3},"qualityScore desc ",1,BillboardsManager.实际条数+100);
