...
import com.fy.engineserver.activity.chongzhiActivity.ChongZhiActivity.MoneyBillBoardData;
...
public class ChongZhiActivityBillboard extends Billboard {
	
	public void update()throws Exception {
		super.update();
		NewMoneyActivity a = NewChongZhiActivityManager.instance.getBillBoardActivity();
		if (a == null) {
			return;
		}
		List<MoneyBillBoardActivityData> datas = ((BillBoardActivity)a).getSortList(200);
		if (datas != null) {
