...
//九黎
public class LevelCareer4Billboard extends Billboard {
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(Player.class, " career = ? ",new Object[]{4},"level desc ,exp desc",1,BillboardsManager.实际条数+1);
