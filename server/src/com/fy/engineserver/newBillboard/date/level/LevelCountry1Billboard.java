...
//昆仑
public class LevelCountry1Billboard extends Billboard {
...
//	角色名称:家族:职业:级别
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(Player.class, "country = ?",new Object[]{1},"level desc,exp desc ",1,BillboardsManager.实际条数+1);
