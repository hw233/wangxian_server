...
//修罗
public class LevelCareer1Billboard extends Billboard {

	
	//	//于title对应
	//	private String[] dateValues;  显示内容：角色ID、国家、家族、级别
//	角色名称:国家:家族:级别
	public void update()throws Exception {
		super.update();
		SimpleEntityManager<Player> em = SimpleEntityManagerFactory.getSimpleEntityManager(Player.class);
		long[] ids = em.queryIds(Player.class, " career = ? ", new Object[]{1},"level desc,exp desc ",1,BillboardsManager.实际条数+1);
