...
//偷菜排行榜
public class StealFruitBillboard extends Billboard {

	
	//	//于title对应
	//	private String[] dateValues;  显示内容：名次、角色ID、国家、分数
	
	public void update()throws Exception {
		super.update();
		SimpleEntityManager<BillboardStatDate> em = BillboardStatDateManager.em;
		long[] ids = em.queryIds(BillboardStatDate.class, " ",new Object[]{},"stealFruitNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
