...
//昆仑
public class WarScoreCountry1Billboard extends Billboard {
...
//	功勋：  国家名称 家族名称 玩家名称 功勋值 

	public void update()throws Exception {
		super.update();
		SimpleEntityManager<Player> em = SimpleEntityManagerFactory.getSimpleEntityManager(Player.class);
		long[] ids = em.queryIds(Player.class, "country = ?",new Object[]{1},"gongxun desc",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
