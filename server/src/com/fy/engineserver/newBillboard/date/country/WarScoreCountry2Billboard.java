...
//九州
public class WarScoreCountry2Billboard extends Billboard {
...
//	玩家名称:国家:家族:活动积分
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(Player.class, "country = ?",new Object[]{2},"gongxun desc",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
