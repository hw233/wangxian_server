...
//万法
public class DrinkCountry3Billboard extends Billboard {
	//于title对应
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(BillboardStatDate.class, "country = ? ",new Object[]{3},"drinkBeerNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
