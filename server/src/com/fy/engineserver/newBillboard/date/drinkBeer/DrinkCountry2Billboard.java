...
//九州
public class DrinkCountry2Billboard extends Billboard {
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(BillboardStatDate.class, "country = ? ",new Object[]{2},"drinkBeerNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
