package com.fy.engineserver.newBillboard.date.drinkBeer;
...
//全部
public class DrinkBeerALLBillboard extends Billboard {
...
//	//于title对应
	...
	public void update()throws Exception {
		...
		long[] ids = em.queryIds(BillboardStatDate.class, " ",new Object[]{},"drinkBeerNum desc ",1,BillboardsManager.实际条数+1);
		//排行榜统计数据
		if(ids != null && ids.length > 0){
			...
			if(playerList != null && playerList.size() > 0){
				...
				if(LogRecordManager.getInstance() != null){
					LogRecordManager.getInstance().活动记录日志(LogRecordManager.酒仙, this);
				}
			}else{
