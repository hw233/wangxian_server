...
//喝酒活动日志记录
public class DaySweetLogRecord extends LogRecord{
	...
	public DaySweetLogRecord(){
		String[] dateString = {"2012-08-23 10:25:00","2012-08-23 23:29:00","2012-08-23 23:59:00"};
		String[] platform = {"官方","官方","官方"};
...
//						}
						...
						ArticleManager.logger.error("[打印当日糖果活动日志异常]",e);
					}
				}
