...
//连斩活动日志记录
public class KillJoinLogRecord extends LogRecord{
	...
	public KillJoinLogRecord(){
		String[] dateString = {"2012-07-26 16:55:00","2012-08-08 10:00:00"};
		String[] platform = {"测试","九游"};
...
//						}
						...
						ArticleManager.logger.error("[打印连斩活动日志异常]",e);
					}
				}
