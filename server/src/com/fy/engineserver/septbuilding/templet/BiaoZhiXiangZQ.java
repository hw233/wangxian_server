 ...
 */
@SimpleEmbeddable
public class BiaoZhiXiangZQ extends SeptBuildingTemplet {

	private static BiaoZhiXiangZQ instance;
	 ...
	 * buffer的名字
	 */
	private transient String bufferName = Translate.家族朱雀;
	/**
	 * buffer的持续时间
	 */
	...
	private BiaoZhiXiangZQ() {

	}

	public static BiaoZhiXiangZQ getInstance() {
		return instance;
	}
	...
	public void init() throws Exception {
		...
		instance = this;
		instance.setBuildingType(BuildingType.标志像朱雀);
	...
	public String toString() {
		return "BiaoZhiXiangZQ [confPath=" + confPath + ", bufferName=" + bufferName + ", durations=" + Arrays.toString(durations) + ", costs=" + Arrays.toString(costs) + "]";
	}
