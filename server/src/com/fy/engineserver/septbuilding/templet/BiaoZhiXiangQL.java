 ...
 */
@SimpleEmbeddable
public class BiaoZhiXiangQL extends SeptBuildingTemplet {

	private static BiaoZhiXiangQL instance;
	 ...
	 * buffer的名字
	 */
	private transient String bufferName = Translate.家族青龙;
	/**
	 * buffer的持续时间
	 */
	...
	private BiaoZhiXiangQL() {

	}

	public static BiaoZhiXiangQL getInstance() {
		return instance;
	}
	...
	public void init() throws Exception {
		...
		instance = this;
		instance.setBuildingType(BuildingType.标志像青龙);
...
//		bufferName = XmlUtil.getAttributeAsString(es[0], "value", null);
	...
	public String toString() {
		return "BiaoZhiXiangQL [confPath=" + confPath + ", bufferName=" + bufferName + ", durations=" + Arrays.toString(durations) + ", costs=" + Arrays.toString(costs) + "]";
	}
