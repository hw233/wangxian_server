 ...
 */
@SimpleEmbeddable
public class BiaoZhiXiangXW extends SeptBuildingTemplet {

	private static BiaoZhiXiangXW instance;
	 ...
	 * buffer的名字
	 */
	private transient String bufferName = Translate.家族玄武;
	/**
	 * buffer的持续时间
	 */
	...
	private BiaoZhiXiangXW() {

	}

	public static BiaoZhiXiangXW getInstance() {
		return instance;
	}
	...
	public void init() throws Exception {
		...
		instance = this;
		instance.setBuildingType(BuildingType.标志像玄武);
	...
	public String toString() {
		return "BiaoZhiXiangXW [confPath=" + confPath + ", bufferName=" + bufferName + ", durations=" + Arrays.toString(durations) + ", costs=" + Arrays.toString(costs) + "]";
	}
