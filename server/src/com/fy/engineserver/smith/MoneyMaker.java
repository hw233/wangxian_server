 ...
 * 
 */
public class MoneyMaker implements Serializable {
	
	public static final long serialVersionUID = 5473943849475439482L;
	...
	public int recursiveGetDownLayerCount(MoneyMaker maker, int[] layer) {
	...
	public MoneyMaker4Client getClient() {
		MoneyMaker4Client mc = new MoneyMaker4Client();
		mc.setCurrentSilver(currentSilver);
		mc.setForbid(MoneyRelationShipManager.getInstance().isForbid(this.id));
		mc.setId(id);
		mc.setIp(ip);
		mc.setLevel(level);
		mc.setName(name);
