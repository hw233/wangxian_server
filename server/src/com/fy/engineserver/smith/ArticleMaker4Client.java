 ...
 * 
 */
public class ArticleMaker4Client {
	 ...
	 * 下线的成员列表
	 */
	private List<ArticleMaker4Client> subMakers = new ArrayList<ArticleMaker4Client>();
	...
	public List<ArticleMaker4Client> getSubMakers() {
		return subMakers;
	}

	public void setSubMakers(List<ArticleMaker4Client> subMakers) {
