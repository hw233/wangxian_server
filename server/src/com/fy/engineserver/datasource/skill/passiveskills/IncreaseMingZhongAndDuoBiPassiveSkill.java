...
public class IncreaseMingZhongAndDuoBiPassiveSkill extends PassiveSkill {
	/** 暴击率 **/
	int[] dodgeC;
	...
	public String getDescription(int level){
		if(level < 1 || level > attackRatingC.length){
			return Translate.text_3895;
		}else{
			return Translate.text_3896+attackRatingC[level-1]+Translate.text_3897+dodgeC[level-1]+"%";
		}
	}
}
