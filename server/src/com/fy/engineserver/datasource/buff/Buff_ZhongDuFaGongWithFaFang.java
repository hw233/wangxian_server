 ...
 */
@SimpleEmbeddable
public class Buff_ZhongDuFaGongWithFaFang extends Buff implements AbnormalStateBuff{
		...
		if(heartBeatStartTime - lastExeTime >= LastingTime){
			...
			if(owner instanceof Player){
				...
				if(p.isImmunity()){
					...
					BuffTemplate_ZhongDuFaGongWithFaFang bt = (BuffTemplate_ZhongDuFaGongWithFaFang)this.getTemplate();
