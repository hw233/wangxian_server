 ...
 */
@SimpleEmbeddable
public class Buff_HuDunWuGong extends Buff{
	int modulus;
	/**
	...
	public void start(Fighter owner){
		if(owner instanceof Player){
			...
			byte shield = -1;
			BuffTemplate_HuDunWuGong bt = (BuffTemplate_HuDunWuGong)this.getTemplate();
	...
	public String getDescription(){
		...
		if(bt != null && bt.modulus != null && bt.modulus.length > getLevel()){
			...
			return Translate.text_3398+damage+Translate.text_3201;
		}
