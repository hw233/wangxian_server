 ...
 */
@SimpleEmbeddable
public class Buff_QiangZhuang extends Buff{
	...
	public void start(Fighter owner){
		...
		if(owner instanceof Player){
			...
			BuffTemplate_QiangZhuang bt = (BuffTemplate_QiangZhuang)this.getTemplate();
			calc(bt);
	...
	public void calc(BuffTemplate_QiangZhuang bt) {
		if(defence != 0){//防止重复计算
			return;
		}
