 ...
 */
@SimpleEmbeddable
public class Buff_XuanYun extends Buff implements ControlBuff{
	
	public Buff_XuanYun(){/*Skill.logger.error("debug ", new Exception("测试哪里来的眩晕"));*/}
...
//					System.out.println("时间测试1:"+this.getInvalidTime()+"--"+p.getName()+"--"+(this.getInvalidTime() - this.getStartTime())+"--:p.decreaseConTimeRate"+p.decreaseConTimeRate);
...
//					System.out.println("时间测试2:"+this.getInvalidTime()+"--"+p.getName()+"--decreaseConTimeRate:"+p.decreaseConTimeRate+"--decreaseTime:"+decreaseTime);
