...
public class BuffTemplate_QiangZhuangNaiLi extends BuffTemplate{
	...
	public BuffTemplate_QiangZhuangNaiLi(){
	...
	public Buff createBuff(int level) {
		Buff_QiangZhuangNaiLi buff = new Buff_QiangZhuangNaiLi();
