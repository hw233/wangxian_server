...
public class BuffTemplate_ZhongDuFaGongWithFaFang extends BuffTemplate{
	...
	public BuffTemplate_ZhongDuFaGongWithFaFang(){
		setName(Translate.text_3392);
		setDescription(Translate.text_3392);
	}
	
	public Buff createBuff(int level) {
		Buff_ZhongDuFaGongWithFaFang buff = new Buff_ZhongDuFaGongWithFaFang();
