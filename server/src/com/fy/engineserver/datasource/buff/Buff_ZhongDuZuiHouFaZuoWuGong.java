 ...
 */
@SimpleEmbeddable
public class Buff_ZhongDuZuiHouFaZuoWuGong extends Buff implements AbnormalStateBuff{
		...
		if(owner instanceof Player){
			...
			if(p.isImmunity()){
				...
				if(activeTime > 0 && heartBeatStartTime >= activeTime){
					int hp = 0;
					BuffTemplate_ZhongDuZuiHouFaZuoWuGong bt = (BuffTemplate_ZhongDuZuiHouFaZuoWuGong)this.getTemplate();
