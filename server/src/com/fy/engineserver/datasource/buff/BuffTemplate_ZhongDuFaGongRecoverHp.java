...
public class BuffTemplate_ZhongDuFaGongRecoverHp extends BuffTemplate{
	...
	public BuffTemplate_ZhongDuFaGongRecoverHp(){
		setName(Translate.text_3392);
		setDescription(Translate.text_3392);
	}
	
	public Buff createBuff(int level) {
		Buff_ZhongDuFaGongRecoverHp buff = new Buff_ZhongDuFaGongRecoverHp();
