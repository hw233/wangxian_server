 ...
 * </table>
 */
public class GET_TYPEPLAYER_REQ implements RequestMessage{
	...
	public GET_TYPEPLAYER_REQ(){
	}

	public GET_TYPEPLAYER_REQ(long seqNum,byte ptype,int page,int numbers){
		this.seqNum = seqNum;
		this.ptype = ptype;
		this.page = page;
	...
	public GET_TYPEPLAYER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
