 ...
 * </table>
 */
public class LEARN_HORSE_SKILL_RES implements ResponseMessage{
	...
	public LEARN_HORSE_SKILL_RES(){
	}

	public LEARN_HORSE_SKILL_RES(long seqNum,long horseId,byte result){
		this.seqNum = seqNum;
		this.horseId = horseId;
		this.result = result;
	}

	public LEARN_HORSE_SKILL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
