 ...
 * </table>
 */
public class EXCHANGE_PLACE_ORDER_RES implements ResponseMessage{
	...
	public EXCHANGE_PLACE_ORDER_RES(long seqNum,long money,long yuanbo,long blockedMoney,long blockedYuanbo){
		this.seqNum = seqNum;
		this.money = money;
		this.yuanbo = yuanbo;
	...
	public EXCHANGE_PLACE_ORDER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "EXCHANGE_PLACE_ORDER_RES";
	}
