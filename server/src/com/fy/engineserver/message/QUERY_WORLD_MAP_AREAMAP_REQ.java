 ...
 * </table>
 */
public class QUERY_WORLD_MAP_AREAMAP_REQ implements RequestMessage{
	...
	public QUERY_WORLD_MAP_AREAMAP_REQ(){
	}

	public QUERY_WORLD_MAP_AREAMAP_REQ(long seqNum,String areaName){
		this.seqNum = seqNum;
		this.areaName = areaName;
	}

	public QUERY_WORLD_MAP_AREAMAP_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_WORLD_MAP_AREAMAP_REQ";
	}
