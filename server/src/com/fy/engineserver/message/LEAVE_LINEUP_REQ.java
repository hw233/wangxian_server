 ...
 * </table>
 */
public class LEAVE_LINEUP_REQ implements RequestMessage{
	...
	public LEAVE_LINEUP_REQ(){
	}

	public LEAVE_LINEUP_REQ(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public LEAVE_LINEUP_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
