 ...
 * </table>
 */
public class XILIAN_CONFIRM_RES implements ResponseMessage{
	...
	public XILIAN_CONFIRM_RES(){
	}

	public XILIAN_CONFIRM_RES(long seqNum,int result,int[] colors){
		this.seqNum = seqNum;
		this.result = result;
		this.colors = colors;
	}

	public XILIAN_CONFIRM_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
