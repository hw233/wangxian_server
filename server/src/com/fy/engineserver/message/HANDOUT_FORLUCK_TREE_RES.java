 ...
 * </table>
 */
public class HANDOUT_FORLUCK_TREE_RES implements ResponseMessage{
	...
	public HANDOUT_FORLUCK_TREE_RES(){
	}

	public HANDOUT_FORLUCK_TREE_RES(long seqNum,byte result,long npcId,long playerId,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.npcId = npcId;
	...
	public HANDOUT_FORLUCK_TREE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "HANDOUT_FORLUCK_TREE_RES";
	}
