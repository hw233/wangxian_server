 ...
 * </table>
 */
public class BOOTHSALE_NEW_BUY_REQ implements RequestMessage{
	...
	public BOOTHSALE_NEW_BUY_REQ(){
	}

	public BOOTHSALE_NEW_BUY_REQ(long seqNum,long saler,long entityID,int index,int saleNum){
		this.seqNum = seqNum;
		this.saler = saler;
	...
	public BOOTHSALE_NEW_BUY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
