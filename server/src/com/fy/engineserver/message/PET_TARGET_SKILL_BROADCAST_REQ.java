 ...
 * </table>
 */
public class PET_TARGET_SKILL_BROADCAST_REQ implements RequestMessage{
	...
	public PET_TARGET_SKILL_BROADCAST_REQ(){
	}

	public PET_TARGET_SKILL_BROADCAST_REQ(long seqNum,long casterId,byte targetType,long targetId,int skillId,byte level){
		this.seqNum = seqNum;
	...
	public PET_TARGET_SKILL_BROADCAST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PET_TARGET_SKILL_BROADCAST_REQ";
	}
