 ...
 * </table>
 */
public class HUNSHI2_CELL_BUY_RES implements ResponseMessage{
	...
	public HUNSHI2_CELL_BUY_RES(){
	}

	public HUNSHI2_CELL_BUY_RES(long seqNum,int index,boolean result){
		this.seqNum = seqNum;
		this.index = index;
		this.result = result;
	}

	public HUNSHI2_CELL_BUY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
