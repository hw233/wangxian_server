 ...
 * </table>
 */
public class OBSERVER_REGISTER_RES implements ResponseMessage{
	...
	public OBSERVER_REGISTER_RES(long seqNum,byte result,String resultString){
		this.seqNum = seqNum;
		this.result = result;
		this.resultString = resultString;
	}

	public OBSERVER_REGISTER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
