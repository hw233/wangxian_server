 ...
 * </table>
 */
public class PET_BREEDING_RES implements ResponseMessage{
	...
	public PET_BREEDING_RES(){
	}

	public PET_BREEDING_RES(long seqNum,String result,long entityId){
		this.seqNum = seqNum;
		this.result = result;
		this.entityId = entityId;
	}

	public PET_BREEDING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
