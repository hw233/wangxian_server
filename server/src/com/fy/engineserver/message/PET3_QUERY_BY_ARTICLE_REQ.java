 ...
 * </table>
 */
public class PET3_QUERY_BY_ARTICLE_REQ implements RequestMessage{
	...
	public PET3_QUERY_BY_ARTICLE_REQ(){
	}

	public PET3_QUERY_BY_ARTICLE_REQ(long seqNum,long petEntityId,boolean isOwner){
		this.seqNum = seqNum;
		this.petEntityId = petEntityId;
		this.isOwner = isOwner;
	}

	public PET3_QUERY_BY_ARTICLE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PET3_QUERY_BY_ARTICLE_REQ";
	}
