 ...
 * </table>
 */
public class DEMISE_ZONGPAI_REQ implements RequestMessage{
	...
	public DEMISE_ZONGPAI_REQ(){
	}

	public DEMISE_ZONGPAI_REQ(long seqNum,long jiazuId,String password){
		this.seqNum = seqNum;
		this.jiazuId = jiazuId;
		this.password = password;
	}

	public DEMISE_ZONGPAI_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
