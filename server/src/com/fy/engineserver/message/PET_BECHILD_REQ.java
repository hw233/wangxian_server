 ...
 * </table>
 */
public class PET_BECHILD_REQ implements RequestMessage{
	...
	public PET_BECHILD_REQ(){
	}

	public PET_BECHILD_REQ(long seqNum,long petEntityId){
		this.seqNum = seqNum;
		this.petEntityId = petEntityId;
	}

	public PET_BECHILD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
