 ...
 * </table>
 */
public class GUOZHAN_RESULT_REQ implements RequestMessage{
	...
	public GUOZHAN_RESULT_REQ(){
	}

	public GUOZHAN_RESULT_REQ(long seqNum,String result,String winCountry,String attackCountry,String[] attackName,int[] attackKillNum,String defendCountry,String[] defendName,int[] defendKillNum,long damage,int killNum,int gongxun,long exp,boolean attacker){
		this.seqNum = seqNum;
		this.result = result;
	...
	public GUOZHAN_RESULT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
