 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>roundIndex</td><td>byte</td><td>1个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class TOURNAMENT_START_REQ implements RequestMessage{
	...
	public TOURNAMENT_START_REQ(){
	}

	public TOURNAMENT_START_REQ(long seqNum,byte roundIndex,String[] names,byte[] careers){
		this.seqNum = seqNum;
	...
	public TOURNAMENT_START_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		roundIndex = (byte)mf.byteArrayToNumber(content,offset,1);
		offset += 1;
		int len = 0;
