 ...
 * </table>
 */
public class TAIWAN_PASSPORT_REGISTER_RES implements ResponseMessage{
	...
	public TAIWAN_PASSPORT_REGISTER_RES(long seqNum,long id,String result){
		this.seqNum = seqNum;
		this.id = id;
		this.result = result;
	}

	public TAIWAN_PASSPORT_REGISTER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "TAIWAN_PASSPORT_REGISTER_RES";
	}
