 ...
 * </table>
 */
public class DIG_FENMU_TEN_REQ implements RequestMessage{
	...
	public DIG_FENMU_TEN_REQ(){
	}

	public DIG_FENMU_TEN_REQ(long seqNum,String fenmuName){
		this.seqNum = seqNum;
		this.fenmuName = fenmuName;
	}

	public DIG_FENMU_TEN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
