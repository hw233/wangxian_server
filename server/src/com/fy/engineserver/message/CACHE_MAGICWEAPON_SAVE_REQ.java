 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>plevel</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>skillLevels.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>skillLevels</td><td>int[]</td><td>skillLevels.length</td><td>*</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>bstrength</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>bdexterity</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>bspellpower</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>bconstitution</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>properties.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>properties</td><td>String</td><td>properties.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>borntime</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class CACHE_MAGICWEAPON_SAVE_REQ implements RequestMessage{
	...
	public CACHE_MAGICWEAPON_SAVE_REQ(long seqNum,long id,String name,long playerid,long articleid,int exp,int plevel,int quality,int star,int[] skillIds,int[] skillLevels,int bstrength,int bdexterity,int bspellpower,int bconstitution,String properties,long borntime){
		this.seqNum = seqNum;
		this.id = id;
		this.name = name;
	...
	public CACHE_MAGICWEAPON_SAVE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "CACHE_MAGICWEAPON_SAVE_REQ";
	}
