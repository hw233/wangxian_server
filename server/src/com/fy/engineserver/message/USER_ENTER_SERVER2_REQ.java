 ...
 * </table>
 */
public class USER_ENTER_SERVER2_REQ implements RequestMessage{
	...
	public USER_ENTER_SERVER2_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
