 ...
 * </table>
 */
public class IAPPP_GET_CHARGE_ORDER_RES implements ResponseMessage{
	...
	public IAPPP_GET_CHARGE_ORDER_RES(){
	}

	public IAPPP_GET_CHARGE_ORDER_RES(long seqNum,int result,String chargeOrder,long money,String waresId,int chargePoint){
		this.seqNum = seqNum;
		this.result = result;
	...
	public IAPPP_GET_CHARGE_ORDER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "IAPPP_GET_CHARGE_ORDER_RES";
	}
