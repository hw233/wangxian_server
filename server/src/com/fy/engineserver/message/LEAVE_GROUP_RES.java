 ...
 * </table>
 */
public class LEAVE_GROUP_RES implements ResponseMessage{
	...
	public LEAVE_GROUP_RES(){
	}

	public LEAVE_GROUP_RES(long seqNum,String result,long groupId){
		this.seqNum = seqNum;
		this.result = result;
		this.groupId = groupId;
	}

	public LEAVE_GROUP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
