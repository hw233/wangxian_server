 ...
 * </table>
 */
public class QUERY_CMCC_Balance_REQ implements RequestMessage{
	...
	public QUERY_CMCC_Balance_REQ(long seqNum,String userId,String key,String username){
		this.seqNum = seqNum;
		this.userId = userId;
		this.key = key;
	...
	public QUERY_CMCC_Balance_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
