 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>materialIds.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>materialIds</td><td>long[]</td><td>materialIds.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>materialNums.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>materialNums</td><td>int[]</td><td>materialNums.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>bossType</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class CONFIRM_COLLENT_MATERIAL_FOR_BOSS_REQ implements RequestMessage{
	...
	public CONFIRM_COLLENT_MATERIAL_FOR_BOSS_REQ(){
	}

	public CONFIRM_COLLENT_MATERIAL_FOR_BOSS_REQ(long seqNum,long[] materialIds,int[] materialNums,int bossType){
		this.seqNum = seqNum;
	...
	public CONFIRM_COLLENT_MATERIAL_FOR_BOSS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CONFIRM_COLLENT_MATERIAL_FOR_BOSS_REQ";
	}
