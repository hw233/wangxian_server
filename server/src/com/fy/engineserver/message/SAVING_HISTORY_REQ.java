 ...
 * </table>
 */
public class SAVING_HISTORY_REQ implements RequestMessage{
	...
	public SAVING_HISTORY_REQ(){
	}

	public SAVING_HISTORY_REQ(long seqNum,int pagenum,int pageindex){
		this.seqNum = seqNum;
		this.pagenum = pagenum;
		this.pageindex = pageindex;
	}

	public SAVING_HISTORY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
