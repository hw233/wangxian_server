 ...
 * </table>
 */
public class NOTICE_OPEN_URL_REQ implements RequestMessage{
	...
	public NOTICE_OPEN_URL_REQ(){
	}

	public NOTICE_OPEN_URL_REQ(long seqNum,String url){
		this.seqNum = seqNum;
		this.url = url;
	}

	public NOTICE_OPEN_URL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
