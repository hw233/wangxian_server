 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>uiidmacaddress.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>uiidmacaddress</td><td>String</td><td>uiidmacaddress.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class QUERY_VIP_DISPLAY_REQ implements RequestMessage{
	...
	String userType;
	String channel;
	String uiidmacaddress;

	public QUERY_VIP_DISPLAY_REQ(){
	}

	public QUERY_VIP_DISPLAY_REQ(long seqNum,String clientId,String phoneType,String platform,String userType,String channel,String uiidmacaddress){
		this.seqNum = seqNum;
		...
		this.uiidmacaddress = uiidmacaddress;
	}

	public QUERY_VIP_DISPLAY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		offset += 2;
		if(len < 0 || len > 16384) throw new Exception("string length ["+len+"] big than the max length [16384]");
		uiidmacaddress = new String(content,offset,len,"UTF-8");
		offset += len;
	}
	...
	public int getLength() {
		...
		len += 2;
		try{
			len +=uiidmacaddress.getBytes("UTF-8").length;
		}catch(java.io.UnsupportedEncodingException e){
		 e.printStackTrace();
			throw new RuntimeException("unsupported encoding [UTF-8]",e);
		}
	...
	public int writeTo(ByteBuffer buffer) {
		...
		try{
			...
			buffer.put(tmpBytes1);
				try{
			tmpBytes1 = uiidmacaddress.getBytes("UTF-8");
				}catch(java.io.UnsupportedEncodingException e){
			 e.printStackTrace();
					throw new RuntimeException("unsupported encoding [UTF-8]",e);
				}
	 ...
	 *	当前客户端uiidmacaddress
	 */
	public String getUiidmacaddress(){
		return uiidmacaddress;
	}
	 ...
	 *	当前客户端uiidmacaddress
	 */
	public void setUiidmacaddress(String uiidmacaddress){
		this.uiidmacaddress = uiidmacaddress;
	}
