 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>lineCountInPage</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class QUERY_ACHIEVEMENT_SERIES_REQ implements RequestMessage{
	...
	public QUERY_ACHIEVEMENT_SERIES_REQ(){
	}

	public QUERY_ACHIEVEMENT_SERIES_REQ(long seqNum,int achievementSeriesId,int currentPage,int lineCountInPage){
		this.seqNum = seqNum;
	...
	public QUERY_ACHIEVEMENT_SERIES_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_ACHIEVEMENT_SERIES_REQ";
	}
