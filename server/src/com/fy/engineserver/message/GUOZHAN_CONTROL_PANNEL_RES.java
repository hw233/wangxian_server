 ...
 * </table>
 */
public class GUOZHAN_CONTROL_PANNEL_RES implements ResponseMessage{
	...
	public GUOZHAN_CONTROL_PANNEL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "GUOZHAN_CONTROL_PANNEL_RES";
	}
