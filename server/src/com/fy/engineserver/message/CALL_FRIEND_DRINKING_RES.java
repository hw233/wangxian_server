 ...
 * </table>
 */
public class CALL_FRIEND_DRINKING_RES implements ResponseMessage{
	...
	public CALL_FRIEND_DRINKING_RES(){
	}

	public CALL_FRIEND_DRINKING_RES(long seqNum,String contentMess,byte activityType){
		this.seqNum = seqNum;
		this.contentMess = contentMess;
		this.activityType = activityType;
	}

	public CALL_FRIEND_DRINKING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CALL_FRIEND_DRINKING_RES";
	}
