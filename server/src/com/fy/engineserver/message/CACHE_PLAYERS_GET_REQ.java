 ...
 * </table>
 */
public class CACHE_PLAYERS_GET_REQ implements RequestMessage{
	...
	public CACHE_PLAYERS_GET_REQ(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public CACHE_PLAYERS_GET_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
