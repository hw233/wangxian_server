 ...
 * </table>
 */
public class QIECUO_INVITE_RESPONSE_REQ implements RequestMessage{
	...
	public QIECUO_INVITE_RESPONSE_REQ(long seqNum,byte result,long playerId,String playerName){
		this.seqNum = seqNum;
		this.result = result;
	...
	public QIECUO_INVITE_RESPONSE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QIECUO_INVITE_RESPONSE_REQ";
	}
