 ...
 * </table>
 */
public class QIANCENGTA_REWARD_INFO_REQ implements RequestMessage{
	...
	public QIANCENGTA_REWARD_INFO_REQ(){
	}

	public QIANCENGTA_REWARD_INFO_REQ(long seqNum,long playerId,int daoIndex){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.daoIndex = daoIndex;
	}

	public QIANCENGTA_REWARD_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QIANCENGTA_REWARD_INFO_REQ";
	}
