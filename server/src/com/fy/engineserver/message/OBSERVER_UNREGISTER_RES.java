 ...
 * </table>
 */
public class OBSERVER_UNREGISTER_RES implements ResponseMessage{
	...
	public OBSERVER_UNREGISTER_RES(long seqNum,byte result,String resultString){
		this.seqNum = seqNum;
		this.result = result;
		this.resultString = resultString;
	}

	public OBSERVER_UNREGISTER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "OBSERVER_UNREGISTER_RES";
	}
