 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>changeEvents[0].fieldId</td><td>short</td><td>2个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>changeEvents[0].valueType</td><td>byte</td><td>1个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>changeEvents[0].valueData.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>changeEvents[0].valueData</td><td>byte[]</td><td>changeEvents[0].valueData.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>changeEvents[1].objectId</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>changeEvents[2].fieldId</td><td>short</td><td>2个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>changeEvents[2].valueType</td><td>byte</td><td>1个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>changeEvents[2].valueData.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>changeEvents[2].valueData</td><td>byte[]</td><td>changeEvents[2].valueData.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td colspan=4>......... 重复</td></tr>
 * </table>
 */
public class NOTIFY_HORSE_SELFCHANGE_REQ implements RequestMessage{
	...
	public NOTIFY_HORSE_SELFCHANGE_REQ(){
	}

	public NOTIFY_HORSE_SELFCHANGE_REQ(long seqNum,FieldChangeEvent[] changeEvents){
		this.seqNum = seqNum;
		this.changeEvents = changeEvents;
	}

	public NOTIFY_HORSE_SELFCHANGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "NOTIFY_HORSE_SELFCHANGE_REQ";
	}
