 ...
 * </table>
 */
public class QUERY_MAGICWEAPON_STRONG_RES implements ResponseMessage{
	...
	public QUERY_MAGICWEAPON_STRONG_RES(){
	}

	public QUERY_MAGICWEAPON_STRONG_RES(long seqNum,long magicweaponId,long cost,String strongedUUB,String[] strongMaterialName,int[] strongMaterialLuck,String otherStrongMaterialName,int otherStrongMaterialNum,int otherStrongMaterialluck){
		this.seqNum = seqNum;
	...
	public QUERY_MAGICWEAPON_STRONG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_MAGICWEAPON_STRONG_RES";
	}
