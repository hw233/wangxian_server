 ...
 * </table>
 */
public class HORSE_RANKSTAR_STRONG_REQ implements RequestMessage{
	...
	public HORSE_RANKSTAR_STRONG_REQ(){
	}

	public HORSE_RANKSTAR_STRONG_REQ(long seqNum,long horseId,byte strongType){
		this.seqNum = seqNum;
		this.horseId = horseId;
		this.strongType = strongType;
	}

	public HORSE_RANKSTAR_STRONG_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "HORSE_RANKSTAR_STRONG_REQ";
	}
