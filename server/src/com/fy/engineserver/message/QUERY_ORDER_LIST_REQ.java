 ...
 * </table>
 */
public class QUERY_ORDER_LIST_REQ implements RequestMessage{
	...
	public QUERY_ORDER_LIST_REQ(){
	}

	public QUERY_ORDER_LIST_REQ(long seqNum,int pageIndex,int pageSize){
		this.seqNum = seqNum;
		this.pageIndex = pageIndex;
		this.pageSize = pageSize;
	}

	public QUERY_ORDER_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
