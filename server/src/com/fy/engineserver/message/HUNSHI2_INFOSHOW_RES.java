 ...
 * </table>
 */
public class HUNSHI2_INFOSHOW_RES implements ResponseMessage{
	...
	public HUNSHI2_INFOSHOW_RES(){
	}

	public HUNSHI2_INFOSHOW_RES(long seqNum,long hunshiId,String des){
		this.seqNum = seqNum;
		this.hunshiId = hunshiId;
		this.des = des;
	}

	public HUNSHI2_INFOSHOW_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
