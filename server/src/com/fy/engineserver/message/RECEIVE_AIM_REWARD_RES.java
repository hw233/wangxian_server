 ...
 * </table>
 */
public class RECEIVE_AIM_REWARD_RES implements ResponseMessage{
	...
	public RECEIVE_AIM_REWARD_RES(){
	}

	public RECEIVE_AIM_REWARD_RES(long seqNum,String contentMess){
		this.seqNum = seqNum;
		this.contentMess = contentMess;
	}

	public RECEIVE_AIM_REWARD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
