 ...
 * </table>
 */
public class GET_ONE_FENMU_INFO_REQ implements RequestMessage{
	...
	public GET_ONE_FENMU_INFO_REQ(){
	}

	public GET_ONE_FENMU_INFO_REQ(long seqNum,String fenmuName){
		this.seqNum = seqNum;
		this.fenmuName = fenmuName;
	}

	public GET_ONE_FENMU_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
