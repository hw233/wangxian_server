 ...
 * </table>
 */
public class QUERY_PET_MERGE_REQ implements RequestMessage{
	...
	public QUERY_PET_MERGE_REQ(){
	}

	public QUERY_PET_MERGE_REQ(long seqNum,long petEntityId){
		this.seqNum = seqNum;
		this.petEntityId = petEntityId;
	}

	public QUERY_PET_MERGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
