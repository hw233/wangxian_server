 ...
 * </table>
 */
public class QUERY_CLIENT_INFO_REQ implements RequestMessage{
	...
	public QUERY_CLIENT_INFO_REQ(){
	}

	public QUERY_CLIENT_INFO_REQ(long seqNum,String serverName,String username){
		this.seqNum = seqNum;
		this.serverName = serverName;
		this.username = username;
	}

	public QUERY_CLIENT_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
