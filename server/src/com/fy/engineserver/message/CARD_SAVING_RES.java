 ...
 * </table>
 */
public class CARD_SAVING_RES implements ResponseMessage{
	...
	public CARD_SAVING_RES(){
	}

	public CARD_SAVING_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public CARD_SAVING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
