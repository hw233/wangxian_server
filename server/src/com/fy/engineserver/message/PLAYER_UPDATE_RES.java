 ...
 * </table>
 */
public class PLAYER_UPDATE_RES implements ResponseMessage{
	...
	public PLAYER_UPDATE_RES(){
	}

	public PLAYER_UPDATE_RES(long seqNum,byte result,String description){
		this.seqNum = seqNum;
		this.result = result;
		this.description = description;
	}

	public PLAYER_UPDATE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
