 ...
 * </table>
 */
public class HUNSHI2_CELL_BUY_REQ implements RequestMessage{
	...
	public HUNSHI2_CELL_BUY_REQ(){
	}

	public HUNSHI2_CELL_BUY_REQ(long seqNum,long horseId,int index){
		this.seqNum = seqNum;
		this.horseId = horseId;
		this.index = index;
	}

	public HUNSHI2_CELL_BUY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
