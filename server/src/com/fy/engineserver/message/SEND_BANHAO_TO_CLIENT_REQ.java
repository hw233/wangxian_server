 ...
 * </table>
 */
public class SEND_BANHAO_TO_CLIENT_REQ implements RequestMessage{
	...
	public SEND_BANHAO_TO_CLIENT_REQ(){
	}

	public SEND_BANHAO_TO_CLIENT_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public SEND_BANHAO_TO_CLIENT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "SEND_BANHAO_TO_CLIENT_REQ";
	}
