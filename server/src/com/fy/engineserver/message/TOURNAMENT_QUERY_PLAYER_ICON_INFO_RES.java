 ...
 * </table>
 */
public class TOURNAMENT_QUERY_PLAYER_ICON_INFO_RES implements ResponseMessage{
	...
	public TOURNAMENT_QUERY_PLAYER_ICON_INFO_RES(){
	}

	public TOURNAMENT_QUERY_PLAYER_ICON_INFO_RES(long seqNum,long id,byte career,String playername,int level){
		this.seqNum = seqNum;
		this.id = id;
		this.career = career;
	...
	public TOURNAMENT_QUERY_PLAYER_ICON_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "TOURNAMENT_QUERY_PLAYER_ICON_INFO_RES";
	}
