 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>honorId</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class QUERY_HONOR_INFO_RES implements ResponseMessage{
	...
	public QUERY_HONOR_INFO_RES(){
	}

	public QUERY_HONOR_INFO_RES(long seqNum,int honorId,String description){
		this.seqNum = seqNum;
		this.honorId = honorId;
		this.description = description;
	}

	public QUERY_HONOR_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
