 ...
 * </table>
 */
public class MAIL_LIST_CARRY_RES implements ResponseMessage{
	...
	public MAIL_LIST_CARRY_RES(){
	}

	public MAIL_LIST_CARRY_RES(long seqNum,long[] ids,byte[] mtype,byte[] status,String[] titles,String[] senderNames,long[] expiredate,int pages,int nowpage,long[] price){
		this.seqNum = seqNum;
		this.ids = ids;
		this.mtype = mtype;
		this.status = status;
	...
	public MAIL_LIST_CARRY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
