 ...
 * </table>
 */
public class ADD_ZONGPAI_RES implements ResponseMessage{
	...
	public ADD_ZONGPAI_RES(long seqNum,String masterName,int onLineNum,int fanrongdu,long[] jiazuId,String[] jiazuName,byte[] jiazuLevel,long[] playerId,String[] playerName){
		this.seqNum = seqNum;
	...
	public ADD_ZONGPAI_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public int writeTo(ByteBuffer buffer) {
		...
		try{
			...
			byte[] tmpBytes1 = masterName.getBytes("UTF-8");
			...
			for(int i = 0 ; i < jiazuName.length; i++){
				byte[] tmpBytes2 = jiazuName[i].getBytes("UTF-8");
