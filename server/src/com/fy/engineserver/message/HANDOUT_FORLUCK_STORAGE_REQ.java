 ...
 * </table>
 */
public class HANDOUT_FORLUCK_STORAGE_REQ implements RequestMessage{
	...
	public HANDOUT_FORLUCK_STORAGE_REQ(){
	}

	public HANDOUT_FORLUCK_STORAGE_REQ(long seqNum,long playerId,int[] nums){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.nums = nums;
	}

	public HANDOUT_FORLUCK_STORAGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "HANDOUT_FORLUCK_STORAGE_REQ";
	}
