 ...
 * </table>
 */
public class GET_WEEKMONTH_REWARD_RES implements ResponseMessage{
	...
	public GET_WEEKMONTH_REWARD_RES(){
	}

	public GET_WEEKMONTH_REWARD_RES(long seqNum,boolean isSuccess,int dataID,int handleType,String result){
		this.seqNum = seqNum;
	...
	public GET_WEEKMONTH_REWARD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "GET_WEEKMONTH_REWARD_RES";
	}
