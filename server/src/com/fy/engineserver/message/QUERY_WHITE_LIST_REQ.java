 ...
 * </table>
 */
public class QUERY_WHITE_LIST_REQ implements RequestMessage{
	...
	public QUERY_WHITE_LIST_REQ(){
	}

	public QUERY_WHITE_LIST_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public QUERY_WHITE_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
