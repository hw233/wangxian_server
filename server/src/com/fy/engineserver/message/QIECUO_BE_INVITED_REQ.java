 ...
 * 版本号：null<br>
 * 服务器通知客户端，某人要与其切磋，客户端应该弹出窗口询问用户是否要进行切磋<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class QIECUO_BE_INVITED_REQ implements RequestMessage{
	...
	public QIECUO_BE_INVITED_REQ(long seqNum,long playerId,String playerName){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.playerName = playerName;
	}

	public QIECUO_BE_INVITED_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
