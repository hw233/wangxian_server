 ...
 * </table>
 */
public class TAIWAN_GET_QKU_USERID_RES implements ResponseMessage{
	...
	public TAIWAN_GET_QKU_USERID_RES(long seqNum,String result,String qkuUserId){
		this.seqNum = seqNum;
		this.result = result;
		this.qkuUserId = qkuUserId;
	}

	public TAIWAN_GET_QKU_USERID_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "TAIWAN_GET_QKU_USERID_RES";
	}
