 ...
 * </table>
 */
public class EQUIPMENT_INLAY_REQ implements RequestMessage{
	...
	public EQUIPMENT_INLAY_REQ(){
	}

	public EQUIPMENT_INLAY_REQ(long seqNum,long equipmentId,int holeIndex,long materialId){
		this.seqNum = seqNum;
	...
	public EQUIPMENT_INLAY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
