 ...
 * </table>
 */
public class HUNSHI_OPEN_RES implements ResponseMessage{
	...
	public HUNSHI_OPEN_RES(){
	}

	public HUNSHI_OPEN_RES(long seqNum,String des){
		this.seqNum = seqNum;
		this.des = des;
	}

	public HUNSHI_OPEN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
