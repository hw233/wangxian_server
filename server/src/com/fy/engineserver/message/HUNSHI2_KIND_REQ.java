 ...
 * </table>
 */
public class HUNSHI2_KIND_REQ implements RequestMessage{
	...
	public HUNSHI2_KIND_REQ(){
	}

	public HUNSHI2_KIND_REQ(long seqNum,String kinds){
		this.seqNum = seqNum;
		this.kinds = kinds;
	}

	public HUNSHI2_KIND_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
