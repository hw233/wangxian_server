 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>updatetime</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class CACHE_MAGICWEAPON_UPDATE_REQ implements RequestMessage{
	...
	public CACHE_MAGICWEAPON_UPDATE_REQ(long seqNum,long id,String name,long playerid,int exp,int plevel,int quality,int star,int[] skillIds,int[] skillLevels,int bstrength,int bdexterity,int bspellpower,int bconstitution,String properties,long updatetime){
		this.seqNum = seqNum;
		this.id = id;
		this.name = name;
	...
	public CACHE_MAGICWEAPON_UPDATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		...
		offset += len;
		updatetime = (long)mf.byteArrayToNumber(content,offset,8);
		offset += 8;
	}
	...
	public String getTypeDescription() {
		return "CACHE_MAGICWEAPON_UPDATE_REQ";
	}
