 ...
 * </table>
 */
public class NEWQIANCENGTA_GET_FIRST_REWARD_REQ implements RequestMessage{
	...
	public NEWQIANCENGTA_GET_FIRST_REWARD_REQ(){
	}

	public NEWQIANCENGTA_GET_FIRST_REWARD_REQ(long seqNum,int nanduType,int daoIndex){
		this.seqNum = seqNum;
		this.nanduType = nanduType;
		this.daoIndex = daoIndex;
	}

	public NEWQIANCENGTA_GET_FIRST_REWARD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEWQIANCENGTA_GET_FIRST_REWARD_REQ";
	}
