 ...
 * </table>
 */
public class NOTIFY_SERVER_TIREN_REQ implements RequestMessage{
	...
	public NOTIFY_SERVER_TIREN_REQ(){
	}

	public NOTIFY_SERVER_TIREN_REQ(long seqNum,String username,String reason){
		this.seqNum = seqNum;
		this.username = username;
		this.reason = reason;
	}

	public NOTIFY_SERVER_TIREN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "NOTIFY_SERVER_TIREN_REQ";
	}
