 ...
 * 版本号：null<br>
 * 国家授勋玩家，客户端发授勋协议给服务器，服务器传回授勋后的结果<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class COUNTRY_HONOURSOR_OR_CANCEL_REQ implements RequestMessage{
	...
	public COUNTRY_HONOURSOR_OR_CANCEL_REQ(){
	}

	public COUNTRY_HONOURSOR_OR_CANCEL_REQ(long seqNum,byte selectType,String playerName){
		this.seqNum = seqNum;
		this.selectType = selectType;
		this.playerName = playerName;
	}

	public COUNTRY_HONOURSOR_OR_CANCEL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "COUNTRY_HONOURSOR_OR_CANCEL_REQ";
	}
