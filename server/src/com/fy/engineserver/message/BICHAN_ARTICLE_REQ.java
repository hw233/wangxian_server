 ...
 * </table>
 */
public class BICHAN_ARTICLE_REQ implements RequestMessage{
	...
	public BICHAN_ARTICLE_REQ(){
	}

	public BICHAN_ARTICLE_REQ(long seqNum,String fenmuName){
		this.seqNum = seqNum;
		this.fenmuName = fenmuName;
	}

	public BICHAN_ARTICLE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
