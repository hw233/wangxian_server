 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>chooseType</td><td>byte</td><td>1个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class MARRIAGE_CHOOSE_GUEST_RES implements ResponseMessage{
	...
	public MARRIAGE_CHOOSE_GUEST_RES(){
	}

	public MARRIAGE_CHOOSE_GUEST_RES(long seqNum,byte result,byte chooseType,long playerId,String playerName,byte career){
		this.seqNum = seqNum;
		this.result = result;
	...
	public MARRIAGE_CHOOSE_GUEST_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		result = (byte)mf.byteArrayToNumber(content,offset,1);
		offset += 1;
		chooseType = (byte)mf.byteArrayToNumber(content,offset,1);
		offset += 1;
	...
	public String getTypeDescription() {
		return "MARRIAGE_CHOOSE_GUEST_RES";
	}
