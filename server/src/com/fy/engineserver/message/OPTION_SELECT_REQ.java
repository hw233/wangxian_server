 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>wId</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>index</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class OPTION_SELECT_REQ implements RequestMessage{
	...
	public OPTION_SELECT_REQ(){
	}

	public OPTION_SELECT_REQ(long seqNum,long npcId,int wId,int index){
		this.seqNum = seqNum;
		this.npcId = npcId;
		this.wId = wId;
		this.index = index;
	...
	public OPTION_SELECT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
