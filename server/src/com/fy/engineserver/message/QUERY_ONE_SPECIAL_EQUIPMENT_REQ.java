 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>equpmentName.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>equpmentName</td><td>String</td><td>equpmentName.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class QUERY_ONE_SPECIAL_EQUIPMENT_REQ implements RequestMessage{
	...
	public QUERY_ONE_SPECIAL_EQUIPMENT_REQ(){
	}

	public QUERY_ONE_SPECIAL_EQUIPMENT_REQ(long seqNum,boolean equpmentType,String equpmentName){
		this.seqNum = seqNum;
		this.equpmentType = equpmentType;
		this.equpmentName = equpmentName;
	}

	public QUERY_ONE_SPECIAL_EQUIPMENT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_ONE_SPECIAL_EQUIPMENT_REQ";
	}
