 ...
 * </table>
 */
public class QUERY_FLOPNPC_REQ implements RequestMessage{
	...
	public QUERY_FLOPNPC_REQ(){
	}

	public QUERY_FLOPNPC_REQ(long seqNum,long[] NPCId){
		this.seqNum = seqNum;
		this.NPCId = NPCId;
	}

	public QUERY_FLOPNPC_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
