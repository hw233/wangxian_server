 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>infoIndex</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>info.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>info</td><td>byte[]</td><td>info.length</td><td>数组实际长度</td></tr>
 * </table>
 */
public class CHAT_VOICE_INFO_REQ implements RequestMessage{
	...
	public CHAT_VOICE_INFO_REQ(){
	}

	public CHAT_VOICE_INFO_REQ(long seqNum,byte sort,long senderId,long receiverId,String voiceKeyID,int infoIndex,byte[] info){
		this.seqNum = seqNum;
		this.sort = sort;
	...
	public CHAT_VOICE_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
