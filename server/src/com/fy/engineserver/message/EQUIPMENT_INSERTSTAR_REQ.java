 ...
 * </table>
 */
public class EQUIPMENT_INSERTSTAR_REQ implements RequestMessage{
	...
	public EQUIPMENT_INSERTSTAR_REQ(){
	}

	public EQUIPMENT_INSERTSTAR_REQ(long seqNum,long equipmentId,long materialId){
		this.seqNum = seqNum;
		this.equipmentId = equipmentId;
		this.materialId = materialId;
	}

	public EQUIPMENT_INSERTSTAR_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "EQUIPMENT_INSERTSTAR_REQ";
	}
