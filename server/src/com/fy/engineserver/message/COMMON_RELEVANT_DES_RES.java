 ...
 * </table>
 */
public class COMMON_RELEVANT_DES_RES implements ResponseMessage{
	...
	public COMMON_RELEVANT_DES_RES(){
	}

	public COMMON_RELEVANT_DES_RES(long seqNum,int windowId,String windowName,String btnName,String targetName,String des){
		this.seqNum = seqNum;
	...
	public COMMON_RELEVANT_DES_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "COMMON_RELEVANT_DES_RES";
	}
