 ...
 * </table>
 */
public class QIANCENGTA_AUTO_PATA_RES implements ResponseMessage{
	...
	public QIANCENGTA_AUTO_PATA_RES(){
	}

	public QIANCENGTA_AUTO_PATA_RES(long seqNum,int action,int result,String resultString){
		this.seqNum = seqNum;
		this.action = action;
		this.result = result;
	...
	public QIANCENGTA_AUTO_PATA_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QIANCENGTA_AUTO_PATA_RES";
	}
