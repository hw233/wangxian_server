 ...
 * </table>
 */
public class PLAYPHONE_USER_SAVING_RES implements ResponseMessage{
	...
	public PLAYPHONE_USER_SAVING_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public PLAYPHONE_USER_SAVING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "PLAYPHONE_USER_SAVING_RES";
	}
