 ...
 * </table>
 */
public class QUERY_WORLD_MAP_AREAMAP_BY_MAPNAME_RES implements ResponseMessage{
	...
	public QUERY_WORLD_MAP_AREAMAP_BY_MAPNAME_RES(){
	}

	public QUERY_WORLD_MAP_AREAMAP_BY_MAPNAME_RES(long seqNum,String areaName,String[] mapNames,String[] mapDisplayNames,boolean[] searched){
		this.seqNum = seqNum;
	...
	public QUERY_WORLD_MAP_AREAMAP_BY_MAPNAME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_WORLD_MAP_AREAMAP_BY_MAPNAME_RES";
	}
