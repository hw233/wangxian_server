 ...
 * </table>
 */
public class DEAL_ADD_ARTICLE_RES implements ResponseMessage{
	...
	public DEAL_ADD_ARTICLE_RES(){
	}

	public DEAL_ADD_ARTICLE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public DEAL_ADD_ARTICLE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
