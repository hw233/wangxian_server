 ...
 * </table>
 */
public class HANDOUT_FORLUCK_RES implements ResponseMessage{
	...
	public HANDOUT_FORLUCK_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public HANDOUT_FORLUCK_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public int writeTo(ByteBuffer buffer) {
		...
		try{
			...
			buffer.put(result);
			byte[] tmpBytes1 = failreason.getBytes("UTF-8");
