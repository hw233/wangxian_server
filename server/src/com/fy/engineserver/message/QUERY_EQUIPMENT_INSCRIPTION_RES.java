 ...
 * </table>
 */
public class QUERY_EQUIPMENT_INSCRIPTION_RES implements ResponseMessage{
	...
	public QUERY_EQUIPMENT_INSCRIPTION_RES(){
	}

	public QUERY_EQUIPMENT_INSCRIPTION_RES(long seqNum,long equipmentId,String descript,String[] materials){
		this.seqNum = seqNum;
	...
	public QUERY_EQUIPMENT_INSCRIPTION_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_EQUIPMENT_INSCRIPTION_RES";
	}
