 ...
 * </table>
 */
public class FUCK_TRANSPORT_GAME implements RequestMessage{
	...
	public FUCK_TRANSPORT_GAME(){
	}

	public FUCK_TRANSPORT_GAME(long seqNum,String mapName){
		this.seqNum = seqNum;
		this.mapName = mapName;
	}

	public FUCK_TRANSPORT_GAME(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
