 ...
 * </table>
 */
public class JIAZU_BASE_RES implements ResponseMessage{
	...
	public JIAZU_BASE_RES(){
	}

	public JIAZU_BASE_RES(long seqNum,byte result,String failreason,long septStationId){
		this.seqNum = seqNum;
		this.result = result;
	...
	public JIAZU_BASE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
