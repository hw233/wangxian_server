 ...
 * </table>
 */
public class CONFIRM_TALENT_EXP_REQ implements RequestMessage{
	...
	public CONFIRM_TALENT_EXP_REQ(){
	}

	public CONFIRM_TALENT_EXP_REQ(long seqNum,long playerId,int feedType,long inputExp,long[] aeId,int[] aeNums){
		this.seqNum = seqNum;
	...
	public CONFIRM_TALENT_EXP_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
