 ...
 * </table>
 */
public class JIAZU_MODIFY_SLOGAN_REQ implements RequestMessage{
	...
	public JIAZU_MODIFY_SLOGAN_REQ(){
	}

	public JIAZU_MODIFY_SLOGAN_REQ(long seqNum,String slogan){
		this.seqNum = seqNum;
		this.slogan = slogan;
	}

	public JIAZU_MODIFY_SLOGAN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "JIAZU_MODIFY_SLOGAN_REQ";
	}
