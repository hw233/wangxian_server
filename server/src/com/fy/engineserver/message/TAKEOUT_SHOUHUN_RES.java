 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>shouhunModel.articleId</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>shouhunModel.level</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>shouhunModel.currentExp</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>shouhunModel.needExp</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>shouhunModel.attrType</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>shouhunModel.attrNum</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>shouhunModel.colorType</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * </table>
 */
public class TAKEOUT_SHOUHUN_RES implements ResponseMessage{
	...
	public TAKEOUT_SHOUHUN_RES(){
	}

	public TAKEOUT_SHOUHUN_RES(long seqNum,int result,Shouhun4Client shouhunModel){
		this.seqNum = seqNum;
		this.result = result;
		this.shouhunModel = shouhunModel;
	}

	public TAKEOUT_SHOUHUN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
