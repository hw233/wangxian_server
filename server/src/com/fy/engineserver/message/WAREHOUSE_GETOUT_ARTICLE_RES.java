 ...
 * </table>
 */
public class WAREHOUSE_GETOUT_ARTICLE_RES implements ResponseMessage{
	...
	public WAREHOUSE_GETOUT_ARTICLE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public WAREHOUSE_GETOUT_ARTICLE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "WAREHOUSE_GETOUT_ARTICLE_RES";
	}
