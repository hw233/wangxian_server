 ...
 * </table>
 */
public class SOULPITH_LEVEL_INFO_REQ implements RequestMessage{
	...
	public SOULPITH_LEVEL_INFO_REQ(){
	}

	public SOULPITH_LEVEL_INFO_REQ(long seqNum,String soulpithType){
		this.seqNum = seqNum;
		this.soulpithType = soulpithType;
	}

	public SOULPITH_LEVEL_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "SOULPITH_LEVEL_INFO_REQ";
	}
