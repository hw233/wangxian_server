 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>goodsId</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class SHOP_BUY_RES implements ResponseMessage{
	...
	public SHOP_BUY_RES(long seqNum,String shopName,int goodsId,String description){
		this.seqNum = seqNum;
	...
	public SHOP_BUY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
