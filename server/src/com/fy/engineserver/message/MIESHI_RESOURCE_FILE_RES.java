 ...
 * </table>
 */
public class MIESHI_RESOURCE_FILE_RES implements ResponseMessage{
	...
	public MIESHI_RESOURCE_FILE_RES(long seqNum,String fileName,long offsetNum,byte[] data){
		this.seqNum = seqNum;
	...
	public MIESHI_RESOURCE_FILE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "MIESHI_RESOURCE_FILE_RES";
	}
