 ...
 * </table>
 */
public class FEEDBACK_LOOK_SCORE_RES implements ResponseMessage{
	...
	public FEEDBACK_LOOK_SCORE_RES(){
	}

	public FEEDBACK_LOOK_SCORE_RES(long seqNum,long id,String scoreMess){
		this.seqNum = seqNum;
		this.id = id;
		this.scoreMess = scoreMess;
	}

	public FEEDBACK_LOOK_SCORE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "FEEDBACK_LOOK_SCORE_RES";
	}
