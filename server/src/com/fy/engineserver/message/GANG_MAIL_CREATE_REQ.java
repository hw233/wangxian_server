 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>gangTitle</td><td>byte</td><td>1个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class GANG_MAIL_CREATE_REQ implements RequestMessage{
	...
	public GANG_MAIL_CREATE_REQ(){
	}

	public GANG_MAIL_CREATE_REQ(long seqNum,byte gangTitle,String title,String mcontent){
		this.seqNum = seqNum;
	...
	public GANG_MAIL_CREATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		gangTitle = (byte)mf.byteArrayToNumber(content,offset,1);
		offset += 1;
		int len = 0;
	 ...
	 *	收件人帮派身份限制
	 */
	public void setGangTitle(byte gangTitle){
		this.gangTitle = gangTitle;
	}
