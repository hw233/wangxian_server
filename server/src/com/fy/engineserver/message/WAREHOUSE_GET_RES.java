 ...
 * </table>
 */
public class WAREHOUSE_GET_RES implements ResponseMessage{
	...
	public WAREHOUSE_GET_RES(){
	}

	public WAREHOUSE_GET_RES(long seqNum,boolean open,long[] entityIds,int[] counts){
		this.seqNum = seqNum;
		this.open = open;
	...
	public WAREHOUSE_GET_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
