 ...
 * </table>
 */
public class CACHE_PROPSENTITY_UPDATE_RES implements ResponseMessage{
	...
	public CACHE_PROPSENTITY_UPDATE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public CACHE_PROPSENTITY_UPDATE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CACHE_PROPSENTITY_UPDATE_RES";
	}
