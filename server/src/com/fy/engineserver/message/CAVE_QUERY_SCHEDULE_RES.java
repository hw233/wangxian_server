 ...
 * </table>
 */
public class CAVE_QUERY_SCHEDULE_RES implements ResponseMessage{
	...
	public CAVE_QUERY_SCHEDULE_RES(){
	}

	public CAVE_QUERY_SCHEDULE_RES(long seqNum,int currScheduleNum,int maxScheduleNum,CaveSchedule[] schedules,ResourceCollection currResource,ResourceCollection currMaxResource){
		this.seqNum = seqNum;
	...
	public CAVE_QUERY_SCHEDULE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "CAVE_QUERY_SCHEDULE_RES";
	}
