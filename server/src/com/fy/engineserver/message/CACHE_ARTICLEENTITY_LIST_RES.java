 ...
 * </table>
 */
public class CACHE_ARTICLEENTITY_LIST_RES implements ResponseMessage{
	...
	public CACHE_ARTICLEENTITY_LIST_RES(long seqNum,long[] idlist,String result){
		this.seqNum = seqNum;
		this.idlist = idlist;
		this.result = result;
	}

	public CACHE_ARTICLEENTITY_LIST_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CACHE_ARTICLEENTITY_LIST_RES";
	}
