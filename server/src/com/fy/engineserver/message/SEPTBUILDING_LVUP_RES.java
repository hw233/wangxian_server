 ...
 * </table>
 */
public class SEPTBUILDING_LVUP_RES implements ResponseMessage{
	...
	public SEPTBUILDING_LVUP_RES(){
	}

	public SEPTBUILDING_LVUP_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public SEPTBUILDING_LVUP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
