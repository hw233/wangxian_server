 ...
 * </table>
 */
public class BING_PHONENUM_RES implements ResponseMessage{
	...
	public BING_PHONENUM_RES(){
	}

	public BING_PHONENUM_RES(long seqNum,boolean isOK,String errorMsg){
		this.seqNum = seqNum;
		this.isOK = isOK;
		this.errorMsg = errorMsg;
	}

	public BING_PHONENUM_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
