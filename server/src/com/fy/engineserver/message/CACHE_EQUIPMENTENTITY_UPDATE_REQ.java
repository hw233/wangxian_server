 ...
 * </table>
 */
public class CACHE_EQUIPMENTENTITY_UPDATE_REQ implements RequestMessage{
	...
	public CACHE_EQUIPMENTENTITY_UPDATE_REQ(long seqNum,long id,String showName,long inValidTime,boolean taskArticle,boolean binded,int level,int durability,long[] inlayEntityIds,int attackDefenceCount,int drillCount,String appendix,boolean abandoned,String propertyString){
		this.seqNum = seqNum;
		this.id = id;
	...
	public CACHE_EQUIPMENTENTITY_UPDATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "CACHE_EQUIPMENTENTITY_UPDATE_REQ";
	}
