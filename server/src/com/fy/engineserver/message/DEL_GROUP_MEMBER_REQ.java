 ...
 * </table>
 */
public class DEL_GROUP_MEMBER_REQ implements RequestMessage{
	...
	public DEL_GROUP_MEMBER_REQ(){
	}

	public DEL_GROUP_MEMBER_REQ(long seqNum,long groupId,long playerId){
		this.seqNum = seqNum;
		this.groupId = groupId;
		this.playerId = playerId;
	}

	public DEL_GROUP_MEMBER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
