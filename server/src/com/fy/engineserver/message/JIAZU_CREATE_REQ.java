 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>jiazuname.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>jiazuname</td><td>String</td><td>jiazuname.length</td><td>字符串对应的byte数组</td></tr>
 ...
 * </table>
 */
public class JIAZU_CREATE_REQ implements RequestMessage{
	...
	public JIAZU_CREATE_REQ(){
	}

	public JIAZU_CREATE_REQ(long seqNum,String jiazuname,String slogan){
		this.seqNum = seqNum;
		this.jiazuname = jiazuname;
		this.slogan = slogan;
	}

	public JIAZU_CREATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
