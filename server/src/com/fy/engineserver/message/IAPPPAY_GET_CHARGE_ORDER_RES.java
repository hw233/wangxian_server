 ...
 * </table>
 */
public class IAPPPAY_GET_CHARGE_ORDER_RES implements ResponseMessage{
	...
	public IAPPPAY_GET_CHARGE_ORDER_RES(){
	}

	public IAPPPAY_GET_CHARGE_ORDER_RES(long seqNum,int result,String chargeOrder,long money,String waresId,int chargePoint){
		this.seqNum = seqNum;
		this.result = result;
	...
	public IAPPPAY_GET_CHARGE_ORDER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "IAPPPAY_GET_CHARGE_ORDER_RES";
	}
