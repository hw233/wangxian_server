 ...
 * 版本号：null<br>
 * 客户端通知服务器，精灵沿着按多个目标点表达的路径移动到目的地，包括到达的时间<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class PLAYER_MOVETRACE_REQ implements RequestMessage{
	...
	public PLAYER_MOVETRACE_REQ(){
	}

	public PLAYER_MOVETRACE_REQ(long seqNum,MoveTrace4Client moveTrace4Client){
		this.seqNum = seqNum;
		this.moveTrace4Client = moveTrace4Client;
	}

	public PLAYER_MOVETRACE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
