 ...
 * </table>
 */
public class LENOVO_GET_CHARGE_ORDER_RES implements ResponseMessage{
	...
	public LENOVO_GET_CHARGE_ORDER_RES(){
	}

	public LENOVO_GET_CHARGE_ORDER_RES(long seqNum,int result,String chargeOrder){
		this.seqNum = seqNum;
		this.result = result;
		this.chargeOrder = chargeOrder;
	}

	public LENOVO_GET_CHARGE_ORDER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "LENOVO_GET_CHARGE_ORDER_RES";
	}
