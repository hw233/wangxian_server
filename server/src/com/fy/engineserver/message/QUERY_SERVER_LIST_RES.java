...
import com.fy.engineserver.gateway.ServerInfoForClient;
 ...
 * </table>
 */
public class QUERY_SERVER_LIST_RES implements ResponseMessage{
	...
	public QUERY_SERVER_LIST_RES(){
	}

	public QUERY_SERVER_LIST_RES(long seqNum,String lastLoginCategory,String[] categories,ServerInfoForClient[] serverInfos){
		this.seqNum = seqNum;
	...
	public QUERY_SERVER_LIST_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
