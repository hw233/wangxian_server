 ...
 * </table>
 */
public class UNBIND_PHONENUM_RES implements ResponseMessage{
	...
	public UNBIND_PHONENUM_RES(){
	}

	public UNBIND_PHONENUM_RES(long seqNum,boolean isOK,String errorMsg){
		this.seqNum = seqNum;
		this.isOK = isOK;
		this.errorMsg = errorMsg;
	}

	public UNBIND_PHONENUM_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
