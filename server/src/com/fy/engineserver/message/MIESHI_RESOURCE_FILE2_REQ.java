 ...
 * </table>
 */
public class MIESHI_RESOURCE_FILE2_REQ implements RequestMessage{
	...
	public MIESHI_RESOURCE_FILE2_REQ(long seqNum,String fileName,long offsetNum,byte[] data){
		this.seqNum = seqNum;
	...
	public MIESHI_RESOURCE_FILE2_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "MIESHI_RESOURCE_FILE2_REQ";
	}
