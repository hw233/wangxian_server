 ...
 * </table>
 */
public class GET_JIAZU_SKILL_INFO_RES implements ResponseMessage{
	...
	public GET_JIAZU_SKILL_INFO_RES(){
	}

	public GET_JIAZU_SKILL_INFO_RES(long seqNum,int skillId,String description){
		this.seqNum = seqNum;
		this.skillId = skillId;
		this.description = description;
	}

	public GET_JIAZU_SKILL_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "GET_JIAZU_SKILL_INFO_RES";
	}
