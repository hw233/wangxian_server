 ...
 * </table>
 */
public class GET_ONE_DAILY_TURN_REQ implements RequestMessage{
	...
	public GET_ONE_DAILY_TURN_REQ(){
	}

	public GET_ONE_DAILY_TURN_REQ(long seqNum,String turnName,int turnId){
		this.seqNum = seqNum;
		this.turnName = turnName;
		this.turnId = turnId;
	}

	public GET_ONE_DAILY_TURN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
