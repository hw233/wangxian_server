 ...
 * </table>
 */
public class PET_ALLOCATE_POINTS_REQ implements RequestMessage{
	...
	public PET_ALLOCATE_POINTS_REQ(){
	}

	public PET_ALLOCATE_POINTS_REQ(long seqNum,long petId,int[] points){
		this.seqNum = seqNum;
		this.petId = petId;
		this.points = points;
	}

	public PET_ALLOCATE_POINTS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PET_ALLOCATE_POINTS_REQ";
	}
