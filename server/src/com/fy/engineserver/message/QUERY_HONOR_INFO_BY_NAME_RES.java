 ...
 * </table>
 */
public class QUERY_HONOR_INFO_BY_NAME_RES implements ResponseMessage{
	...
	public QUERY_HONOR_INFO_BY_NAME_RES(){
	}

	public QUERY_HONOR_INFO_BY_NAME_RES(long seqNum,String description){
		this.seqNum = seqNum;
		this.description = description;
	}

	public QUERY_HONOR_INFO_BY_NAME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_HONOR_INFO_BY_NAME_RES";
	}
