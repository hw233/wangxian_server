 ...
 * </table>
 */
public class CHANGE_PLAYER_NAME_REQ implements RequestMessage{
	...
	public CHANGE_PLAYER_NAME_REQ(){
	}

	public CHANGE_PLAYER_NAME_REQ(long seqNum,long playerId,String newName){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.newName = newName;
	}

	public CHANGE_PLAYER_NAME_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
