 ...
 * </table>
 */
public class GET_SHOUHUN_KNAP_RES implements ResponseMessage{
	...
	public GET_SHOUHUN_KNAP_RES(){
	}

	public GET_SHOUHUN_KNAP_RES(long seqNum,long[] articleIds){
		this.seqNum = seqNum;
		this.articleIds = articleIds;
	}

	public GET_SHOUHUN_KNAP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
