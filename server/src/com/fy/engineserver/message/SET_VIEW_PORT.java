 ...
 * </table>
 */
public class SET_VIEW_PORT implements RequestMessage{
	...
	public SET_VIEW_PORT(){
	}

	public SET_VIEW_PORT(long seqNum,int viewWidth,int viewHeight){
		this.seqNum = seqNum;
		this.viewWidth = viewWidth;
		this.viewHeight = viewHeight;
	}

	public SET_VIEW_PORT(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
