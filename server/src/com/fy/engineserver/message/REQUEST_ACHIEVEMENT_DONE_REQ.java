 ...
 * </table>
 */
public class REQUEST_ACHIEVEMENT_DONE_REQ implements RequestMessage{
	...
	public REQUEST_ACHIEVEMENT_DONE_REQ(){
	}

	public REQUEST_ACHIEVEMENT_DONE_REQ(long seqNum,String mainName,String subName){
		this.seqNum = seqNum;
		this.mainName = mainName;
		this.subName = subName;
	}

	public REQUEST_ACHIEVEMENT_DONE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "REQUEST_ACHIEVEMENT_DONE_REQ";
	}
