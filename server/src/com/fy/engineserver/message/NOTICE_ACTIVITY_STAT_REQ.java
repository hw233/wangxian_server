 ...
 * </table>
 */
public class NOTICE_ACTIVITY_STAT_REQ implements RequestMessage{
	...
	public NOTICE_ACTIVITY_STAT_REQ(){
	}

	public NOTICE_ACTIVITY_STAT_REQ(long seqNum,int reqType,String activityName){
		this.seqNum = seqNum;
		this.reqType = reqType;
		this.activityName = activityName;
	}

	public NOTICE_ACTIVITY_STAT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NOTICE_ACTIVITY_STAT_REQ";
	}
