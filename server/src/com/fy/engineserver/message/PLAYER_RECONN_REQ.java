 ...
 * 版本号：null<br>
 * 客户端通知服务器，刚才断网，重新连接上来，要求继续进行游戏<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class PLAYER_RECONN_REQ implements RequestMessage{
	...
	public PLAYER_RECONN_REQ(){
	}

	public PLAYER_RECONN_REQ(long seqNum,String username,String password,long player,String authCode){
		this.seqNum = seqNum;
	...
	public PLAYER_RECONN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
