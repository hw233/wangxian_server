 ...
 * </table>
 */
public class GET_SHOP_REQ implements RequestMessage{
	...
	public GET_SHOP_REQ(long seqNum,String shopName){
		this.seqNum = seqNum;
		this.shopName = shopName;
	}

	public GET_SHOP_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
