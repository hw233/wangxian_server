 ...
 * </table>
 */
public class USER_CHANGE_PASSWORD_REQ implements RequestMessage{
	...
	public USER_CHANGE_PASSWORD_REQ(){
	}

	public USER_CHANGE_PASSWORD_REQ(long seqNum,String clientId,String username,String passwd,String newpasswd,String protectAnswer){
		this.seqNum = seqNum;
	...
	public USER_CHANGE_PASSWORD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "USER_CHANGE_PASSWORD_REQ";
	}
