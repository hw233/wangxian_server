 ...
 * </table>
 */
public class JIAZU_CREATE_RES implements ResponseMessage{
	...
	public JIAZU_CREATE_RES(){
	}

	public JIAZU_CREATE_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public JIAZU_CREATE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
