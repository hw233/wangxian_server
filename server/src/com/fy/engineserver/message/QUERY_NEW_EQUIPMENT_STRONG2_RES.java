 ...
 * </table>
 */
public class QUERY_NEW_EQUIPMENT_STRONG2_RES implements ResponseMessage{
	...
	public QUERY_NEW_EQUIPMENT_STRONG2_RES(){
	}

	public QUERY_NEW_EQUIPMENT_STRONG2_RES(long seqNum,String baoDiName,long equipmentId,long cost,String strongedUUB,String[] strongMaterialName,int[] strongMaterialLuck,String otherStrongMaterialName,int otherStrongMaterialNum,int otherStrongMaterialluck){
		this.seqNum = seqNum;
	...
	public QUERY_NEW_EQUIPMENT_STRONG2_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_NEW_EQUIPMENT_STRONG2_RES";
	}
