 ...
 * </table>
 */
public class QUERY_EQUIPMENT_PICKSTAR_RES implements ResponseMessage{
	...
	public QUERY_EQUIPMENT_PICKSTAR_RES(){
	}

	public QUERY_EQUIPMENT_PICKSTAR_RES(long seqNum,long equipmentId,String description){
		this.seqNum = seqNum;
		this.equipmentId = equipmentId;
		this.description = description;
	}

	public QUERY_EQUIPMENT_PICKSTAR_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_EQUIPMENT_PICKSTAR_RES";
	}
