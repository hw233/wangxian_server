 ...
 * </table>
 */
public class HUNSHI_JIANDING2_SURE_RES implements ResponseMessage{
	...
	public HUNSHI_JIANDING2_SURE_RES(){
	}

	public HUNSHI_JIANDING2_SURE_RES(long seqNum,String des,boolean result){
		this.seqNum = seqNum;
		this.des = des;
		this.result = result;
	}

	public HUNSHI_JIANDING2_SURE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "HUNSHI_JIANDING2_SURE_RES";
	}
