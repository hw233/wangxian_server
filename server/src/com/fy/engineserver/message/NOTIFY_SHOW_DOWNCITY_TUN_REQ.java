 ...
 * </table>
 */
public class NOTIFY_SHOW_DOWNCITY_TUN_REQ implements RequestMessage{
	...
	public NOTIFY_SHOW_DOWNCITY_TUN_REQ(){
	}

	public NOTIFY_SHOW_DOWNCITY_TUN_REQ(long seqNum,long[] articleIds,int[] articleNums,int leftTimes){
		this.seqNum = seqNum;
	...
	public NOTIFY_SHOW_DOWNCITY_TUN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "NOTIFY_SHOW_DOWNCITY_TUN_REQ";
	}
