 ...
 * </table>
 */
public class CHAT_CHANNEL_STATUS_RES implements ResponseMessage{
	...
	public CHAT_CHANNEL_STATUS_RES(){
	}

	public CHAT_CHANNEL_STATUS_RES(long seqNum,byte[] status){
		this.seqNum = seqNum;
		this.status = status;
	}

	public CHAT_CHANNEL_STATUS_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CHAT_CHANNEL_STATUS_RES";
	}
