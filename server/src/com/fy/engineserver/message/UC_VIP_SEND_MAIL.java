 ...
 * </table>
 */
public class UC_VIP_SEND_MAIL implements RequestMessage{
	...
	public UC_VIP_SEND_MAIL(){
	}

	public UC_VIP_SEND_MAIL(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public UC_VIP_SEND_MAIL(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
