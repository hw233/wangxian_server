 ...
 * </table>
 */
public class GET_ACTIVITY_MESS_REQ implements RequestMessage{
	...
	public GET_ACTIVITY_MESS_REQ(){
	}

	public GET_ACTIVITY_MESS_REQ(long seqNum,String activityName){
		this.seqNum = seqNum;
		this.activityName = activityName;
	}

	public GET_ACTIVITY_MESS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
