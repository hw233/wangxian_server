 ...
 * </table>
 */
public class THIRDPART_PROMOTE_RES implements ResponseMessage{
	...
	public THIRDPART_PROMOTE_RES(){
	}

	public THIRDPART_PROMOTE_RES(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public THIRDPART_PROMOTE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
