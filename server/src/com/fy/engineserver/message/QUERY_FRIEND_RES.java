 ...
 * </table>
 */
public class QUERY_FRIEND_RES implements ResponseMessage{
	...
	public QUERY_FRIEND_RES(){
	}

	public QUERY_FRIEND_RES(long seqNum,Player_RelatinInfo[] player_relationInfo){
		this.seqNum = seqNum;
		this.player_relationInfo = player_relationInfo;
	}

	public QUERY_FRIEND_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
