 ...
 * </table>
 */
public class HUNSHI2_INFOSHOW_REQ implements RequestMessage{
	...
	public HUNSHI2_INFOSHOW_REQ(){
	}

	public HUNSHI2_INFOSHOW_REQ(long seqNum,long hunshiId,long horseId,long playerId){
		this.seqNum = seqNum;
	...
	public HUNSHI2_INFOSHOW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
