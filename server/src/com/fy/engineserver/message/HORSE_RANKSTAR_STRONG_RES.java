 ...
 * </table>
 */
public class HORSE_RANKSTAR_STRONG_RES implements ResponseMessage{
	...
	public HORSE_RANKSTAR_STRONG_RES(){
	}

	public HORSE_RANKSTAR_STRONG_RES(long seqNum,int free4rank,byte result){
		this.seqNum = seqNum;
		this.free4rank = free4rank;
		this.result = result;
	}

	public HORSE_RANKSTAR_STRONG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "HORSE_RANKSTAR_STRONG_RES";
	}
