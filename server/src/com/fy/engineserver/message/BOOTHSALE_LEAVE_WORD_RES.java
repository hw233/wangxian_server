 ...
 * </table>
 */
public class BOOTHSALE_LEAVE_WORD_RES implements ResponseMessage{
	...
	public BOOTHSALE_LEAVE_WORD_RES(){
	}

	public BOOTHSALE_LEAVE_WORD_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public BOOTHSALE_LEAVE_WORD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "BOOTHSALE_LEAVE_WORD_RES";
	}
