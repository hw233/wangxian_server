 ...
 * </table>
 */
public class EXCHANGE_CONFIRMACTION_CODE_RES implements ResponseMessage{
	...
	public EXCHANGE_CONFIRMACTION_CODE_RES(){
	}

	public EXCHANGE_CONFIRMACTION_CODE_RES(long seqNum,int result,String notice){
		this.seqNum = seqNum;
		this.result = result;
		this.notice = notice;
	}

	public EXCHANGE_CONFIRMACTION_CODE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "EXCHANGE_CONFIRMACTION_CODE_RES";
	}
