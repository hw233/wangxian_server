 ...
 * </table>
 */
public class XL_CATCH_SUCC_RES implements ResponseMessage{
	...
	public XL_CATCH_SUCC_RES(){
	}

	public XL_CATCH_SUCC_RES(long seqNum,int score,boolean result){
		this.seqNum = seqNum;
		this.score = score;
		this.result = result;
	}

	public XL_CATCH_SUCC_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
