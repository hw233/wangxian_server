 ...
 * </table>
 */
public class VERSION_CHECK_REQ implements RequestMessage{
	...
	public VERSION_CHECK_REQ(long seqNum,String clientId,String MIDletName,String MIDletVersion,String handset,String platform,long recommendid){
		this.seqNum = seqNum;
	...
	public VERSION_CHECK_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
