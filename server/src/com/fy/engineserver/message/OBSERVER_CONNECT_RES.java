 ...
 * </table>
 */
public class OBSERVER_CONNECT_RES implements ResponseMessage{
	...
	public OBSERVER_CONNECT_RES(long seqNum,byte result,String resultString){
		this.seqNum = seqNum;
		this.result = result;
		this.resultString = resultString;
	}

	public OBSERVER_CONNECT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
