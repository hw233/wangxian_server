 ...
 * </table>
 */
public class PET_TARGET_SKILL_REQ implements RequestMessage{
	...
	public PET_TARGET_SKILL_REQ(){
	}

	public PET_TARGET_SKILL_REQ(long seqNum,short targetX,short targetY,byte[] targetType,long[] targetId,short skillId,byte direction){
		this.seqNum = seqNum;
	...
	public PET_TARGET_SKILL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
