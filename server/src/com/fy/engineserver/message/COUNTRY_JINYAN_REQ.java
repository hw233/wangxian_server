 ...
 * </table>
 */
public class COUNTRY_JINYAN_REQ implements RequestMessage{
	...
	public COUNTRY_JINYAN_REQ(){
	}

	public COUNTRY_JINYAN_REQ(long seqNum,String playerName){
		this.seqNum = seqNum;
		this.playerName = playerName;
	}

	public COUNTRY_JINYAN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
