 ...
 * </table>
 */
public class QUERY_PLAYER_TITLE_RES implements ResponseMessage{
	...
	public QUERY_PLAYER_TITLE_RES(){
	}

	public QUERY_PLAYER_TITLE_RES(long seqNum,int[] types,String[] names){
		this.seqNum = seqNum;
		this.types = types;
		this.names = names;
	}

	public QUERY_PLAYER_TITLE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
