 ...
 * </table>
 */
public class INLAY_SOULPITH_REQ implements RequestMessage{
	...
	public INLAY_SOULPITH_REQ(){
	}

	public INLAY_SOULPITH_REQ(long seqNum,int soultype,int inlayIndex,long articleId){
		this.seqNum = seqNum;
	...
	public INLAY_SOULPITH_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
