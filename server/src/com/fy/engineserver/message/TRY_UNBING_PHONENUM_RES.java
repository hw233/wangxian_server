 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>sendSpace</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>sendMsg.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>sendMsg</td><td>String</td><td>sendMsg.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class TRY_UNBING_PHONENUM_RES implements ResponseMessage{
	...
	public TRY_UNBING_PHONENUM_RES(){
	}

	public TRY_UNBING_PHONENUM_RES(long seqNum,String msg,String phoneNum,int sendSpace,String sendMsg){
		this.seqNum = seqNum;
		this.msg = msg;
	...
	public TRY_UNBING_PHONENUM_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "TRY_UNBING_PHONENUM_RES";
	}
