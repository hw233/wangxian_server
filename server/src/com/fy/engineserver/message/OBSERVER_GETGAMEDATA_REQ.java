 ...
 * </table>
 */
public class OBSERVER_GETGAMEDATA_REQ implements RequestMessage{
	...
	public OBSERVER_GETGAMEDATA_REQ(long seqNum,String world,String game){
		this.seqNum = seqNum;
		this.world = world;
		this.game = game;
	}

	public OBSERVER_GETGAMEDATA_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "OBSERVER_GETGAMEDATA_REQ";
	}
