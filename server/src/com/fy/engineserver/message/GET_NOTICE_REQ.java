 ...
 * </table>
 */
public class GET_NOTICE_REQ implements RequestMessage{
	...
	public GET_NOTICE_REQ(){
	}

	public GET_NOTICE_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public GET_NOTICE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
