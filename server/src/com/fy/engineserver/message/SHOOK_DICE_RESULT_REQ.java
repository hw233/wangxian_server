 ...
 * </table>
 */
public class SHOOK_DICE_RESULT_REQ implements RequestMessage{
	...
	public SHOOK_DICE_RESULT_REQ(){
	}

	public SHOOK_DICE_RESULT_REQ(long seqNum,long id,int fightType){
		this.seqNum = seqNum;
		this.id = id;
		this.fightType = fightType;
	}

	public SHOOK_DICE_RESULT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
