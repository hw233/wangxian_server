 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>equipmentType</td><td>byte</td><td>1个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class SHOP_GET_BY_QUERY_CONDITION_REQ implements RequestMessage{
	...
	public SHOP_GET_BY_QUERY_CONDITION_REQ(){
	}

	public SHOP_GET_BY_QUERY_CONDITION_REQ(long seqNum,String shopName,byte equipmentType){
		this.seqNum = seqNum;
		this.shopName = shopName;
		this.equipmentType = equipmentType;
	}

	public SHOP_GET_BY_QUERY_CONDITION_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "SHOP_GET_BY_QUERY_CONDITION_REQ";
	}
