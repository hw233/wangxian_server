 ...
 * </table>
 */
public class WAREHOUSE_CHANGE_REQ implements RequestMessage{
	...
	public WAREHOUSE_CHANGE_REQ(long seqNum,long[] entityIds,int[] counts){
		this.seqNum = seqNum;
		this.entityIds = entityIds;
		this.counts = counts;
	}

	public WAREHOUSE_CHANGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
