 ...
 * </table>
 */
public class QUERY_COUNTRY_GONGGAO_RES implements ResponseMessage{
	...
	public QUERY_COUNTRY_GONGGAO_RES(){
	}

	public QUERY_COUNTRY_GONGGAO_RES(long seqNum,String notice){
		this.seqNum = seqNum;
		this.notice = notice;
	}

	public QUERY_COUNTRY_GONGGAO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_COUNTRY_GONGGAO_RES";
	}
