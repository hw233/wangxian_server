 ...
 * </table>
 */
public class MONTH_CARD_FIRST_PAGE_REQ implements RequestMessage{
	...
	public MONTH_CARD_FIRST_PAGE_REQ(){
	}

	public MONTH_CARD_FIRST_PAGE_REQ(long seqNum,String channelName){
		this.seqNum = seqNum;
		this.channelName = channelName;
	}

	public MONTH_CARD_FIRST_PAGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "MONTH_CARD_FIRST_PAGE_REQ";
	}
