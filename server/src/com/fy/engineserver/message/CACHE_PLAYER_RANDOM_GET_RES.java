 ...
 * </table>
 */
public class CACHE_PLAYER_RANDOM_GET_RES implements ResponseMessage{
	...
	public CACHE_PLAYER_RANDOM_GET_RES(long seqNum,byte[] playerProtobuf,int[] statid,long[] svalue,long[] lastUpdateTime,String result){
		this.seqNum = seqNum;
	...
	public CACHE_PLAYER_RANDOM_GET_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CACHE_PLAYER_RANDOM_GET_RES";
	}
