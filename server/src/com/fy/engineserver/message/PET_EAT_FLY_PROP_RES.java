 ...
 * </table>
 */
public class PET_EAT_FLY_PROP_RES implements ResponseMessage{
	...
	public PET_EAT_FLY_PROP_RES(){
	}

	public PET_EAT_FLY_PROP_RES(long seqNum,long petId,int result){
		this.seqNum = seqNum;
		this.petId = petId;
		this.result = result;
	}

	public PET_EAT_FLY_PROP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
