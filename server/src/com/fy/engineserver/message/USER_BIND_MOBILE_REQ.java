 ...
 * </table>
 */
public class USER_BIND_MOBILE_REQ implements RequestMessage{
	...
	public USER_BIND_MOBILE_REQ(){
	}

	public USER_BIND_MOBILE_REQ(long seqNum,String username,String passwd,String mobile){
		this.seqNum = seqNum;
	...
	public USER_BIND_MOBILE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
