 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>needSilver</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>energy</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class XL_BUTENERGY_RES implements ResponseMessage{
	...
	public XL_BUTENERGY_RES(){
	}

	public XL_BUTENERGY_RES(long seqNum,String des,long needSilver,int energy){
		this.seqNum = seqNum;
		this.des = des;
	...
	public XL_BUTENERGY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		offset += len;
		needSilver = (long)mf.byteArrayToNumber(content,offset,8);
		offset += 8;
