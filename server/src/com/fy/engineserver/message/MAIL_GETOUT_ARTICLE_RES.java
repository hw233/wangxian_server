 ...
 * </table>
 */
public class MAIL_GETOUT_ARTICLE_RES implements ResponseMessage{
	...
	public MAIL_GETOUT_ARTICLE_RES(){
	}

	public MAIL_GETOUT_ARTICLE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public MAIL_GETOUT_ARTICLE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "MAIL_GETOUT_ARTICLE_RES";
	}
