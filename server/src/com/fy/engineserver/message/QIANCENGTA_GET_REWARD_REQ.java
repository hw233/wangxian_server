 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>isOver</td><td>boolean</td><td>1个字节</td><td>布尔型长度,0==false，其他为true</td></tr>
 ...
 * </table>
 */
public class QIANCENGTA_GET_REWARD_REQ implements RequestMessage{
	...
	public QIANCENGTA_GET_REWARD_REQ(){
	}

	public QIANCENGTA_GET_REWARD_REQ(long seqNum,long playerId,boolean isOver,int daoIndex,int cengIndex){
		this.seqNum = seqNum;
	...
	public QIANCENGTA_GET_REWARD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QIANCENGTA_GET_REWARD_REQ";
	}
	...
	/**
	 * 获取属性：
	 *	是否是手动爬塔的领取，如果是就不会返回QIANCENGTA_REWARD_INFO_REQ
	 */
