 ...
 * </table>
 */
public class PET_FEED_RES implements ResponseMessage{
	...
	public PET_FEED_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public PET_FEED_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
