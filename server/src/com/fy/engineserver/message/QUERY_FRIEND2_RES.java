 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>player_relationInfo[0].relationShip</td><td>byte</td><td>1个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>player_relationInfo[0].isonline</td><td>boolean</td><td>1个字节</td><td>布尔型长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>player_relationInfo[0].mood.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>player_relationInfo[0].mood</td><td>String</td><td>player_relationInfo[0].mood.length</td><td>字符串对应的byte数组</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>player_relationInfo[2].relationShip</td><td>byte</td><td>1个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>player_relationInfo[2].isonline</td><td>boolean</td><td>1个字节</td><td>布尔型长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>player_relationInfo[2].mood.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>player_relationInfo[2].mood</td><td>String</td><td>player_relationInfo[2].mood.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td colspan=4>......... 重复</td></tr>
 * </table>
 */
public class QUERY_FRIEND2_RES implements ResponseMessage{
	...
	public QUERY_FRIEND2_RES(){
	}

	public QUERY_FRIEND2_RES(long seqNum,Player_RelatinInfo[] player_relationInfo){
		this.seqNum = seqNum;
		this.player_relationInfo = player_relationInfo;
	}

	public QUERY_FRIEND2_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
