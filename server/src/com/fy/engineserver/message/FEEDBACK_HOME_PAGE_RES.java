 ...
 * </table>
 */
public class FEEDBACK_HOME_PAGE_RES implements ResponseMessage{
	...
	public FEEDBACK_HOME_PAGE_RES(){
	}

	public FEEDBACK_HOME_PAGE_RES(long seqNum,String queueCountMess,String gmServiceMess,int showNumLimit,NewFeedback[] feedbacks){
		this.seqNum = seqNum;
	...
	public FEEDBACK_HOME_PAGE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
