 ...
 * </table>
 */
public class BOOTHSALE_BUY_RES implements ResponseMessage{
	...
	public BOOTHSALE_BUY_RES(){
	}

	public BOOTHSALE_BUY_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public BOOTHSALE_BUY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
