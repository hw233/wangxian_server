 ...
 * </table>
 */
public class REQUESTBUY_CANCEL_SELF_RES implements ResponseMessage{
	...
	public REQUESTBUY_CANCEL_SELF_RES(){
	}

	public REQUESTBUY_CANCEL_SELF_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public REQUESTBUY_CANCEL_SELF_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "REQUESTBUY_CANCEL_SELF_RES";
	}
