 ...
 * </table>
 */
public class GET_HORSE_SKILL_INFO_SHOW_RES implements ResponseMessage{
	...
	public GET_HORSE_SKILL_INFO_SHOW_RES(){
	}

	public GET_HORSE_SKILL_INFO_SHOW_RES(long seqNum,int skillId,String description){
		this.seqNum = seqNum;
		this.skillId = skillId;
		this.description = description;
	}

	public GET_HORSE_SKILL_INFO_SHOW_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "GET_HORSE_SKILL_INFO_SHOW_RES";
	}
