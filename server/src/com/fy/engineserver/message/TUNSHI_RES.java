 ...
 * </table>
 */
public class TUNSHI_RES implements ResponseMessage{
	...
	public TUNSHI_RES(long seqNum,long mainArticleId,int currentHunLiang,int maxHunLiang){
		this.seqNum = seqNum;
	...
	public TUNSHI_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
