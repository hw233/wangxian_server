 ...
 * </table>
 */
public class PLAYER_RECONN_RES implements ResponseMessage{
	...
	public PLAYER_RECONN_RES(){
	}

	public PLAYER_RECONN_RES(long seqNum,byte result,String resultString){
		this.seqNum = seqNum;
		this.result = result;
		this.resultString = resultString;
	}

	public PLAYER_RECONN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
