 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>voiceTime</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>voiceSize</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>voiceInfoNum</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>otherInfo.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>otherInfo[0].length</td><td>int</td><td>2</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>otherInfo[0]</td><td>String</td><td>otherInfo[0].length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>otherInfo[1].length</td><td>int</td><td>2</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>otherInfo[1]</td><td>String</td><td>otherInfo[1].length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>otherInfo[2].length</td><td>int</td><td>2</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>otherInfo[2]</td><td>String</td><td>otherInfo[2].length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td colspan=4>......... 重复</td></tr>
 * </table>
 */
public class CHAT_VOICE_RES implements ResponseMessage{
	...
	public CHAT_VOICE_RES(){
	}

	public CHAT_VOICE_RES(long seqNum,byte sort,long senderId,String senderName,String voiceKeyID,int voiceTime,int voiceSize,int voiceInfoNum,String[] otherInfo){
		this.seqNum = seqNum;
		this.sort = sort;
	...
	public CHAT_VOICE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
