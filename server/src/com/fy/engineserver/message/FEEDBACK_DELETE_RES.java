 ...
 * </table>
 */
public class FEEDBACK_DELETE_RES implements ResponseMessage{
	...
	public FEEDBACK_DELETE_RES(){
	}

	public FEEDBACK_DELETE_RES(long seqNum,long id,String resultMess,byte result){
		this.seqNum = seqNum;
		this.id = id;
	...
	public FEEDBACK_DELETE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
