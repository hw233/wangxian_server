 ...
 * </table>
 */
public class REBEL_EVICT_REQ implements RequestMessage{
	...
	public REBEL_EVICT_REQ(){
	}

	public REBEL_EVICT_REQ(long seqNum,boolean opration,long id){
		this.seqNum = seqNum;
		this.opration = opration;
		this.id = id;
	}

	public REBEL_EVICT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
