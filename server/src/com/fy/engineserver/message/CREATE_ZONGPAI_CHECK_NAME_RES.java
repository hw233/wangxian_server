 ...
 * </table>
 */
public class CREATE_ZONGPAI_CHECK_NAME_RES implements ResponseMessage{
	...
	public CREATE_ZONGPAI_CHECK_NAME_RES(){
	}

	public CREATE_ZONGPAI_CHECK_NAME_RES(long seqNum,String result,String name,String declaration){
		this.seqNum = seqNum;
		this.result = result;
		this.name = name;
	...
	public CREATE_ZONGPAI_CHECK_NAME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CREATE_ZONGPAI_CHECK_NAME_RES";
	}
