 ...
 * </table>
 */
public class JIAZU_APPOINT_RES implements ResponseMessage{
	...
	public JIAZU_APPOINT_RES(){
	}

	public JIAZU_APPOINT_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public JIAZU_APPOINT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
