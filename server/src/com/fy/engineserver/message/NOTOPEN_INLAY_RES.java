 ...
 * </table>
 */
public class NOTOPEN_INLAY_RES implements ResponseMessage{
	...
	public NOTOPEN_INLAY_RES(){
	}

	public NOTOPEN_INLAY_RES(long seqNum,String des){
		this.seqNum = seqNum;
		this.des = des;
	}

	public NOTOPEN_INLAY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
