 ...
 * </table>
 */
public class UCSDK_NOTICE_CHARGE_RES implements ResponseMessage{
	...
	public UCSDK_NOTICE_CHARGE_RES(){
	}

	public UCSDK_NOTICE_CHARGE_RES(long seqNum,int result,String chargeOrder){
		this.seqNum = seqNum;
		this.result = result;
		this.chargeOrder = chargeOrder;
	}

	public UCSDK_NOTICE_CHARGE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "UCSDK_NOTICE_CHARGE_RES";
	}
