 ...
 * </table>
 */
public class QUERY_EQUIPMENT_STRONG_RES implements ResponseMessage{
	...
	public QUERY_EQUIPMENT_STRONG_RES(){
	}

	public QUERY_EQUIPMENT_STRONG_RES(long seqNum,long equipmentId,long cost,String strongedUUB,String[] strongMaterialName,int[] strongMaterialLuck){
		this.seqNum = seqNum;
	...
	public QUERY_EQUIPMENT_STRONG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_EQUIPMENT_STRONG_RES";
	}
