 ...
 * </table>
 */
public class DEFAULT_GET_CHARGEORDER_REQ implements RequestMessage{
	...
	public DEFAULT_GET_CHARGEORDER_REQ(){
	}

	public DEFAULT_GET_CHARGEORDER_REQ(long seqNum,String modeName,String channel,String os,String id){
		this.seqNum = seqNum;
	...
	public DEFAULT_GET_CHARGEORDER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "DEFAULT_GET_CHARGEORDER_REQ";
	}
