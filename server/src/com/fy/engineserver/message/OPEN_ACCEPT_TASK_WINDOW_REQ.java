 ...
 * </table>
 */
public class OPEN_ACCEPT_TASK_WINDOW_REQ implements RequestMessage{
	...
	public OPEN_ACCEPT_TASK_WINDOW_REQ(){
	}

	public OPEN_ACCEPT_TASK_WINDOW_REQ(long seqNum,Task task,TaskTarget[] targets,TaskPrize[] prizes,long articleId){
		this.seqNum = seqNum;
		this.task = task;
	...
	public OPEN_ACCEPT_TASK_WINDOW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		task = new Task();
	...
	public String getTypeDescription() {
		return "OPEN_ACCEPT_TASK_WINDOW_REQ";
	}
