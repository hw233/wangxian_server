 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>cengMsg.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>cengMsg</td><td>String</td><td>cengMsg.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>rewardsExp</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>rewards.cengIndex</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>rewards.rewardid.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>rewards.rewardid</td><td>long[]</td><td>rewards.rewardid.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>rewards.nums.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>rewards.nums</td><td>int[]</td><td>rewards.nums.length</td><td>*</td></tr>
 * </table>
 */
public class NEWQIANCHENGTA_MANUAL_OVER_RES implements ResponseMessage{
	...
	public NEWQIANCHENGTA_MANUAL_OVER_RES(){
	}

	public NEWQIANCHENGTA_MANUAL_OVER_RES(long seqNum,int nanduType,int daoIndex,String daoName,String cengMsg,int rewardsExp,RewardMsg rewards){
		this.seqNum = seqNum;
	...
	public NEWQIANCHENGTA_MANUAL_OVER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEWQIANCHENGTA_MANUAL_OVER_RES";
	}
