 ...
 * </table>
 */
public class TENCENT_GET_CHARGE_ORDER_REQ implements RequestMessage{
	...
	public TENCENT_GET_CHARGE_ORDER_REQ(){
	}

	public TENCENT_GET_CHARGE_ORDER_REQ(long seqNum,String modeName,String id){
		this.seqNum = seqNum;
		this.modeName = modeName;
		this.id = id;
	}

	public TENCENT_GET_CHARGE_ORDER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "TENCENT_GET_CHARGE_ORDER_REQ";
	}
