 ...
 * </table>
 */
public class WOLF_USE_SKILL_RES implements ResponseMessage{
	...
	public WOLF_USE_SKILL_RES(){
	}

	public WOLF_USE_SKILL_RES(long seqNum,int result,int skillId){
		this.seqNum = seqNum;
		this.result = result;
		this.skillId = skillId;
	}

	public WOLF_USE_SKILL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
