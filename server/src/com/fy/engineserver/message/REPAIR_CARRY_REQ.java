 ...
 * </table>
 */
public class REPAIR_CARRY_REQ implements RequestMessage{
	...
	public REPAIR_CARRY_REQ(){
	}

	public REPAIR_CARRY_REQ(long seqNum,byte repairType,long equipmentId){
		this.seqNum = seqNum;
		this.repairType = repairType;
		this.equipmentId = equipmentId;
	}

	public REPAIR_CARRY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
