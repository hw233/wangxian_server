 ...
 * </table>
 */
public class QUERY_NEW_EQUIPMENT_STRONG_RES implements ResponseMessage{
	...
	public QUERY_NEW_EQUIPMENT_STRONG_RES(){
	}

	public QUERY_NEW_EQUIPMENT_STRONG_RES(long seqNum,long equipmentId,long cost,String strongedUUB,String[] strongMaterialName,int[] strongMaterialLuck,String otherStrongMaterialName,int otherStrongMaterialNum,int otherStrongMaterialluck){
		this.seqNum = seqNum;
	...
	public QUERY_NEW_EQUIPMENT_STRONG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_NEW_EQUIPMENT_STRONG_RES";
	}
