 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>bindyuanbao</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>lastgame.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>lastgame</td><td>String</td><td>lastgame.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>lastupdatetime</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>polcamp</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>lastLoginTime</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>lastLogoutTime</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>statid.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>statid</td><td>int[]</td><td>statid.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>svalue.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>svalue</td><td>long[]</td><td>svalue.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>lastUpdateTime.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>lastUpdateTime</td><td>long[]</td><td>lastUpdateTime.length</td><td>*</td></tr>
 * </table>
 */
public class CACHE_PLAYER_SAVE_REQ implements RequestMessage{
	...
	public CACHE_PLAYER_SAVE_REQ(long seqNum,String playerName,String userName,int playerLevel,int sex,int career,int hp,int mp,long money,long bindyuanbao,String game,String lastgame,long lastupdatetime,byte[] playerProtobuf,int exp,int polcamp,long lastLoginTime,long lastLogoutTime,int[] statid,long[] svalue,long[] lastUpdateTime){
		this.seqNum = seqNum;
	...
	public CACHE_PLAYER_SAVE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
