 ...
 * </table>
 */
public class QUERY_CHARGE_LIST_REQ implements RequestMessage{
	...
	public QUERY_CHARGE_LIST_REQ(){
	}

	public QUERY_CHARGE_LIST_REQ(long seqNum,String channel){
		this.seqNum = seqNum;
		this.channel = channel;
	}

	public QUERY_CHARGE_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
