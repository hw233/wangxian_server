 ...
 * </table>
 */
public class NEW_USER_ENTER_SERVER_RES implements ResponseMessage{
	...
	public NEW_USER_ENTER_SERVER_RES(){
	}

	public NEW_USER_ENTER_SERVER_RES(long seqNum,byte result,long onlineNum,long offlineNum,long leftTime){
		this.seqNum = seqNum;
		this.result = result;
	...
	public NEW_USER_ENTER_SERVER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEW_USER_ENTER_SERVER_RES";
	}
