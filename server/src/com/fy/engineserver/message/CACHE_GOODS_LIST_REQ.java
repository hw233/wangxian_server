 ...
 * </table>
 */
public class CACHE_GOODS_LIST_REQ implements RequestMessage{
	...
	public CACHE_GOODS_LIST_REQ(long seqNum,int start,int len){
		this.seqNum = seqNum;
		this.start = start;
		this.len = len;
	}

	public CACHE_GOODS_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
