 ...
 * </table>
 */
public class EQUIPMENT_COMPOUND_RES implements ResponseMessage{
	...
	public EQUIPMENT_COMPOUND_RES(){
	}

	public EQUIPMENT_COMPOUND_RES(long seqNum,byte result,String resultString){
		this.seqNum = seqNum;
		this.result = result;
		this.resultString = resultString;
	}

	public EQUIPMENT_COMPOUND_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
