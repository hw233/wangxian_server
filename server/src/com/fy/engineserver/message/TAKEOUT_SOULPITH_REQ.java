 ...
 * </table>
 */
public class TAKEOUT_SOULPITH_REQ implements RequestMessage{
	...
	public TAKEOUT_SOULPITH_REQ(){
	}

	public TAKEOUT_SOULPITH_REQ(long seqNum,int soultype,int inlayIndex){
		this.seqNum = seqNum;
		this.soultype = soultype;
		this.inlayIndex = inlayIndex;
	}

	public TAKEOUT_SOULPITH_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
