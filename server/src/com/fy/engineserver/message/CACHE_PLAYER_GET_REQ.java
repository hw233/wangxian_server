 ...
 * </table>
 */
public class CACHE_PLAYER_GET_REQ implements RequestMessage{
	...
	public CACHE_PLAYER_GET_REQ(long seqNum,String name,long id){
		this.seqNum = seqNum;
		this.name = name;
		this.id = id;
	}

	public CACHE_PLAYER_GET_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
