 ...
 * </table>
 */
public class JIAZU_MASTER_RESIGN_RES implements ResponseMessage{
	...
	public JIAZU_MASTER_RESIGN_RES(){
	}

	public JIAZU_MASTER_RESIGN_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public JIAZU_MASTER_RESIGN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "JIAZU_MASTER_RESIGN_RES";
	}
