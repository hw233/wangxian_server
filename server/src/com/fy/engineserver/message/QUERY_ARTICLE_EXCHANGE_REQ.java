 ...
 * </table>
 */
public class QUERY_ARTICLE_EXCHANGE_REQ implements RequestMessage{
	...
	public QUERY_ARTICLE_EXCHANGE_REQ(){
	}

	public QUERY_ARTICLE_EXCHANGE_REQ(long seqNum,int selectType,String[] articleNames){
		this.seqNum = seqNum;
		this.selectType = selectType;
		this.articleNames = articleNames;
	}

	public QUERY_ARTICLE_EXCHANGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_ARTICLE_EXCHANGE_REQ";
	}
