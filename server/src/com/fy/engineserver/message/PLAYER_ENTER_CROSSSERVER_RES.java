 ...
 * </table>
 */
public class PLAYER_ENTER_CROSSSERVER_RES implements ResponseMessage{
	...
	public PLAYER_ENTER_CROSSSERVER_RES(long seqNum,byte result,String description){
		this.seqNum = seqNum;
		this.result = result;
		this.description = description;
	}

	public PLAYER_ENTER_CROSSSERVER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PLAYER_ENTER_CROSSSERVER_RES";
	}
