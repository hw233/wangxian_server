 ...
 * </table>
 */
public class BOOTHSALE_ADVERTISING_RES implements ResponseMessage{
	...
	public BOOTHSALE_ADVERTISING_RES(){
	}

	public BOOTHSALE_ADVERTISING_RES(long seqNum,byte result,String salername,String failreason,int cycle){
		this.seqNum = seqNum;
		this.result = result;
	...
	public BOOTHSALE_ADVERTISING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "BOOTHSALE_ADVERTISING_RES";
	}
