 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>descType</td><td>byte</td><td>1个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class QUERY_SKILLINFO_RES implements ResponseMessage{
	...
	public QUERY_SKILLINFO_RES(){
	}

	public QUERY_SKILLINFO_RES(long seqNum,short id,byte descType,String description){
		this.seqNum = seqNum;
		this.id = id;
	...
	public QUERY_SKILLINFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
