 ...
 * </table>
 */
public class LEARN_HORSE_SKILL_REQ implements RequestMessage{
	...
	public LEARN_HORSE_SKILL_REQ(){
	}

	public LEARN_HORSE_SKILL_REQ(long seqNum,long horseId,int skillIndex,int skillId){
		this.seqNum = seqNum;
	...
	public LEARN_HORSE_SKILL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
