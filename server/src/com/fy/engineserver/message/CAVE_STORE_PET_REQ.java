 ...
 * </table>
 */
public class CAVE_STORE_PET_REQ implements RequestMessage{
	...
	public CAVE_STORE_PET_REQ(){
	}

	public CAVE_STORE_PET_REQ(long seqNum,byte action,long NPCId,long petId,int index){
		this.seqNum = seqNum;
		this.action = action;
		this.NPCId = NPCId;
		this.petId = petId;
	...
	public CAVE_STORE_PET_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
