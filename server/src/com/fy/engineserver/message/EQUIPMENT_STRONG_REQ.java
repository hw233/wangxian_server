 ...
 * </table>
 */
public class EQUIPMENT_STRONG_REQ implements RequestMessage{
	...
	public EQUIPMENT_STRONG_REQ(){
	}

	public EQUIPMENT_STRONG_REQ(long seqNum,long equipmentId,long[] strongMaterialID,byte strongType){
		this.seqNum = seqNum;
	...
	public EQUIPMENT_STRONG_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
