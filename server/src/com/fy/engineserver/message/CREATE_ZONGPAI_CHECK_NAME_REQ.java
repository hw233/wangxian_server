 ...
 * </table>
 */
public class CREATE_ZONGPAI_CHECK_NAME_REQ implements RequestMessage{
	...
	public CREATE_ZONGPAI_CHECK_NAME_REQ(){
	}

	public CREATE_ZONGPAI_CHECK_NAME_REQ(long seqNum,String name,String declaration){
		this.seqNum = seqNum;
		this.name = name;
		this.declaration = declaration;
	}

	public CREATE_ZONGPAI_CHECK_NAME_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CREATE_ZONGPAI_CHECK_NAME_REQ";
	}
