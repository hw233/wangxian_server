 ...
 * </table>
 */
public class JIAZU_SET_RANK_NAME_RES implements ResponseMessage{
	...
	public JIAZU_SET_RANK_NAME_RES(){
	}

	public JIAZU_SET_RANK_NAME_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public JIAZU_SET_RANK_NAME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "JIAZU_SET_RANK_NAME_RES";
	}
