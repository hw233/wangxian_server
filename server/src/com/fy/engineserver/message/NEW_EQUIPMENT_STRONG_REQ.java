 ...
 * </table>
 */
public class NEW_EQUIPMENT_STRONG_REQ implements RequestMessage{
	...
	public NEW_EQUIPMENT_STRONG_REQ(){
	}

	public NEW_EQUIPMENT_STRONG_REQ(long seqNum,long equipmentId,long[] strongMaterialID,long[] otherStrongMaterialID,int[] otherStrongMaterialNum,byte strongType){
		this.seqNum = seqNum;
	...
	public NEW_EQUIPMENT_STRONG_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEW_EQUIPMENT_STRONG_REQ";
	}
