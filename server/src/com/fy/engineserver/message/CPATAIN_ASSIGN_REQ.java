 ...
 * </table>
 */
public class CPATAIN_ASSIGN_REQ implements RequestMessage{
	...
	public CPATAIN_ASSIGN_REQ(){
	}

	public CPATAIN_ASSIGN_REQ(long seqNum,long spriteId,long articleEntityId,long playerId){
		this.seqNum = seqNum;
	...
	public CPATAIN_ASSIGN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
