 ...
 * </table>
 */
public class CACHE_GOODS_UPDATE_REQ implements RequestMessage{
	...
	public CACHE_GOODS_UPDATE_REQ(long seqNum,long id,int buyPrice,int sellPrice){
		this.seqNum = seqNum;
		this.id = id;
	...
	public CACHE_GOODS_UPDATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
