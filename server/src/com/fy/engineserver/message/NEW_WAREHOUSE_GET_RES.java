 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>warehorseType</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>open</td><td>boolean</td><td>1个字节</td><td>布尔型长度,0==false，其他为true</td></tr>
 ...
 * </table>
 */
public class NEW_WAREHOUSE_GET_RES implements ResponseMessage{
	...
	public NEW_WAREHOUSE_GET_RES(){
	}

	public NEW_WAREHOUSE_GET_RES(long seqNum,int warehorseType,boolean open,long[] entityIds,int[] counts){
		this.seqNum = seqNum;
		this.warehorseType = warehorseType;
		this.open = open;
		this.entityIds = entityIds;
		this.counts = counts;
	}

	public NEW_WAREHOUSE_GET_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		warehorseType = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
	 ...
	 *	6代表2号仓库
	 */
	public int getWarehorseType(){
		return warehorseType;
	}
	 ...
	 *	6代表2号仓库
	 */
	public void setWarehorseType(int warehorseType){
		this.warehorseType = warehorseType;
	}
