 ...
 * </table>
 */
public class NEW_QUERY_ARTICLE_INFO_RES implements ResponseMessage{
	...
	public NEW_QUERY_ARTICLE_INFO_RES(){
	}

	public NEW_QUERY_ARTICLE_INFO_RES(long seqNum,long articleId,String iconId,String description){
		this.seqNum = seqNum;
	...
	public NEW_QUERY_ARTICLE_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEW_QUERY_ARTICLE_INFO_RES";
	}
