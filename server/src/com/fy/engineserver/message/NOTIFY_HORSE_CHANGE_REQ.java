 ...
 * 版本号：null<br>
 * 根据坐骑心跳，服务器向客户端发送，体力值，体力值影响属性百分比<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class NOTIFY_HORSE_CHANGE_REQ implements RequestMessage{
	...
	public NOTIFY_HORSE_CHANGE_REQ(){
	}

	public NOTIFY_HORSE_CHANGE_REQ(long seqNum,long horseId,int energy,int rate){
		this.seqNum = seqNum;
	...
	public NOTIFY_HORSE_CHANGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NOTIFY_HORSE_CHANGE_REQ";
	}
