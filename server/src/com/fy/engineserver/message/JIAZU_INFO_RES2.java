 ...
 * </table>
 */
public class JIAZU_INFO_RES2 implements ResponseMessage{
	...
	public JIAZU_INFO_RES2(){
	}

	public JIAZU_INFO_RES2(long seqNum,long jiazuId,String jiazuName,int level,String slogan,int usedBedge,long constructionConsume,String[] titleAlias,JiazuMember4Client[] jiazuMembers,JiazuBedge[] allBedge,int[] hadBedge,int switchCost,long septStationId,long maintai,long jiazuMoney,long warScore,long prosperity){
		this.seqNum = seqNum;
	...
	public JIAZU_INFO_RES2(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
