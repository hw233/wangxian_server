 ...
 * </table>
 */
public class RECEIVE_FENMU_REWARD_RES implements ResponseMessage{
	...
	public RECEIVE_FENMU_REWARD_RES(){
	}

	public RECEIVE_FENMU_REWARD_RES(long seqNum,String fenmuName,int fenmuIndex,FenDiModel4Client[] fendiModel){
		this.seqNum = seqNum;
	...
	public RECEIVE_FENMU_REWARD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "RECEIVE_FENMU_REWARD_RES";
	}
