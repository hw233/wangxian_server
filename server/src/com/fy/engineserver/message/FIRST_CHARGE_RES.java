 ...
 * </table>
 */
public class FIRST_CHARGE_RES implements ResponseMessage{
	...
	public FIRST_CHARGE_RES(){
	}

	public FIRST_CHARGE_RES(long seqNum,long[] ids,int[] counts){
		this.seqNum = seqNum;
		this.ids = ids;
		this.counts = counts;
	}

	public FIRST_CHARGE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
