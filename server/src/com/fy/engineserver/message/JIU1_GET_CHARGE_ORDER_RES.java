 ...
 * </table>
 */
public class JIU1_GET_CHARGE_ORDER_RES implements ResponseMessage{
	...
	public JIU1_GET_CHARGE_ORDER_RES(){
	}

	public JIU1_GET_CHARGE_ORDER_RES(long seqNum,int result,String chargeOrder,long money){
		this.seqNum = seqNum;
		this.result = result;
	...
	public JIU1_GET_CHARGE_ORDER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "JIU1_GET_CHARGE_ORDER_RES";
	}
