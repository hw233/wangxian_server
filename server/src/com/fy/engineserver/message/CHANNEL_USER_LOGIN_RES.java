 ...
 * </table>
 */
public class CHANNEL_USER_LOGIN_RES implements ResponseMessage{
	...
	public CHANNEL_USER_LOGIN_RES(long seqNum,byte result,String resultString,String authCode,String RecommendWelcome){
		this.seqNum = seqNum;
		this.result = result;
	...
	public CHANNEL_USER_LOGIN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
