 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>basicSkills[0].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>basicSkills[0].needExp</td><td>int[]</td><td>basicSkills[0].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>basicSkills[1].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>basicSkills[1].needExp</td><td>int[]</td><td>basicSkills[1].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>basicSkills[2].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>basicSkills[2].needExp</td><td>int[]</td><td>basicSkills[2].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>professorSkills[0].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>professorSkills[0].needExp</td><td>int[]</td><td>professorSkills[0].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>professorSkills[1].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>professorSkills[1].needExp</td><td>int[]</td><td>professorSkills[1].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>professorSkills[2].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>professorSkills[2].needExp</td><td>int[]</td><td>professorSkills[2].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>nuqiSkills[0].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>nuqiSkills[0].needExp</td><td>int[]</td><td>nuqiSkills[0].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>nuqiSkills[1].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>nuqiSkills[1].needExp</td><td>int[]</td><td>nuqiSkills[1].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>nuqiSkills[2].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>nuqiSkills[2].needExp</td><td>int[]</td><td>nuqiSkills[2].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>xinfaSkills[0].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>xinfaSkills[0].needExp</td><td>int[]</td><td>xinfaSkills[0].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>xinfaSkills[1].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>xinfaSkills[1].needExp</td><td>int[]</td><td>xinfaSkills[1].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>xinfaSkills[2].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>xinfaSkills[2].needExp</td><td>int[]</td><td>xinfaSkills[2].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>kingSkills[0].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>kingSkills[0].needExp</td><td>int[]</td><td>kingSkills[0].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>kingSkills[1].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>kingSkills[1].needExp</td><td>int[]</td><td>kingSkills[1].needExp.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>kingSkills[2].needExp.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>kingSkills[2].needExp</td><td>int[]</td><td>kingSkills[2].needExp.length</td><td>*</td></tr>
 ...
 * </table>
 */
public class QUERY_CAREER_INFO_RES implements ResponseMessage{
	...
	public QUERY_CAREER_INFO_RES(){
	}

	public QUERY_CAREER_INFO_RES(long seqNum,Career career,SkillInfo[] basicSkills,SkillInfo[] professorSkills,SkillInfo[] nuqiSkills,SkillInfo[] xinfaSkills,SkillInfo[] kingSkills){
		this.seqNum = seqNum;
		this.career = career;
	...
	public QUERY_CAREER_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		career = new Career();
		int len = 0;
		...
		for(int i = 0 ; i < basicSkills.length ; i++){
			...
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
			int[] needExp_0004 = new int[len];
			for(int j = 0 ; j < needExp_0004.length ; j++){
				needExp_0004[j] = (int)mf.byteArrayToNumber(content,offset,4);
				offset += 4;
			}
			basicSkills[i].setNeedExp(needExp_0004);
			len = (int)mf.byteArrayToNumber(content,offset,4);
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
		...
		for(int i = 0 ; i < professorSkills.length ; i++){
			...
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
			int[] needExp_0009 = new int[len];
			for(int j = 0 ; j < needExp_0009.length ; j++){
				needExp_0009[j] = (int)mf.byteArrayToNumber(content,offset,4);
				offset += 4;
			}
			professorSkills[i].setNeedExp(needExp_0009);
			len = (int)mf.byteArrayToNumber(content,offset,4);
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
		...
		for(int i = 0 ; i < nuqiSkills.length ; i++){
			...
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
			int[] needExp_0014 = new int[len];
			for(int j = 0 ; j < needExp_0014.length ; j++){
				needExp_0014[j] = (int)mf.byteArrayToNumber(content,offset,4);
				offset += 4;
			}
			nuqiSkills[i].setNeedExp(needExp_0014);
			len = (int)mf.byteArrayToNumber(content,offset,4);
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
		...
		for(int i = 0 ; i < xinfaSkills.length ; i++){
			...
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
			int[] needExp_0019 = new int[len];
			for(int j = 0 ; j < needExp_0019.length ; j++){
				needExp_0019[j] = (int)mf.byteArrayToNumber(content,offset,4);
				offset += 4;
			}
			xinfaSkills[i].setNeedExp(needExp_0019);
			len = (int)mf.byteArrayToNumber(content,offset,4);
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
		...
		for(int i = 0 ; i < kingSkills.length ; i++){
			...
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
			int[] needExp_0024 = new int[len];
			for(int j = 0 ; j < needExp_0024.length ; j++){
				needExp_0024[j] = (int)mf.byteArrayToNumber(content,offset,4);
				offset += 4;
			}
			kingSkills[i].setNeedExp(needExp_0024);
			len = (int)mf.byteArrayToNumber(content,offset,4);
			offset += 4;
			if(len < 0 || len > 4096) throw new Exception("array length ["+len+"] big than the max length [4096]");
	...
	public int getLength() {
		...
		for(int i = 0 ; i < basicSkills.length ; i++){
		 ...
		 e.printStackTrace();
			...
			len += 4;
			len += basicSkills[i].getNeedExp().length * 4;
			len += 4;
		...
		for(int i = 0 ; i < professorSkills.length ; i++){
		 ...
		 e.printStackTrace();
			...
			len += 4;
			len += professorSkills[i].getNeedExp().length * 4;
			len += 4;
		...
		for(int i = 0 ; i < nuqiSkills.length ; i++){
		 ...
		 e.printStackTrace();
			...
			len += 4;
			len += nuqiSkills[i].getNeedExp().length * 4;
			len += 4;
		...
		for(int i = 0 ; i < xinfaSkills.length ; i++){
		 ...
		 e.printStackTrace();
			...
			len += 4;
			len += xinfaSkills[i].getNeedExp().length * 4;
			len += 4;
		...
		for(int i = 0 ; i < kingSkills.length ; i++){
		 ...
		 e.printStackTrace();
			...
			len += 4;
			len += kingSkills[i].getNeedExp().length * 4;
			len += 4;
		...
		try{
			...
			for(int i = 0 ; i < basicSkills.length ; i++){
			 ...
			 e.printStackTrace();
				...
				buffer.putInt(basicSkills[i].getNeedExp().length);
				int[] needExp_0030 = basicSkills[i].getNeedExp();
				for(int j = 0 ; j < needExp_0030.length ; j++){
					buffer.putInt(needExp_0030[j]);
				}
			...
			for(int i = 0 ; i < professorSkills.length ; i++){
			 ...
			 e.printStackTrace();
				...
				buffer.putInt(professorSkills[i].getNeedExp().length);
				int[] needExp_0035 = professorSkills[i].getNeedExp();
				for(int j = 0 ; j < needExp_0035.length ; j++){
					buffer.putInt(needExp_0035[j]);
				}
			...
			for(int i = 0 ; i < nuqiSkills.length ; i++){
			 ...
			 e.printStackTrace();
				...
				buffer.putInt(nuqiSkills[i].getNeedExp().length);
				int[] needExp_0040 = nuqiSkills[i].getNeedExp();
				for(int j = 0 ; j < needExp_0040.length ; j++){
					buffer.putInt(needExp_0040[j]);
				}
			...
			for(int i = 0 ; i < xinfaSkills.length ; i++){
			 ...
			 e.printStackTrace();
				...
				buffer.putInt(xinfaSkills[i].getNeedExp().length);
				int[] needExp_0045 = xinfaSkills[i].getNeedExp();
				for(int j = 0 ; j < needExp_0045.length ; j++){
					buffer.putInt(needExp_0045[j]);
				}
			...
			for(int i = 0 ; i < kingSkills.length ; i++){
			 ...
			 e.printStackTrace();
				...
				buffer.putInt(kingSkills[i].getNeedExp().length);
				int[] needExp_0050 = kingSkills[i].getNeedExp();
				for(int j = 0 ; j < needExp_0050.length ; j++){
					buffer.putInt(needExp_0050[j]);
				}
