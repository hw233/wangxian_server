 ...
 * </table>
 */
public class ENCHANT_LOCK_RES implements ResponseMessage{
	...
	public ENCHANT_LOCK_RES(){
	}

	public ENCHANT_LOCK_RES(long seqNum,int result,long articleId){
		this.seqNum = seqNum;
		this.result = result;
		this.articleId = articleId;
	}

	public ENCHANT_LOCK_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
