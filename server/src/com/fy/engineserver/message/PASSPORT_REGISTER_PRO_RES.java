 ...
 * </table>
 */
public class PASSPORT_REGISTER_PRO_RES implements ResponseMessage{
	...
	public PASSPORT_REGISTER_PRO_RES(){
	}

	public PASSPORT_REGISTER_PRO_RES(long seqNum,long id,String result,String loginUsername,String recUserServer,String recUserUsername,String recUserPlayername,byte recUserPolcamp,String[] others){
		this.seqNum = seqNum;
		this.id = id;
		this.result = result;
	...
	public PASSPORT_REGISTER_PRO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PASSPORT_REGISTER_PRO_RES";
	}
