 ...
 * </table>
 */
public class FAIRY_VOTE_RES implements ResponseMessage{
	...
	public FAIRY_VOTE_RES(){
	}

	public FAIRY_VOTE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public FAIRY_VOTE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
