 ...
 * </table>
 */
public class REQUESTBUY_SALE_RES implements ResponseMessage{
	...
	public REQUESTBUY_SALE_RES(){
	}

	public REQUESTBUY_SALE_RES(long seqNum,int num,long money){
		this.seqNum = seqNum;
		this.num = num;
		this.money = money;
	}

	public REQUESTBUY_SALE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
