 ...
 * </table>
 */
public class NEWIANCENGTA_FLUSH_REQ implements RequestMessage{
	...
	public NEWIANCENGTA_FLUSH_REQ(){
	}

	public NEWIANCENGTA_FLUSH_REQ(long seqNum,long playerId,int nanduType,int daoIndex){
		this.seqNum = seqNum;
	...
	public NEWIANCENGTA_FLUSH_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
