 ...
 * </table>
 */
public class QUERY_HORSE_DATA_REQ implements RequestMessage{
	...
	public QUERY_HORSE_DATA_REQ(){
	}

	public QUERY_HORSE_DATA_REQ(long seqNum,long playerId,long horseId){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.horseId = horseId;
	}

	public QUERY_HORSE_DATA_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
