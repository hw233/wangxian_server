 ...
 * </table>
 */
public class PET2_QUERY_BY_ARTICLE_REQ implements RequestMessage{
	...
	public PET2_QUERY_BY_ARTICLE_REQ(){
	}

	public PET2_QUERY_BY_ARTICLE_REQ(long seqNum,long petEntityId,boolean isOwner){
		this.seqNum = seqNum;
		this.petEntityId = petEntityId;
		this.isOwner = isOwner;
	}

	public PET2_QUERY_BY_ARTICLE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PET2_QUERY_BY_ARTICLE_REQ";
	}
