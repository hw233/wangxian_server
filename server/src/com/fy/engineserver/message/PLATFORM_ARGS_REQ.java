 ...
 * </table>
 */
public class PLATFORM_ARGS_REQ implements RequestMessage{
	...
	public PLATFORM_ARGS_REQ(){
	}

	public PLATFORM_ARGS_REQ(long seqNum,String userType){
		this.seqNum = seqNum;
		this.userType = userType;
	}

	public PLATFORM_ARGS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
