 ...
 * </table>
 */
public class QIANCENGTA_FLUSH_REQ implements RequestMessage{
	...
	public QIANCENGTA_FLUSH_REQ(){
	}

	public QIANCENGTA_FLUSH_REQ(long seqNum,long playerId,int daoIndex){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.daoIndex = daoIndex;
	}

	public QIANCENGTA_FLUSH_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
