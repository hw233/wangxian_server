 ...
 * </table>
 */
public class CLIFFORD_START_REQ implements RequestMessage{
	...
	public CLIFFORD_START_REQ(){
	}

	public CLIFFORD_START_REQ(long seqNum,byte cliffordType){
		this.seqNum = seqNum;
		this.cliffordType = cliffordType;
	}

	public CLIFFORD_START_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
