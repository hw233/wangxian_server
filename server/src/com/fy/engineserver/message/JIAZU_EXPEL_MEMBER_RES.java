 ...
 * </table>
 */
public class JIAZU_EXPEL_MEMBER_RES implements ResponseMessage{
	...
	public JIAZU_EXPEL_MEMBER_RES(){
	}

	public JIAZU_EXPEL_MEMBER_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public JIAZU_EXPEL_MEMBER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
