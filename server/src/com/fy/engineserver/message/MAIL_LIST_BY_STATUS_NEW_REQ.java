 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>mailType</td><td>byte</td><td>1个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class MAIL_LIST_BY_STATUS_NEW_REQ implements RequestMessage{
	...
	public MAIL_LIST_BY_STATUS_NEW_REQ(){
	}

	public MAIL_LIST_BY_STATUS_NEW_REQ(long seqNum,int mailBaseType,byte mailType,int pageIndex,int pageNum){
		this.seqNum = seqNum;
	...
	public MAIL_LIST_BY_STATUS_NEW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		mailBaseType = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
		mailType = (byte)mf.byteArrayToNumber(content,offset,1);
		offset += 1;
	...
	public String getTypeDescription() {
		return "MAIL_LIST_BY_STATUS_NEW_REQ";
	}
