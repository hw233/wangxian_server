 ...
 * </table>
 */
public class DENY_USER_RES implements ResponseMessage{
	...
	public DENY_USER_RES(){
	}

	public DENY_USER_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public DENY_USER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
