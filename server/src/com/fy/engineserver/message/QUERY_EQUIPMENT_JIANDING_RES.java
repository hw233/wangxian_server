 ...
 * </table>
 */
public class QUERY_EQUIPMENT_JIANDING_RES implements ResponseMessage{
	...
	public QUERY_EQUIPMENT_JIANDING_RES(){
	}

	public QUERY_EQUIPMENT_JIANDING_RES(long seqNum,String descript,String[] materials){
		this.seqNum = seqNum;
		this.descript = descript;
		this.materials = materials;
	}

	public QUERY_EQUIPMENT_JIANDING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_EQUIPMENT_JIANDING_RES";
	}
