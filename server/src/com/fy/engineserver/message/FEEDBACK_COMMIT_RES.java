 ...
 * </table>
 */
public class FEEDBACK_COMMIT_RES implements ResponseMessage{
	...
	public FEEDBACK_COMMIT_RES(){
	}

	public FEEDBACK_COMMIT_RES(long seqNum,long id,byte result,String resultMess){
		this.seqNum = seqNum;
		this.id = id;
		this.result = result;
	...
	public FEEDBACK_COMMIT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
