 ...
 * </table>
 */
public class CACHE_PLAYER_COUNT_USERNAME_REQ implements RequestMessage{
	...
	public CACHE_PLAYER_COUNT_USERNAME_REQ(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public CACHE_PLAYER_COUNT_USERNAME_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CACHE_PLAYER_COUNT_USERNAME_REQ";
	}
