 ...
 * </table>
 */
public class FEEDBACK_HOME_PAGE_REQ implements RequestMessage{
	...
	public FEEDBACK_HOME_PAGE_REQ(){
	}

	public FEEDBACK_HOME_PAGE_REQ(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public FEEDBACK_HOME_PAGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
