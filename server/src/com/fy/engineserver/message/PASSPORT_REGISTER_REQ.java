...
public class PASSPORT_REGISTER_REQ implements RequestMessage{
	...
	public PASSPORT_REGISTER_REQ(long seqNum,String username,String passwd,String usertype,boolean quickreg,String clientId,String whitecontent,String handset,String platform,String channel,long recommendid){
		this.seqNum = seqNum;
