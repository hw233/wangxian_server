 ...
 * </table>
 */
public class MAIL_LIST_CARRY_REQ implements RequestMessage{
	...
	public MAIL_LIST_CARRY_REQ(){
	}

	public MAIL_LIST_CARRY_REQ(long seqNum,int pageIndex,int pageNum){
		this.seqNum = seqNum;
		this.pageIndex = pageIndex;
		this.pageNum = pageNum;
	}

	public MAIL_LIST_CARRY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
