 ...
 * </table>
 */
public class FEED_HORSE_REQ implements RequestMessage{
	...
	public FEED_HORSE_REQ(){
	}

	public FEED_HORSE_REQ(long seqNum,long horseId,long entityId){
		this.seqNum = seqNum;
		this.horseId = horseId;
		this.entityId = entityId;
	}

	public FEED_HORSE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
