 ...
 * </table>
 */
public class CACHE_GOODS_LIST_RES implements ResponseMessage{
	...
	public CACHE_GOODS_LIST_RES(long seqNum,int[] idlist,String result){
		this.seqNum = seqNum;
		this.idlist = idlist;
		this.result = result;
	}

	public CACHE_GOODS_LIST_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
