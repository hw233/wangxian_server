 ...
 * </table>
 */
public class PET_MATING_TAKEBACK_RES implements ResponseMessage{
	...
	public PET_MATING_TAKEBACK_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public PET_MATING_TAKEBACK_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "PET_MATING_TAKEBACK_RES";
	}
