 ...
 * </table>
 */
public class CACHE_PROPSENTITY_UPDATE_REQ implements RequestMessage{
	...
	public CACHE_PROPSENTITY_UPDATE_REQ(long seqNum,long id,String showName,long inValidTime,boolean taskArticle,boolean binded,int leftUsingTimes,boolean abandoned,String propertyString){
		this.seqNum = seqNum;
		this.id = id;
	...
	public CACHE_PROPSENTITY_UPDATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "CACHE_PROPSENTITY_UPDATE_REQ";
	}
