 ...
 * </table>
 */
public class QUERY_SERVER_LIST_REQ implements RequestMessage{
	...
	public QUERY_SERVER_LIST_REQ(){
	}

	public QUERY_SERVER_LIST_REQ(long seqNum,String clientId,String username,String password,String authCode){
		this.seqNum = seqNum;
	...
	public QUERY_SERVER_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
