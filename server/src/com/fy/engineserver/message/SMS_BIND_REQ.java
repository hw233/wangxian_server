 ...
 * </table>
 */
public class SMS_BIND_REQ implements RequestMessage{
	...
	public SMS_BIND_REQ(long seqNum,byte mode,String username,String passwd){
		this.seqNum = seqNum;
		this.mode = mode;
	...
	public SMS_BIND_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
