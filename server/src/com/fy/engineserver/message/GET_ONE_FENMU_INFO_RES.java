 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>fenmuId</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>lineWeigth</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>lineHeigth</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class GET_ONE_FENMU_INFO_RES implements ResponseMessage{
	...
	public GET_ONE_FENMU_INFO_RES(){
	}

	public GET_ONE_FENMU_INFO_RES(long seqNum,String fenmuName,int fenmuId,int lineWeigth,int lineHeigth,int[] chanziType,String description,FenDiModel4Client[] fendiModel){
		this.seqNum = seqNum;
		this.fenmuName = fenmuName;
		this.fenmuId = fenmuId;
	...
	public GET_ONE_FENMU_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		offset += len;
		fenmuId = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
	 ...
	 *	坟墓id
	 */
	public void setFenmuId(int fenmuId){
		this.fenmuId = fenmuId;
	}
