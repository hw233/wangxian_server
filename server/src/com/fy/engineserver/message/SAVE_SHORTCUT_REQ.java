 ...
 * </table>
 */
public class SAVE_SHORTCUT_REQ implements RequestMessage{
	...
	public SAVE_SHORTCUT_REQ(){
	}

	public SAVE_SHORTCUT_REQ(long seqNum,byte[] shortcutData){
		this.seqNum = seqNum;
		this.shortcutData = shortcutData;
	}

	public SAVE_SHORTCUT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
