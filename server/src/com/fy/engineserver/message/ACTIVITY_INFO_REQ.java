 ...
 * </table>
 */
public class ACTIVITY_INFO_REQ implements RequestMessage{
	...
	public ACTIVITY_INFO_REQ(){
	}

	public ACTIVITY_INFO_REQ(long seqNum,String activityName){
		this.seqNum = seqNum;
		this.activityName = activityName;
	}

	public ACTIVITY_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
