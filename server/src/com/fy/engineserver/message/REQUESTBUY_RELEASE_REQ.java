 ...
 * </table>
 */
public class REQUESTBUY_RELEASE_REQ implements RequestMessage{
	...
	public REQUESTBUY_RELEASE_REQ(){
	}

	public REQUESTBUY_RELEASE_REQ(long seqNum,String mainType,String subType,String articleName,int color,int num,long perPrice){
		this.seqNum = seqNum;
	...
	public REQUESTBUY_RELEASE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
