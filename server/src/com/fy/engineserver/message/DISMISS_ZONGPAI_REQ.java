 ...
 * </table>
 */
public class DISMISS_ZONGPAI_REQ implements RequestMessage{
	...
	public DISMISS_ZONGPAI_REQ(){
	}

	public DISMISS_ZONGPAI_REQ(long seqNum,String password){
		this.seqNum = seqNum;
		this.password = password;
	}

	public DISMISS_ZONGPAI_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
