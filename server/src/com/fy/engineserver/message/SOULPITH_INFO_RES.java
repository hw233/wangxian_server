 ...
 * </table>
 */
public class SOULPITH_INFO_RES implements ResponseMessage{
	...
	public SOULPITH_INFO_RES(){
	}

	public SOULPITH_INFO_RES(long seqNum,int soultype,SoulpithInfo4Client datas){
		this.seqNum = seqNum;
		this.soultype = soultype;
		this.datas = datas;
	}

	public SOULPITH_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
