 ...
 * </table>
 */
public class QUERY_CMCC_USER_LOGIN_REQ implements RequestMessage{
	...
	public QUERY_CMCC_USER_LOGIN_REQ(long seqNum,String clientId,String username,String passwd,String userId,String key){
		this.seqNum = seqNum;
	...
	public QUERY_CMCC_USER_LOGIN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_CMCC_USER_LOGIN_REQ";
	}
