 ...
 * 版本号：null<br>
 * 国家表彰玩家，客户端发表彰协议给服务器，服务器传回表彰后的结果<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class COUNTRY_COMMEND_OR_CANCEL_REQ implements RequestMessage{
	...
	public COUNTRY_COMMEND_OR_CANCEL_REQ(){
	}

	public COUNTRY_COMMEND_OR_CANCEL_REQ(long seqNum,byte selectType,String playerName){
		this.seqNum = seqNum;
		this.selectType = selectType;
		this.playerName = playerName;
	}

	public COUNTRY_COMMEND_OR_CANCEL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "COUNTRY_COMMEND_OR_CANCEL_REQ";
	}
