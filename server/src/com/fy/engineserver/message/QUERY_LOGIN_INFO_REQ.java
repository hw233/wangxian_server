 ...
 * </table>
 */
public class QUERY_LOGIN_INFO_REQ implements RequestMessage{
	...
	public QUERY_LOGIN_INFO_REQ(){
	}

	public QUERY_LOGIN_INFO_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public QUERY_LOGIN_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
