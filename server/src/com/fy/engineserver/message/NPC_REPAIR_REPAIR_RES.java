 ...
 * </table>
 */
public class NPC_REPAIR_REPAIR_RES implements ResponseMessage{
	...
	public NPC_REPAIR_REPAIR_RES(){
	}

	public NPC_REPAIR_REPAIR_RES(long seqNum,byte result,byte repairType,long equipmentId,int money){
		this.seqNum = seqNum;
		this.result = result;
	...
	public NPC_REPAIR_REPAIR_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
