 ...
 * </table>
 */
public class NEW_RECOMMEND_REQ implements RequestMessage{
	...
	public NEW_RECOMMEND_REQ(){
	}

	public NEW_RECOMMEND_REQ(long seqNum,String friendMobile,String friendName){
		this.seqNum = seqNum;
		this.friendMobile = friendMobile;
		this.friendName = friendName;
	}

	public NEW_RECOMMEND_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
