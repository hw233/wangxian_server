 ...
 * </table>
 */
public class EQUIPMENT_JIANDING_REQ implements RequestMessage{
	...
	public EQUIPMENT_JIANDING_REQ(){
	}

	public EQUIPMENT_JIANDING_REQ(long seqNum,long equipmentId,long materialId){
		this.seqNum = seqNum;
		this.equipmentId = equipmentId;
		this.materialId = materialId;
	}

	public EQUIPMENT_JIANDING_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
