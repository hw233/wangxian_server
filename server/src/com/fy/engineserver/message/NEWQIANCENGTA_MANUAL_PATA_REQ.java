 ...
 * </table>
 */
public class NEWQIANCENGTA_MANUAL_PATA_REQ implements RequestMessage{
	...
	public NEWQIANCENGTA_MANUAL_PATA_REQ(){
	}

	public NEWQIANCENGTA_MANUAL_PATA_REQ(long seqNum,long playerId,int nanduType,int daoIndex,int cengIndex){
		this.seqNum = seqNum;
	...
	public NEWQIANCENGTA_MANUAL_PATA_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEWQIANCENGTA_MANUAL_PATA_REQ";
	}
