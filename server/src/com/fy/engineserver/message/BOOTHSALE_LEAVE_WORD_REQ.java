 ...
 * </table>
 */
public class BOOTHSALE_LEAVE_WORD_REQ implements RequestMessage{
	...
	public BOOTHSALE_LEAVE_WORD_REQ(){
	}

	public BOOTHSALE_LEAVE_WORD_REQ(long seqNum,long saler,String message){
		this.seqNum = seqNum;
		this.saler = saler;
		this.message = message;
	}

	public BOOTHSALE_LEAVE_WORD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "BOOTHSALE_LEAVE_WORD_REQ";
	}
