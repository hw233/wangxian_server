 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList.length</td><td>int</td><td>4个字节</td><td>Horse数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].horseId</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].horseLevel</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].rank</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].horseName.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].horseName</td><td>String</td><td>horseList[0].horseName.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].avata.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].avata</td><td>String</td><td>horseList[0].avata.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].icon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].icon</td><td>String</td><td>horseList[0].icon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].equipmentIds.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].equipmentIds</td><td>long[]</td><td>horseList[0].equipmentIds.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].maxEnergy</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].energy</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].lastEnergyIndex</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].fireAttack</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[0].fireDefence</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[0].thunderAttack</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].horseId</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].horseLevel</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].rank</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].horseName.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].horseName</td><td>String</td><td>horseList[1].horseName.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].avata.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].avata</td><td>String</td><td>horseList[1].avata.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].icon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].icon</td><td>String</td><td>horseList[1].icon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].equipmentIds.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].equipmentIds</td><td>long[]</td><td>horseList[1].equipmentIds.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].maxEnergy</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].energy</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].lastEnergyIndex</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].fireAttack</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[1].fireDefence</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[1].thunderAttack</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].horseId</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].horseLevel</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].rank</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].horseName.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].horseName</td><td>String</td><td>horseList[2].horseName.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].avata.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].avata</td><td>String</td><td>horseList[2].avata.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].icon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].icon</td><td>String</td><td>horseList[2].icon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].equipmentIds.length</td><td>int</td><td>4个字节</td><td>对象属性为数组，数组的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].equipmentIds</td><td>long[]</td><td>horseList[2].equipmentIds.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].maxEnergy</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].energy</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].lastEnergyIndex</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].fireAttack</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>horseList[2].fireDefence</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>horseList[2].thunderAttack</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td colspan=4>......... 重复</td></tr>
 * </table>
 */
public class QUERY_HORSE_LIST_RES implements ResponseMessage{
	...
	public QUERY_HORSE_LIST_RES(){
	}

	public QUERY_HORSE_LIST_RES(long seqNum,Horse[] horseList){
		this.seqNum = seqNum;
		this.horseList = horseList;
	}

	public QUERY_HORSE_LIST_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		for(int i = 0 ; i < horseList.length ; i++){
			...
			horseList[i].setHorseName(new String(content,offset,len,"UTF-8"));
			offset += len;
			len = (int)mf.byteArrayToNumber(content,offset,2);
			offset += 2;
			if(len < 0 || len > 16384) throw new Exception("string length ["+len+"] big than the max length [16384]");
	...
	public int getLength() {
		...
		for(int i = 0 ; i < horseList.length ; i++){
			...
			len += 4;
			len += 2;
			if(horseList[i].getHorseName() != null){
				try{
				len += horseList[i].getHorseName().getBytes("UTF-8").length;
	...
	public int writeTo(ByteBuffer buffer) {
		...
		try{
			...
			for(int i = 0 ; i < horseList.length ; i++){
				...
				byte[] tmpBytes2 ;
				try{
				tmpBytes2 = horseList[i].getHorseName().getBytes("UTF-8");
				}catch(java.io.UnsupportedEncodingException e){
			 e.printStackTrace();
					throw new RuntimeException("unsupported encoding [UTF-8]",e);
				}
