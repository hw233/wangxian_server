 ...
 * </table>
 */
public class QILING_OUTLAY_REQ implements RequestMessage{
	...
	public QILING_OUTLAY_REQ(){
	}

	public QILING_OUTLAY_REQ(long seqNum,long equipmentId,int holeIndex){
		this.seqNum = seqNum;
		this.equipmentId = equipmentId;
		this.holeIndex = holeIndex;
	}

	public QILING_OUTLAY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
