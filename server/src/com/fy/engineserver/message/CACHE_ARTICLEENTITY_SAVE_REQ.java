 ...
 * </table>
 */
public class CACHE_ARTICLEENTITY_SAVE_REQ implements RequestMessage{
	...
	public CACHE_ARTICLEENTITY_SAVE_REQ(long seqNum,long id,String articleName,String showName,long inValidTime,boolean taskArticle,boolean binded,boolean abandoned,String propertyString){
		this.seqNum = seqNum;
		this.id = id;
	...
	public CACHE_ARTICLEENTITY_SAVE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "CACHE_ARTICLEENTITY_SAVE_REQ";
	}
