 ...
 * </table>
 */
public class MAGICWEAPON_BREAK_REQ implements RequestMessage{
	...
	public MAGICWEAPON_BREAK_REQ(){
	}

	public MAGICWEAPON_BREAK_REQ(long seqNum,long magicweaponId){
		this.seqNum = seqNum;
		this.magicweaponId = magicweaponId;
	}

	public MAGICWEAPON_BREAK_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
