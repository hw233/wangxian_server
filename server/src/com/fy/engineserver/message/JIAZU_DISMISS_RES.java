 ...
 * </table>
 */
public class JIAZU_DISMISS_RES implements ResponseMessage{
	...
	public JIAZU_DISMISS_RES(){
	}

	public JIAZU_DISMISS_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public JIAZU_DISMISS_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
