 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>player_relationInfo[1].relationShip</td><td>byte</td><td>1个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>player_relationInfo[1].isonline</td><td>boolean</td><td>1个字节</td><td>布尔型长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>player_relationInfo[1].mood.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>player_relationInfo[1].mood</td><td>String</td><td>player_relationInfo[1].mood.length</td><td>字符串对应的byte数组</td></tr>
 ...
 * </table>
 */
public class GET_TYPEPLAYER_RES implements ResponseMessage{
	...
	public GET_TYPEPLAYER_RES(){
	}

	public GET_TYPEPLAYER_RES(long seqNum,int playerSum,int playerOnline,int pageNum,int page,byte ptype,Player_RelatinInfo[] player_relationInfo){
		this.seqNum = seqNum;
	...
	public GET_TYPEPLAYER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
