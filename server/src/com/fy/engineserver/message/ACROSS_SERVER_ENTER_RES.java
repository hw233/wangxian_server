 ...
 * </table>
 */
public class ACROSS_SERVER_ENTER_RES implements ResponseMessage{
	...
	public ACROSS_SERVER_ENTER_RES(){
	}

	public ACROSS_SERVER_ENTER_RES(long seqNum,Player[] players){
		this.seqNum = seqNum;
		this.players = players;
	}

	public ACROSS_SERVER_ENTER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "ACROSS_SERVER_ENTER_RES";
	}
