 ...
 * </table>
 */
public class BOOTHSALE_CANCEL_BOOTHSALE_RES implements ResponseMessage{
	...
	public BOOTHSALE_CANCEL_BOOTHSALE_RES(){
	}

	public BOOTHSALE_CANCEL_BOOTHSALE_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public BOOTHSALE_CANCEL_BOOTHSALE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "BOOTHSALE_CANCEL_BOOTHSALE_RES";
	}
