 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>petList[0].progName.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>petList[0].progName</td><td>String</td><td>petList[0].progName.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>petList[0].icon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>petList[0].icon</td><td>String</td><td>petList[0].icon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>petList[1].name.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>petList[1].name</td><td>String</td><td>petList[1].name.length</td><td>字符串对应的byte数组</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>petList[2].progName.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>petList[2].progName</td><td>String</td><td>petList[2].progName.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>petList[2].icon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>petList[2].icon</td><td>String</td><td>petList[2].icon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td colspan=4>......... 重复</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>scaleArr.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>scaleArr</td><td>int[]</td><td>scaleArr.length</td><td>*</td></tr>
 * </table>
 */
public class PET_LIST_RES implements ResponseMessage{
	...
	public PET_LIST_RES(long seqNum,String havePets,GradePet[] petList,int[] scaleArr){
		this.seqNum = seqNum;
	...
	public PET_LIST_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
