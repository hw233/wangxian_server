 ...
 * </table>
 */
public class DEFAULT_GET_CHARGEORDER_RES implements ResponseMessage{
	...
	public DEFAULT_GET_CHARGEORDER_RES(){
	}

	public DEFAULT_GET_CHARGEORDER_RES(long seqNum,int result,long denomination,String chargeOrder){
		this.seqNum = seqNum;
		this.result = result;
	...
	public DEFAULT_GET_CHARGEORDER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "DEFAULT_GET_CHARGEORDER_RES";
	}
