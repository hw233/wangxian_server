 ...
 * </table>
 */
public class QUERY_ARTICLE_INFO_RES implements ResponseMessage{
	...
	public QUERY_ARTICLE_INFO_RES(){
	}

	public QUERY_ARTICLE_INFO_RES(long seqNum,long articleId,String description){
		this.seqNum = seqNum;
		this.articleId = articleId;
		this.description = description;
	}

	public QUERY_ARTICLE_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
