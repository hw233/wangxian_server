 ...
 * </table>
 */
public class COUNTRY_JIECHU_QIUJIN_REQ implements RequestMessage{
	...
	public COUNTRY_JIECHU_QIUJIN_REQ(){
	}

	public COUNTRY_JIECHU_QIUJIN_REQ(long seqNum,String playerName){
		this.seqNum = seqNum;
		this.playerName = playerName;
	}

	public COUNTRY_JIECHU_QIUJIN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "COUNTRY_JIECHU_QIUJIN_REQ";
	}
