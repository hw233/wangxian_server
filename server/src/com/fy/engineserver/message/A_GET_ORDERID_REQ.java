 ...
 * </table>
 */
public class A_GET_ORDERID_REQ implements RequestMessage{
	...
	public A_GET_ORDERID_REQ(){
	}

	public A_GET_ORDERID_REQ(long seqNum,String channel,long pAmount){
		this.seqNum = seqNum;
		this.channel = channel;
		this.pAmount = pAmount;
	}

	public A_GET_ORDERID_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
