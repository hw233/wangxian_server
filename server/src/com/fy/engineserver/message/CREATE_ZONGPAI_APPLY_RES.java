 ...
 * </table>
 */
public class CREATE_ZONGPAI_APPLY_RES implements ResponseMessage{
	...
	public CREATE_ZONGPAI_APPLY_RES(){
	}

	public CREATE_ZONGPAI_APPLY_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public CREATE_ZONGPAI_APPLY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CREATE_ZONGPAI_APPLY_RES";
	}
