 ...
 * </table>
 */
public class PET2_QUERY_RES implements ResponseMessage{
	...
	public PET2_QUERY_RES(){
	}

	public PET2_QUERY_RES(long seqNum,Pet pet,SkillInfo[] skillInfos,PetSkillReleaseProbability[] petSkillReleaseProbability,String[] description,SkillInfo[] bornSkills,SkillInfo[] talentSkills,int grade,int wuXing,int addBooks,int rankIndex,int hunExp,int toNextHunExp,int[] jinJieAtt){
		this.seqNum = seqNum;
		this.pet = pet;
	...
	public PET2_QUERY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		pet = new Pet();
