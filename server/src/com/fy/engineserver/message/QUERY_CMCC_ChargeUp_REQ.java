 ...
 * </table>
 */
public class QUERY_CMCC_ChargeUp_REQ implements RequestMessage{
	...
	public QUERY_CMCC_ChargeUp_REQ(long seqNum,String userId,String key,int amount,String username){
		this.seqNum = seqNum;
		this.userId = userId;
		this.key = key;
		this.amount = amount;
	...
	public QUERY_CMCC_ChargeUp_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_CMCC_ChargeUp_REQ";
	}
