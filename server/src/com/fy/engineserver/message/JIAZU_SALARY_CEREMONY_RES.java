 ...
 * </table>
 */
public class JIAZU_SALARY_CEREMONY_RES implements ResponseMessage{
	...
	public JIAZU_SALARY_CEREMONY_RES(){
	}

	public JIAZU_SALARY_CEREMONY_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public JIAZU_SALARY_CEREMONY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "JIAZU_SALARY_CEREMONY_RES";
	}
