 ...
 * </table>
 */
public class CREATE_GROUP_RES implements ResponseMessage{
	...
	public CREATE_GROUP_RES(){
	}

	public CREATE_GROUP_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public CREATE_GROUP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
