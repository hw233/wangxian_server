 ...
 * </table>
 */
public class PET_CLEAR_PROP_CD_RES implements ResponseMessage{
	...
	public PET_CLEAR_PROP_CD_RES(){
	}

	public PET_CLEAR_PROP_CD_RES(long seqNum,long petId,int result){
		this.seqNum = seqNum;
		this.petId = petId;
		this.result = result;
	}

	public PET_CLEAR_PROP_CD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
