 ...
 * </table>
 */
public class NEWQIANCENGTA_GET_FIRST_REWARD_RES implements ResponseMessage{
	...
	public NEWQIANCENGTA_GET_FIRST_REWARD_RES(){
	}

	public NEWQIANCENGTA_GET_FIRST_REWARD_RES(long seqNum,int result,String resultString){
		this.seqNum = seqNum;
		this.result = result;
		this.resultString = resultString;
	}

	public NEWQIANCENGTA_GET_FIRST_REWARD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEWQIANCENGTA_GET_FIRST_REWARD_RES";
	}
