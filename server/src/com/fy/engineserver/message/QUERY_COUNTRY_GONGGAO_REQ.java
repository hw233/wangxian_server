 ...
 * </table>
 */
public class QUERY_COUNTRY_GONGGAO_REQ implements RequestMessage{
	...
	public QUERY_COUNTRY_GONGGAO_REQ(){
	}

	public QUERY_COUNTRY_GONGGAO_REQ(long seqNum,String notice){
		this.seqNum = seqNum;
		this.notice = notice;
	}

	public QUERY_COUNTRY_GONGGAO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_COUNTRY_GONGGAO_REQ";
	}
