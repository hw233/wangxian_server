 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>playerCareer</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>playerRMB</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>playerVip</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>action</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class NEW_MIESHI_UPDATE_PLAYER_INFO implements RequestMessage{
	...
	public NEW_MIESHI_UPDATE_PLAYER_INFO(){
	}

	public NEW_MIESHI_UPDATE_PLAYER_INFO(long seqNum,String serverName,String userName,long playerId,String playerName,int playerLevel,int playerCareer,int playerRMB,int playerVip,int action){
		this.seqNum = seqNum;
	...
	public NEW_MIESHI_UPDATE_PLAYER_INFO(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		offset += 4;
		playerRMB = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
		playerVip = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
	...
	public String getTypeDescription() {
		return "NEW_MIESHI_UPDATE_PLAYER_INFO";
	}
	...
	public int writeTo(ByteBuffer buffer) {
		...
		try{
			...
			buffer.putInt(playerRMB);
			buffer.putInt(playerVip);
