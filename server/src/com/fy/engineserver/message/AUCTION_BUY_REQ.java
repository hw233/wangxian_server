 ...
 * </table>
 */
public class AUCTION_BUY_REQ implements RequestMessage{
	...
	public AUCTION_BUY_REQ(){
	}

	public AUCTION_BUY_REQ(long seqNum,long id,long price){
		this.seqNum = seqNum;
		this.id = id;
		this.price = price;
	}

	public AUCTION_BUY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
