 ...
 * </table>
 */
public class RSA_DATA_REQ implements RequestMessage{
	...
	public RSA_DATA_REQ(long seqNum,String clientID,String clientVersion,String platform,String realPlatform,String GPU,String otherGPU,byte[] rsa_data){
		this.seqNum = seqNum;
	...
	public RSA_DATA_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
