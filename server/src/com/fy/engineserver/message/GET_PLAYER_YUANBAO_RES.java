 ...
 * 版本号：null<br>
 * 获得玩家的元宝数量，由两部分组成，一部分是角色身上的，一部分在账户上，其中账户上的元宝是多个角色间共享的<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class GET_PLAYER_YUANBAO_RES implements ResponseMessage{
	...
	public GET_PLAYER_YUANBAO_RES(){
	}

	public GET_PLAYER_YUANBAO_RES(long seqNum,long playerAmount,long userAmount){
		this.seqNum = seqNum;
		this.playerAmount = playerAmount;
		this.userAmount = userAmount;
	}

	public GET_PLAYER_YUANBAO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
