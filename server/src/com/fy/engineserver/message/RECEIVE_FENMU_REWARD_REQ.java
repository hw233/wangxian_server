 ...
 * </table>
 */
public class RECEIVE_FENMU_REWARD_REQ implements RequestMessage{
	...
	public RECEIVE_FENMU_REWARD_REQ(){
	}

	public RECEIVE_FENMU_REWARD_REQ(long seqNum,String fenmuName){
		this.seqNum = seqNum;
		this.fenmuName = fenmuName;
	}

	public RECEIVE_FENMU_REWARD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "RECEIVE_FENMU_REWARD_REQ";
	}
