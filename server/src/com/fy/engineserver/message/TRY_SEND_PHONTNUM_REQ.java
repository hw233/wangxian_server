 ...
 * </table>
 */
public class TRY_SEND_PHONTNUM_REQ implements RequestMessage{
	...
	public TRY_SEND_PHONTNUM_REQ(){
	}

	public TRY_SEND_PHONTNUM_REQ(long seqNum,String phoneNum){
		this.seqNum = seqNum;
		this.phoneNum = phoneNum;
	}

	public TRY_SEND_PHONTNUM_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
