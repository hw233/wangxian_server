 ...
 * </table>
 */
public class JIU1_GET_CHARGE_ORDER_REQ implements RequestMessage{
	...
	public JIU1_GET_CHARGE_ORDER_REQ(){
	}

	public JIU1_GET_CHARGE_ORDER_REQ(long seqNum,String modeName,String id,String channel,String os){
		this.seqNum = seqNum;
	...
	public JIU1_GET_CHARGE_ORDER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "JIU1_GET_CHARGE_ORDER_REQ";
	}
