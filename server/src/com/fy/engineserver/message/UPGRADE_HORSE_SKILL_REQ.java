 ...
 * </table>
 */
public class UPGRADE_HORSE_SKILL_REQ implements RequestMessage{
	...
	public UPGRADE_HORSE_SKILL_REQ(){
	}

	public UPGRADE_HORSE_SKILL_REQ(long seqNum,long horseId,int skillIndex,int skillId){
		this.seqNum = seqNum;
	...
	public UPGRADE_HORSE_SKILL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "UPGRADE_HORSE_SKILL_REQ";
	}
