 ...
 * </table>
 */
public class GET_RMBREWARD_RES implements ResponseMessage{
	...
	public GET_RMBREWARD_RES(){
	}

	public GET_RMBREWARD_RES(long seqNum,boolean isSuccess,String result){
		this.seqNum = seqNum;
		this.isSuccess = isSuccess;
		this.result = result;
	}

	public GET_RMBREWARD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
