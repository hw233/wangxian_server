 ...
 * </table>
 */
public class TRY_BING_PHONENUM_RES implements ResponseMessage{
	...
	public TRY_BING_PHONENUM_RES(){
	}

	public TRY_BING_PHONENUM_RES(long seqNum,String msg,long jiaoyanTime,int sendSpace,String sendMsg){
		this.seqNum = seqNum;
		this.msg = msg;
	...
	public TRY_BING_PHONENUM_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
