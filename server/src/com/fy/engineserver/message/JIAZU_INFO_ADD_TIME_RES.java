 ...
 * 版本号：null<br>
 * 查询家族信息(2012-7-9 11:33:21新增协议)<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class JIAZU_INFO_ADD_TIME_RES implements ResponseMessage{
	...
	public JIAZU_INFO_ADD_TIME_RES(){
	}

	public JIAZU_INFO_ADD_TIME_RES(long seqNum,long jiazuId,String jiazuName,int level,String slogan,int usedBedge,int constructionConsume,String[] titleAlias,JiazuMember4Client[] jiazuMembers,String[] offLineTime,JiazuBedge[] allBedge,int[] hadBedge,int switchCost,long septStationId,long maintai,int jiazuMoney,long warScore,long prosperity){
		this.seqNum = seqNum;
	...
	public JIAZU_INFO_ADD_TIME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "JIAZU_INFO_ADD_TIME_RES";
	}
