 ...
 * </table>
 */
public class INLAY_SOULPITH_RES implements ResponseMessage{
	...
	public INLAY_SOULPITH_RES(){
	}

	public INLAY_SOULPITH_RES(long seqNum,int soultype,SoulpithInfo4Client datas){
		this.seqNum = seqNum;
		this.soultype = soultype;
		this.datas = datas;
	}

	public INLAY_SOULPITH_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
