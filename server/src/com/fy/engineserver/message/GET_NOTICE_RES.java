 ...
 * </table>
 */
public class GET_NOTICE_RES implements ResponseMessage{
	...
	public GET_NOTICE_RES(){
	}

	public GET_NOTICE_RES(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public GET_NOTICE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
