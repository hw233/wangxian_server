 ...
 * </table>
 */
public class CHANNEL_USER_LOGIN_REQ implements RequestMessage{
	...
	public CHANNEL_USER_LOGIN_REQ(long seqNum,String clientId,String username,String password,String channel){
		this.seqNum = seqNum;
	...
	public CHANNEL_USER_LOGIN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
