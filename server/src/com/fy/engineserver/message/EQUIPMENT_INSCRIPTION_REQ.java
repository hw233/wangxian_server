 ...
 * </table>
 */
public class EQUIPMENT_INSCRIPTION_REQ implements RequestMessage{
	...
	public EQUIPMENT_INSCRIPTION_REQ(){
	}

	public EQUIPMENT_INSCRIPTION_REQ(long seqNum,long equipmentId,long materialId){
		this.seqNum = seqNum;
		this.equipmentId = equipmentId;
		this.materialId = materialId;
	}

	public EQUIPMENT_INSCRIPTION_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "EQUIPMENT_INSCRIPTION_REQ";
	}
