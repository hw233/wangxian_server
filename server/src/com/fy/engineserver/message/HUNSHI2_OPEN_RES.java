 ...
 * </table>
 */
public class HUNSHI2_OPEN_RES implements ResponseMessage{
	...
	public HUNSHI2_OPEN_RES(){
	}

	public HUNSHI2_OPEN_RES(long seqNum,String[] kinds){
		this.seqNum = seqNum;
		this.kinds = kinds;
	}

	public HUNSHI2_OPEN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
