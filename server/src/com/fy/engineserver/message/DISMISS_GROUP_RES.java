 ...
 * </table>
 */
public class DISMISS_GROUP_RES implements ResponseMessage{
	...
	public DISMISS_GROUP_RES(){
	}

	public DISMISS_GROUP_RES(long seqNum,String result,long groupId){
		this.seqNum = seqNum;
		this.result = result;
		this.groupId = groupId;
	}

	public DISMISS_GROUP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
