 ...
 * </table>
 */
public class SEND_CITYFIGHT_STATE_REQ implements RequestMessage{
	...
	public SEND_CITYFIGHT_STATE_REQ(){
	}

	public SEND_CITYFIGHT_STATE_REQ(long seqNum,byte state,String description,String sideAName,String sideAIcon,String sideBName,String sideBIcon){
		this.seqNum = seqNum;
		this.state = state;
	...
	public SEND_CITYFIGHT_STATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "SEND_CITYFIGHT_STATE_REQ";
	}
