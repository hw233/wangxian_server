 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[0].littleSellIcon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>goods[0].littleSellIcon</td><td>String</td><td>goods[0].littleSellIcon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[0].jjcLevelLimit</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[1].overNum</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>goods[1].goodEndTime</td><td>long</td><td>8个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[1].serverNumlimit</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>goods[1].playerNumlimit</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[1].goodMaxNumLimit</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>goods[1].littleSellIcon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[1].littleSellIcon</td><td>String</td><td>goods[1].littleSellIcon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>goods[1].jjcLevelLimit</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[2].littleSellIcon.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>goods[2].littleSellIcon</td><td>String</td><td>goods[2].littleSellIcon.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>goods[2].jjcLevelLimit</td><td>int</td><td>4个字节</td><td>对象属性配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td colspan=4>......... 重复</td></tr>
 * </table>
 */
public class GET_NEW_SHOP_RES implements ResponseMessage{
	...
	public GET_NEW_SHOP_RES(){
	}

	public GET_NEW_SHOP_RES(long seqNum,String shopName,boolean isOpen,long starttime,long point,long activity,String[] allShopNames,Goods[] goods){
		this.seqNum = seqNum;
	...
	public GET_NEW_SHOP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		for(int i = 0 ; i < goods.length ; i++){
			...
			goods[i].setLittleSellIcon(new String(content,offset,len,"UTF-8"));
			offset += len;
			goods[i].setJjcLevelLimit((int)mf.byteArrayToNumber(content,offset,4));
			offset += 4;
		}
	}
		...
		try{
			...
			for(int i = 0 ; i < goods.length ; i++){
			 ...
			 e.printStackTrace();
				...
				buffer.putShort((short)tmpBytes2.length);
				buffer.put(tmpBytes2);
				buffer.putInt((int)goods[i].getJjcLevelLimit());
			}
		}catch(Exception e){
		 e.printStackTrace();
			buffer.reset();
