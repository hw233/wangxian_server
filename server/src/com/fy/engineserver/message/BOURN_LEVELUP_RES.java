 ...
 * </table>
 */
public class BOURN_LEVELUP_RES implements ResponseMessage{
	...
	public BOURN_LEVELUP_RES(){
	}

	public BOURN_LEVELUP_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public BOURN_LEVELUP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
