 ...
 * </table>
 */
public class HUNSHI_JIANDING2_SURE_REQ implements RequestMessage{
	...
	public HUNSHI_JIANDING2_SURE_REQ(){
	}

	public HUNSHI_JIANDING2_SURE_REQ(long seqNum,long hunshiId,long materialId){
		this.seqNum = seqNum;
		this.hunshiId = hunshiId;
		this.materialId = materialId;
	}

	public HUNSHI_JIANDING2_SURE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "HUNSHI_JIANDING2_SURE_REQ";
	}
