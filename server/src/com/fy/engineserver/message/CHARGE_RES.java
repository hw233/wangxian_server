 ...
 * </table>
 */
public class CHARGE_RES implements ResponseMessage{
	...
	public CHARGE_RES(long seqNum,String notice){
		this.seqNum = seqNum;
		this.notice = notice;
	}

	public CHARGE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
