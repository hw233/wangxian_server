 ...
 * </table>
 */
public class SEND_CLIENT_EXTENDINFO_REQ implements RequestMessage{
	...
	public SEND_CLIENT_EXTENDINFO_REQ(){
	}

	public SEND_CLIENT_EXTENDINFO_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public SEND_CLIENT_EXTENDINFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "SEND_CLIENT_EXTENDINFO_REQ";
	}
