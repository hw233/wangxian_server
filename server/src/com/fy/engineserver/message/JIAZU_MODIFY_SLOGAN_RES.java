 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>slogan.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>slogan</td><td>String</td><td>slogan.length</td><td>字符串对应的byte数组</td></tr>
 ...
 * </table>
 */
public class JIAZU_MODIFY_SLOGAN_RES implements ResponseMessage{
	...
	public JIAZU_MODIFY_SLOGAN_RES(){
	}

	public JIAZU_MODIFY_SLOGAN_RES(long seqNum,byte result,String slogan,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.slogan = slogan;
	...
	public JIAZU_MODIFY_SLOGAN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "JIAZU_MODIFY_SLOGAN_RES";
	}
