 ...
 * </table>
 */
public class NEWQIANCENGTA_AUTO_PATA_RES implements ResponseMessage{
	...
	public NEWQIANCENGTA_AUTO_PATA_RES(){
	}

	public NEWQIANCENGTA_AUTO_PATA_RES(long seqNum,int nanduType,int action,int result,String resultString){
		this.seqNum = seqNum;
	...
	public NEWQIANCENGTA_AUTO_PATA_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEWQIANCENGTA_AUTO_PATA_RES";
	}
