 ...
 * </table>
 */
public class HORSE_RIDE_RES implements ResponseMessage{
	...
	public HORSE_RIDE_RES(long seqNum,long horseId,boolean ride){
		this.seqNum = seqNum;
		this.horseId = horseId;
		this.ride = ride;
	}

	public HORSE_RIDE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
