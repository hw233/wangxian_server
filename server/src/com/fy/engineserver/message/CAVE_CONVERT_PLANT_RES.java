 ...
 * </table>
 */
public class CAVE_CONVERT_PLANT_RES implements ResponseMessage{
	...
	public CAVE_CONVERT_PLANT_RES(){
	}

	public CAVE_CONVERT_PLANT_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public CAVE_CONVERT_PLANT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
