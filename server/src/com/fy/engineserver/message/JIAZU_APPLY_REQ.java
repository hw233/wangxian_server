 ...
 * </table>
 */
public class JIAZU_APPLY_REQ implements RequestMessage{
	...
	public JIAZU_APPLY_REQ(){
	}

	public JIAZU_APPLY_REQ(long seqNum,String name){
		this.seqNum = seqNum;
		this.name = name;
	}

	public JIAZU_APPLY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
