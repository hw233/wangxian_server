 ...
 * </table>
 */
public class PET_QUERY_RES implements ResponseMessage{
	...
	public PET_QUERY_RES(){
	}

	public PET_QUERY_RES(long seqNum,Pet pet,SkillInfo[] skillInfos,PetSkillReleaseProbability[] petSkillReleaseProbability,String[] description){
		this.seqNum = seqNum;
		this.pet = pet;
	...
	public PET_QUERY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		pet = new Pet();
