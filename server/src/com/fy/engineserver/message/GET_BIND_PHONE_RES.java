 ...
 * </table>
 */
public class GET_BIND_PHONE_RES implements ResponseMessage{
	...
	public GET_BIND_PHONE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public GET_BIND_PHONE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
