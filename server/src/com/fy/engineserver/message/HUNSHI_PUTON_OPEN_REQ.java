 ...
 * </table>
 */
public class HUNSHI_PUTON_OPEN_REQ implements RequestMessage{
	...
	public HUNSHI_PUTON_OPEN_REQ(){
	}

	public HUNSHI_PUTON_OPEN_REQ(long seqNum,long playerId,long horseId){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.horseId = horseId;
	}

	public HUNSHI_PUTON_OPEN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
