 ...
 * </table>
 */
public class MAIL_LIST_NEW_REQ implements RequestMessage{
	...
	public MAIL_LIST_NEW_REQ(){
	}

	public MAIL_LIST_NEW_REQ(long seqNum,int mailBaseType,int pageIndex,int pageNum){
		this.seqNum = seqNum;
	...
	public MAIL_LIST_NEW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
