 ...
 * </table>
 */
public class SESSION_VALIDATE_REQ implements RequestMessage{
	...
	public SESSION_VALIDATE_REQ(){
	}

	public SESSION_VALIDATE_REQ(long seqNum,String servername,String username,String sessionId,String clientId,String channel,String platform,String phoneType,String network,String gpuOtherName,String MACADDRESS){
		this.seqNum = seqNum;
	...
	public SESSION_VALIDATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
