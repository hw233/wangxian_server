 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>casterId</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>targetX</td><td>short</td><td>2个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>targetY</td><td>short</td><td>2个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class PET_NONTARGET_SKILL_BROADCAST_REQ implements RequestMessage{
	...
	public PET_NONTARGET_SKILL_BROADCAST_REQ(){
	}

	public PET_NONTARGET_SKILL_BROADCAST_REQ(long seqNum,long casterId,short targetX,short targetY,int skillId,byte level){
		this.seqNum = seqNum;
	...
	public PET_NONTARGET_SKILL_BROADCAST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PET_NONTARGET_SKILL_BROADCAST_REQ";
	}
