 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>shibaiMsg.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>shibaiMsg</td><td>String</td><td>shibaiMsg.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class QIANCHENGTA_MANUAL_FAIL_RES implements ResponseMessage{
	...
	public QIANCHENGTA_MANUAL_FAIL_RES(){
	}

	public QIANCHENGTA_MANUAL_FAIL_RES(long seqNum,int daoIndex,String daoName,int cengIndex,String shibaiMsg){
		this.seqNum = seqNum;
	...
	public QIANCHENGTA_MANUAL_FAIL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QIANCHENGTA_MANUAL_FAIL_RES";
	}
