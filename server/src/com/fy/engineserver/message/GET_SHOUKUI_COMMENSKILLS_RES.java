 ...
 * </table>
 */
public class GET_SHOUKUI_COMMENSKILLS_RES implements ResponseMessage{
	...
	public GET_SHOUKUI_COMMENSKILLS_RES(){
	}

	public GET_SHOUKUI_COMMENSKILLS_RES(long seqNum,int requestType,int[] careerTypes){
		this.seqNum = seqNum;
		this.requestType = requestType;
		this.careerTypes = careerTypes;
	}

	public GET_SHOUKUI_COMMENSKILLS_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "GET_SHOUKUI_COMMENSKILLS_RES";
	}
	...
	/**
	 * 获取属性：
	 *	兽魁普通攻击技能id，[0]人形态普通攻击 [1]兽形态普通攻击
	 */
