 ...
 * </table>
 */
public class CHANGE_SERVER_REQ implements RequestMessage{
	...
	public CHANGE_SERVER_REQ(){
	}

	public CHANGE_SERVER_REQ(long seqNum,String userName){
		this.seqNum = seqNum;
		this.userName = userName;
	}

	public CHANGE_SERVER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
