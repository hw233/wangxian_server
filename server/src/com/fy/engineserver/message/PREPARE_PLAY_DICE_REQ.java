 ...
 * </table>
 */
public class PREPARE_PLAY_DICE_REQ implements RequestMessage{
	...
	public PREPARE_PLAY_DICE_REQ(){
	}

	public PREPARE_PLAY_DICE_REQ(long seqNum,long spriteId,long articleEntityId){
		this.seqNum = seqNum;
		this.spriteId = spriteId;
		this.articleEntityId = articleEntityId;
	}

	public PREPARE_PLAY_DICE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
