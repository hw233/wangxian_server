 ...
 * </table>
 */
public class QUERY_CMCC_Balance_RES implements ResponseMessage{
	...
	public QUERY_CMCC_Balance_RES(long seqNum,String result,int balance){
		this.seqNum = seqNum;
		this.result = result;
		this.balance = balance;
	}

	public QUERY_CMCC_Balance_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
