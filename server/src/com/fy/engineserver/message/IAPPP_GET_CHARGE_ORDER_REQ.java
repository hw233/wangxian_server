 ...
 * </table>
 */
public class IAPPP_GET_CHARGE_ORDER_REQ implements RequestMessage{
	...
	public IAPPP_GET_CHARGE_ORDER_REQ(){
	}

	public IAPPP_GET_CHARGE_ORDER_REQ(long seqNum,String modeName,String id,String channel,String os){
		this.seqNum = seqNum;
	...
	public IAPPP_GET_CHARGE_ORDER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "IAPPP_GET_CHARGE_ORDER_REQ";
	}
