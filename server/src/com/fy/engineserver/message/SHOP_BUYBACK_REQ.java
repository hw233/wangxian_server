 ...
 * </table>
 */
public class SHOP_BUYBACK_REQ implements RequestMessage{
	...
	public SHOP_BUYBACK_REQ(){
	}

	public SHOP_BUYBACK_REQ(long seqNum,String shopName,long articleEntityId,int amount){
		this.seqNum = seqNum;
	...
	public SHOP_BUYBACK_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
