 ...
 * </table>
 */
public class BOOTH_HELP_RES implements ResponseMessage{
	...
	public BOOTH_HELP_RES(){
	}

	public BOOTH_HELP_RES(long seqNum,String helpMess){
		this.seqNum = seqNum;
		this.helpMess = helpMess;
	}

	public BOOTH_HELP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
