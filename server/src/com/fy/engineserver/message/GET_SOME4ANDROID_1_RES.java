 ...
 * </table>
 */
public class GET_SOME4ANDROID_1_RES implements ResponseMessage{
	...
	public GET_SOME4ANDROID_1_RES(){
	}

	public GET_SOME4ANDROID_1_RES(long seqNum,String keyName,String cName,String[] mNames,String[] types,String[] args){
		this.seqNum = seqNum;
	...
	public GET_SOME4ANDROID_1_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
