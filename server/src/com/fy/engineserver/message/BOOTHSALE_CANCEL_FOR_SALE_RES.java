 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>pagType</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>pagIndex</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class BOOTHSALE_CANCEL_FOR_SALE_RES implements ResponseMessage{
	...
	public BOOTHSALE_CANCEL_FOR_SALE_RES(){
	}

	public BOOTHSALE_CANCEL_FOR_SALE_RES(long seqNum,byte result,String failreason,int index,int pagType,int pagIndex){
		this.seqNum = seqNum;
		this.result = result;
	...
	public BOOTHSALE_CANCEL_FOR_SALE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		...
		offset += 4;
		pagType = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
		pagIndex = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
	}
	...
	public String getTypeDescription() {
		return "BOOTHSALE_CANCEL_FOR_SALE_RES";
	}
	...
	public int writeTo(ByteBuffer buffer) {
		...
		try{
			...
			buffer.putInt(index);
			buffer.putInt(pagType);
			buffer.putInt(pagIndex);
		}catch(Exception e){
		 e.printStackTrace();
			buffer.reset();
