 ...
 * </table>
 */
public class SEPTBUILDING_LVDOWN_RES implements ResponseMessage{
	...
	public SEPTBUILDING_LVDOWN_RES(){
	}

	public SEPTBUILDING_LVDOWN_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public SEPTBUILDING_LVDOWN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "SEPTBUILDING_LVDOWN_RES";
	}
