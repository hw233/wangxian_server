 ...
 * </table>
 */
public class QIANCHENGTA_MANUAL_MSG_RES implements ResponseMessage{
	...
	public QIANCHENGTA_MANUAL_MSG_RES(){
	}

	public QIANCHENGTA_MANUAL_MSG_RES(long seqNum,int daoIndex,String daoName,int cengIndex,String cengMsg){
		this.seqNum = seqNum;
	...
	public QIANCHENGTA_MANUAL_MSG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QIANCHENGTA_MANUAL_MSG_RES";
	}
