 ...
 * 版本号：null<br>
 * 更换服务器通知，服务器收到后通知网关，网关关闭用户对应的管道，重新开始解析协议<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class LEAVE_GAME_NOTIFY_REQ implements RequestMessage{
	...
	public LEAVE_GAME_NOTIFY_REQ(){
	}

	public LEAVE_GAME_NOTIFY_REQ(long seqNum,String userName){
		this.seqNum = seqNum;
		this.userName = userName;
	}

	public LEAVE_GAME_NOTIFY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
