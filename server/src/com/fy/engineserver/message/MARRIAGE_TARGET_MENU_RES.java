 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>sextype</td><td>byte</td><td>1个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>Entityid.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>Entityid</td><td>long[]</td><td>Entityid.length</td><td>*</td></tr>
 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>flowerNum.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>flowerNum</td><td>int[]</td><td>flowerNum.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>haveFlower.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>haveFlower</td><td>int[]</td><td>haveFlower.length</td><td>*</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>flowerMoney.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>flowerMoney</td><td>long[]</td><td>flowerMoney.length</td><td>*</td></tr>
 * </table>
 */
public class MARRIAGE_TARGET_MENU_RES implements ResponseMessage{
	...
	public MARRIAGE_TARGET_MENU_RES(){
	}

	public MARRIAGE_TARGET_MENU_RES(long seqNum,long playerId,byte sextype,long[] Entityid,String[] name,int[] flowerNum,int[] haveFlower,long[] flowerMoney){
		this.seqNum = seqNum;
	...
	public MARRIAGE_TARGET_MENU_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "MARRIAGE_TARGET_MENU_RES";
	}
