 ...
 * </table>
 */
public class NEWQIANCENGTA_FLUSH_REQ implements RequestMessage{
	...
	public NEWQIANCENGTA_FLUSH_REQ(){
	}

	public NEWQIANCENGTA_FLUSH_REQ(long seqNum,long playerId,int nanduType,int daoIndex){
		this.seqNum = seqNum;
	...
	public NEWQIANCENGTA_FLUSH_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEWQIANCENGTA_FLUSH_REQ";
	}
