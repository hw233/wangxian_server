 ...
 * </table>
 */
public class QUERY_FEED_HORSE_RES implements ResponseMessage{
	...
	public QUERY_FEED_HORSE_RES(){
	}

	public QUERY_FEED_HORSE_RES(long seqNum,String[] names){
		this.seqNum = seqNum;
		this.names = names;
	}

	public QUERY_FEED_HORSE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
