 ...
 * </table>
 */
public class GET_MARRIAGE_FRIEND_RES implements ResponseMessage{
	...
	public GET_MARRIAGE_FRIEND_RES(){
	}

	public GET_MARRIAGE_FRIEND_RES(long seqNum,Player_RelatinInfo[] player_relationInfo){
		this.seqNum = seqNum;
		this.player_relationInfo = player_relationInfo;
	}

	public GET_MARRIAGE_FRIEND_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "GET_MARRIAGE_FRIEND_RES";
	}
