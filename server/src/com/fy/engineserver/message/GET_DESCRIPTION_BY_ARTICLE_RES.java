 ...
 * </table>
 */
public class GET_DESCRIPTION_BY_ARTICLE_RES implements ResponseMessage{
	...
	public GET_DESCRIPTION_BY_ARTICLE_RES(){
	}

	public GET_DESCRIPTION_BY_ARTICLE_RES(long seqNum,String articleName,String icon,String description){
		this.seqNum = seqNum;
	...
	public GET_DESCRIPTION_BY_ARTICLE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "GET_DESCRIPTION_BY_ARTICLE_RES";
	}
