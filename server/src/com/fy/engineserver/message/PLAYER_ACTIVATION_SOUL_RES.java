 ...
 * </table>
 */
public class PLAYER_ACTIVATION_SOUL_RES implements ResponseMessage{
	...
	public PLAYER_ACTIVATION_SOUL_RES(){
	}

	public PLAYER_ACTIVATION_SOUL_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public PLAYER_ACTIVATION_SOUL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "PLAYER_ACTIVATION_SOUL_RES";
	}
