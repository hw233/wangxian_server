 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>switchColdDown</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class PLAYER_SWITCH_SOUL_RES implements ResponseMessage{
	...
	public PLAYER_SWITCH_SOUL_RES(){
	}

	public PLAYER_SWITCH_SOUL_RES(long seqNum,byte result,String failreason,long switchColdDown){
		this.seqNum = seqNum;
		this.result = result;
	...
	public PLAYER_SWITCH_SOUL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
