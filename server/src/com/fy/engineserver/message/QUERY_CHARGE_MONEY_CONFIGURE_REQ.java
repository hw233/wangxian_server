 ...
 * </table>
 */
public class QUERY_CHARGE_MONEY_CONFIGURE_REQ implements RequestMessage{
	...
	public QUERY_CHARGE_MONEY_CONFIGURE_REQ(){
	}

	public QUERY_CHARGE_MONEY_CONFIGURE_REQ(long seqNum,String channel,String modeName){
		this.seqNum = seqNum;
		this.channel = channel;
		this.modeName = modeName;
	}

	public QUERY_CHARGE_MONEY_CONFIGURE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_CHARGE_MONEY_CONFIGURE_REQ";
	}
