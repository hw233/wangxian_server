 ...
 * </table>
 */
public class A_ARGS_RES implements ResponseMessage{
	...
	public A_ARGS_RES(long seqNum,String partnerID,String sellerID,String aliPublicKey,String ownPublicKey,String ownPrivateKey,String notifyUrl){
		this.seqNum = seqNum;
	...
	public A_ARGS_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
