 ...
 * </table>
 */
public class QUERY_WHITE_LIST_RES implements ResponseMessage{
	...
	public QUERY_WHITE_LIST_RES(){
	}

	public QUERY_WHITE_LIST_RES(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public QUERY_WHITE_LIST_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
