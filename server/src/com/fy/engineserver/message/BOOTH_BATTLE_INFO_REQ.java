 ...
 * </table>
 */
public class BOOTH_BATTLE_INFO_REQ implements RequestMessage{
	...
	public BOOTH_BATTLE_INFO_REQ(){
	}

	public BOOTH_BATTLE_INFO_REQ(long seqNum,int billboardType){
		this.seqNum = seqNum;
		this.billboardType = billboardType;
	}

	public BOOTH_BATTLE_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
