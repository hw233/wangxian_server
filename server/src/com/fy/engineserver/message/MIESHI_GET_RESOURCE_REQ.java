 ...
 * </table>
 */
public class MIESHI_GET_RESOURCE_REQ implements RequestMessage{
	...
	public MIESHI_GET_RESOURCE_REQ(){
	}

	public MIESHI_GET_RESOURCE_REQ(long seqNum,String clientId,String channel,String clientPlatform,String gpu,String gpuOtherName,String clientProgramVersion,String clientResourceVersion,String phoneType,String fileName){
		this.seqNum = seqNum;
	...
	public MIESHI_GET_RESOURCE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "MIESHI_GET_RESOURCE_REQ";
	}
