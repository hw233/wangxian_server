 ...
 * </table>
 */
public class XILIAN_EQUIPMENT_SURE_REQ implements RequestMessage{
	...
	public XILIAN_EQUIPMENT_SURE_REQ(){
	}

	public XILIAN_EQUIPMENT_SURE_REQ(long seqNum,long equipmentId,long materialId){
		this.seqNum = seqNum;
		this.equipmentId = equipmentId;
		this.materialId = materialId;
	}

	public XILIAN_EQUIPMENT_SURE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "XILIAN_EQUIPMENT_SURE_REQ";
	}
