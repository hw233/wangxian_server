 ...
 * </table>
 */
public class JIAZU_P_SALARY_RES implements ResponseMessage{
	...
	public JIAZU_P_SALARY_RES(){
	}

	public JIAZU_P_SALARY_RES(long seqNum,byte result,String failreason,long playerid,long salary,long jiazuLeftSalary){
		this.seqNum = seqNum;
		this.result = result;
	...
	public JIAZU_P_SALARY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
