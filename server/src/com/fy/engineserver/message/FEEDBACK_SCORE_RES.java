 ...
 * </table>
 */
public class FEEDBACK_SCORE_RES implements ResponseMessage{
	...
	public FEEDBACK_SCORE_RES(){
	}

	public FEEDBACK_SCORE_RES(long seqNum,long id,int result,String resultMess){
		this.seqNum = seqNum;
		this.id = id;
		this.result = result;
	...
	public FEEDBACK_SCORE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
