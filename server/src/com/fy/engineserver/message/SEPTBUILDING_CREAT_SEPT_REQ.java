 ...
 * </table>
 */
public class SEPTBUILDING_CREAT_SEPT_REQ implements RequestMessage{
	...
	public SEPTBUILDING_CREAT_SEPT_REQ(){
	}

	public SEPTBUILDING_CREAT_SEPT_REQ(long seqNum,long septId,String mapName,String name,long NPCId){
		this.seqNum = seqNum;
		this.septId = septId;
	...
	public SEPTBUILDING_CREAT_SEPT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "SEPTBUILDING_CREAT_SEPT_REQ";
	}
