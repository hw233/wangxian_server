 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>stepDesc.length</td><td>int</td><td>4</td><td>数组长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>stepDesc[0].length</td><td>int</td><td>2</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>stepDesc[0]</td><td>String</td><td>stepDesc[0].length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>stepDesc[1].length</td><td>int</td><td>2</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>stepDesc[1]</td><td>String</td><td>stepDesc[1].length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>stepDesc[2].length</td><td>int</td><td>2</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>stepDesc[2]</td><td>String</td><td>stepDesc[2].length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td colspan=4>......... 重复</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>layerDesc.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>layerDesc</td><td>String</td><td>layerDesc.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>nextLayerDesc.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>nextLayerDesc</td><td>String</td><td>nextLayerDesc.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class SkEnh_jj_RES implements ResponseMessage{
	...
	public SkEnh_jj_RES(long seqNum,int level,String name,String desc,String[] stepDesc,String layerDesc,String nextLayerDesc){
		this.seqNum = seqNum;
		this.level = level;
		this.name = name;
		this.desc = desc;
	...
	public SkEnh_jj_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
