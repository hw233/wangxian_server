 ...
 * </table>
 */
public class NONTARGET_SKILL_BROADCAST_REQ implements RequestMessage{
	...
	public NONTARGET_SKILL_BROADCAST_REQ(){
	}

	public NONTARGET_SKILL_BROADCAST_REQ(long seqNum,byte casterType,long casterId,short targetX,short targetY,int skillId,byte level){
		this.seqNum = seqNum;
	...
	public NONTARGET_SKILL_BROADCAST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NONTARGET_SKILL_BROADCAST_REQ";
	}
