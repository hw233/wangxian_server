 ...
 * </table>
 */
public class FEEDBACK_ISSHOW_HOMEPAGE_REQ implements RequestMessage{
	...
	public FEEDBACK_ISSHOW_HOMEPAGE_REQ(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public FEEDBACK_ISSHOW_HOMEPAGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "FEEDBACK_ISSHOW_HOMEPAGE_REQ";
	}
