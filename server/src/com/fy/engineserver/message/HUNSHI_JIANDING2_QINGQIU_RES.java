 ...
 * </table>
 */
public class HUNSHI_JIANDING2_QINGQIU_RES implements ResponseMessage{
	...
	public HUNSHI_JIANDING2_QINGQIU_RES(){
	}

	public HUNSHI_JIANDING2_QINGQIU_RES(long seqNum,String descript){
		this.seqNum = seqNum;
		this.descript = descript;
	}

	public HUNSHI_JIANDING2_QINGQIU_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "HUNSHI_JIANDING2_QINGQIU_RES";
	}
