 ...
 * </table>
 */
public class QUERY_CMCC_AUTHORIZED_RES implements ResponseMessage{
	...
	public QUERY_CMCC_AUTHORIZED_RES(long seqNum,String result,String userId,String key){
		this.seqNum = seqNum;
		this.result = result;
		this.userId = userId;
		this.key = key;
	...
	public QUERY_CMCC_AUTHORIZED_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_CMCC_AUTHORIZED_RES";
	}
