 ...
 * </table>
 */
public class SEPTBUILDING_CREAT_SEPT_RES implements ResponseMessage{
	...
	public SEPTBUILDING_CREAT_SEPT_RES(){
	}

	public SEPTBUILDING_CREAT_SEPT_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public SEPTBUILDING_CREAT_SEPT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "SEPTBUILDING_CREAT_SEPT_RES";
	}
