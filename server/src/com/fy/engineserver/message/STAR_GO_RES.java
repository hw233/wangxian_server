 ...
 * </table>
 */
public class STAR_GO_RES implements ResponseMessage{
	...
	public STAR_GO_RES(long seqNum,boolean result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public STAR_GO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
