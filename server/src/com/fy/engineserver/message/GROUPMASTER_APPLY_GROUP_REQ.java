 ...
 * </table>
 */
public class GROUPMASTER_APPLY_GROUP_REQ implements RequestMessage{
	...
	public GROUPMASTER_APPLY_GROUP_REQ(){
	}

	public GROUPMASTER_APPLY_GROUP_REQ(long seqNum,long groupId,long playerId){
		this.seqNum = seqNum;
		this.groupId = groupId;
		this.playerId = playerId;
	}

	public GROUPMASTER_APPLY_GROUP_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "GROUPMASTER_APPLY_GROUP_REQ";
	}
