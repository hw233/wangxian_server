 ...
 * </table>
 */
public class TRY_SEND_UNBIND_RES implements ResponseMessage{
	...
	public TRY_SEND_UNBIND_RES(){
	}

	public TRY_SEND_UNBIND_RES(long seqNum,boolean isOK,String errorMsg){
		this.seqNum = seqNum;
		this.isOK = isOK;
		this.errorMsg = errorMsg;
	}

	public TRY_SEND_UNBIND_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
