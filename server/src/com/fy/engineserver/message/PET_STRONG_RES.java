 ...
 * </table>
 */
public class PET_STRONG_RES implements ResponseMessage{
	...
	public PET_STRONG_RES(){
	}

	public PET_STRONG_RES(long seqNum,long equipmentId,short star,boolean canStrong){
		this.seqNum = seqNum;
	...
	public PET_STRONG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
