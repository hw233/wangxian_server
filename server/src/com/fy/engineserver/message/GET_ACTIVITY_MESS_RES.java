 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>chargeMess.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>chargeMess</td><td>String</td><td>chargeMess.length</td><td>字符串对应的byte数组</td></tr>
 * </table>
 */
public class GET_ACTIVITY_MESS_RES implements ResponseMessage{
	...
	public GET_ACTIVITY_MESS_RES(){
	}

	public GET_ACTIVITY_MESS_RES(long seqNum,String activityName,String chargeMess){
		this.seqNum = seqNum;
		this.activityName = activityName;
		this.chargeMess = chargeMess;
	}

	public GET_ACTIVITY_MESS_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
