 ...
 * </table>
 */
public class QUERY_ARTICLE_REQ implements RequestMessage{
	...
	public QUERY_ARTICLE_REQ(){
	}

	public QUERY_ARTICLE_REQ(long seqNum,long[] articleIds){
		this.seqNum = seqNum;
		this.articleIds = articleIds;
	}

	public QUERY_ARTICLE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
