 ...
 * </table>
 */
public class GET_HORSE_SKILL_INFO_SHOW_REQ implements RequestMessage{
	...
	public GET_HORSE_SKILL_INFO_SHOW_REQ(){
	}

	public GET_HORSE_SKILL_INFO_SHOW_REQ(long seqNum,long playerId,long horseId,int skillId){
		this.seqNum = seqNum;
	...
	public GET_HORSE_SKILL_INFO_SHOW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "GET_HORSE_SKILL_INFO_SHOW_REQ";
	}
	...
	/**
	 * 获取属性：
	 *	玩家id，防止以后可以查看别人的坐骑技能请求描述用,查询自己的传-1
	 */
