 ...
 * </table>
 */
public class HUNSHI_SPECIAL_REQ implements RequestMessage{
	...
	public HUNSHI_SPECIAL_REQ(){
	}

	public HUNSHI_SPECIAL_REQ(long seqNum,long[] materialId){
		this.seqNum = seqNum;
		this.materialId = materialId;
	}

	public HUNSHI_SPECIAL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
