 ...
 * </table>
 */
public class HANDOUT_FORLUCK_TREE_REQ implements RequestMessage{
	...
	public HANDOUT_FORLUCK_TREE_REQ(){
	}

	public HANDOUT_FORLUCK_TREE_REQ(long seqNum,long npcId,long playerId){
		this.seqNum = seqNum;
		this.npcId = npcId;
		this.playerId = playerId;
	}

	public HANDOUT_FORLUCK_TREE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "HANDOUT_FORLUCK_TREE_REQ";
	}
