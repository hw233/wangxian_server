 ...
 * </table>
 */
public class HELP_RES implements ResponseMessage{
	...
	public HELP_RES(long seqNum,String des){
		this.seqNum = seqNum;
		this.des = des;
	}

	public HELP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
