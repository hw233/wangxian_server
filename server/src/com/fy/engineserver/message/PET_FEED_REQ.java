 ...
 * </table>
 */
public class PET_FEED_REQ implements RequestMessage{
	...
	public PET_FEED_REQ(long seqNum,long petEntityId,long foodId,int num){
		this.seqNum = seqNum;
	...
	public PET_FEED_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
