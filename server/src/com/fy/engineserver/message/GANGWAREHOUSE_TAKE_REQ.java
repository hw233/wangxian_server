 ...
 * </table>
 */
public class GANGWAREHOUSE_TAKE_REQ implements RequestMessage{
	...
	public GANGWAREHOUSE_TAKE_REQ(){
	}

	public GANGWAREHOUSE_TAKE_REQ(long seqNum,byte privilegeType,int cellIndex){
		this.seqNum = seqNum;
		this.privilegeType = privilegeType;
		this.cellIndex = cellIndex;
	}

	public GANGWAREHOUSE_TAKE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
