 ...
 * </table>
 */
public class PET_CELL_HELP_RES implements ResponseMessage{
	...
	public PET_CELL_HELP_RES(){
	}

	public PET_CELL_HELP_RES(long seqNum,String helpMess){
		this.seqNum = seqNum;
		this.helpMess = helpMess;
	}

	public PET_CELL_HELP_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
