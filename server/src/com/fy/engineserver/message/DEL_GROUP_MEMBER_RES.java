 ...
 * </table>
 */
public class DEL_GROUP_MEMBER_RES implements ResponseMessage{
	...
	public DEL_GROUP_MEMBER_RES(){
	}

	public DEL_GROUP_MEMBER_RES(long seqNum,String result,long groupId,long playerId){
		this.seqNum = seqNum;
		this.result = result;
	...
	public DEL_GROUP_MEMBER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
