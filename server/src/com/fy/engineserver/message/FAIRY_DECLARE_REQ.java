 ...
 * </table>
 */
public class FAIRY_DECLARE_REQ implements RequestMessage{
	...
	public FAIRY_DECLARE_REQ(){
	}

	public FAIRY_DECLARE_REQ(long seqNum,String declaration){
		this.seqNum = seqNum;
		this.declaration = declaration;
	}

	public FAIRY_DECLARE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
