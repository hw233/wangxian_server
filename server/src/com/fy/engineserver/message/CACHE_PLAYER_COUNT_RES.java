 ...
 * </table>
 */
public class CACHE_PLAYER_COUNT_RES implements ResponseMessage{
	...
	public CACHE_PLAYER_COUNT_RES(long seqNum,int count,String result){
		this.seqNum = seqNum;
		this.count = count;
		this.result = result;
	}

	public CACHE_PLAYER_COUNT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
