 ...
 * </table>
 */
public class SET_PWD_PROTECT_RES implements ResponseMessage{
	...
	public SET_PWD_PROTECT_RES(){
	}

	public SET_PWD_PROTECT_RES(long seqNum,byte result,String resultString){
		this.seqNum = seqNum;
		this.result = result;
		this.resultString = resultString;
	}

	public SET_PWD_PROTECT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
