 ...
 * </table>
 */
public class PET_MATING_SESSION_OVER_REQ implements RequestMessage{
	...
	public PET_MATING_SESSION_OVER_REQ(){
	}

	public PET_MATING_SESSION_OVER_REQ(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public PET_MATING_SESSION_OVER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "PET_MATING_SESSION_OVER_REQ";
	}
