 ...
 * </table>
 */
public class TIPS_FOR_MINIGAME_ACTIVITY_RES implements ResponseMessage{
	...
	public TIPS_FOR_MINIGAME_ACTIVITY_RES(){
	}

	public TIPS_FOR_MINIGAME_ACTIVITY_RES(long seqNum,String contentmass){
		this.seqNum = seqNum;
		this.contentmass = contentmass;
	}

	public TIPS_FOR_MINIGAME_ACTIVITY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "TIPS_FOR_MINIGAME_ACTIVITY_RES";
	}
