 ...
 * </table>
 */
public class SOUL_UPGRADE_RES implements ResponseMessage{
	...
	public SOUL_UPGRADE_RES(long seqNum,int action,String resultMess){
		this.seqNum = seqNum;
		this.action = action;
		this.resultMess = resultMess;
	}

	public SOUL_UPGRADE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
