 ...
 * </table>
 */
public class MARRIAGE_REQ implements RequestMessage{
	...
	public MARRIAGE_REQ(long seqNum,String playerName){
		this.seqNum = seqNum;
		this.playerName = playerName;
	}

	public MARRIAGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
