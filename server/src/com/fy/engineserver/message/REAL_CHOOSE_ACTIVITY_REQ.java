 ...
 * </table>
 */
public class REAL_CHOOSE_ACTIVITY_REQ implements RequestMessage{
	...
	public REAL_CHOOSE_ACTIVITY_REQ(){
	}

	public REAL_CHOOSE_ACTIVITY_REQ(long seqNum,long playerId,byte activityType,int level){
		this.seqNum = seqNum;
	...
	public REAL_CHOOSE_ACTIVITY_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "REAL_CHOOSE_ACTIVITY_REQ";
	}
