 ...
 * </table>
 */
public class SEPTBUILDING_DESTROY_RES implements ResponseMessage{
	...
	public SEPTBUILDING_DESTROY_RES(){
	}

	public SEPTBUILDING_DESTROY_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public SEPTBUILDING_DESTROY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "SEPTBUILDING_DESTROY_RES";
	}
