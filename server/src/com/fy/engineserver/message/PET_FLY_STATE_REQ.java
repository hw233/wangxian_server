 ...
 * </table>
 */
public class PET_FLY_STATE_REQ implements RequestMessage{
	...
	public PET_FLY_STATE_REQ(){
	}

	public PET_FLY_STATE_REQ(long seqNum,long petId,long playerId){
		this.seqNum = seqNum;
		this.petId = petId;
		this.playerId = playerId;
	}

	public PET_FLY_STATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
