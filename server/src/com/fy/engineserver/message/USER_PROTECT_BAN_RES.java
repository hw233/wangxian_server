 ...
 * </table>
 */
public class USER_PROTECT_BAN_RES implements ResponseMessage{
	...
	public USER_PROTECT_BAN_RES(){
	}

	public USER_PROTECT_BAN_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public USER_PROTECT_BAN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
