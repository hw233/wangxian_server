 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>fendiIndex</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class DIG_FENMU_REQ implements RequestMessage{
	...
	public DIG_FENMU_REQ(){
	}

	public DIG_FENMU_REQ(long seqNum,String fenmuName,int fendiIndex){
		this.seqNum = seqNum;
		this.fenmuName = fenmuName;
		this.fendiIndex = fendiIndex;
	}

	public DIG_FENMU_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
