 ...
 * </table>
 */
public class REFRESH_SHOP_GOODS_REQ implements RequestMessage{
	...
	public REFRESH_SHOP_GOODS_REQ(){
	}

	public REFRESH_SHOP_GOODS_REQ(long seqNum,String shopName){
		this.seqNum = seqNum;
		this.shopName = shopName;
	}

	public REFRESH_SHOP_GOODS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
