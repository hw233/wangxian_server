 ...
 * </table>
 */
public class QUERY_MAP_SEARCH_RES implements ResponseMessage{
	...
	public QUERY_MAP_SEARCH_RES(){
	}

	public QUERY_MAP_SEARCH_RES(long seqNum,String[] mapNames,boolean[] searched){
		this.seqNum = seqNum;
		this.mapNames = mapNames;
		this.searched = searched;
	}

	public QUERY_MAP_SEARCH_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
