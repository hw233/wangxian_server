 ...
 * </table>
 */
public class NEWQIANCHENGTA_MANUAL_MSG_RES implements ResponseMessage{
	...
	public NEWQIANCHENGTA_MANUAL_MSG_RES(){
	}

	public NEWQIANCHENGTA_MANUAL_MSG_RES(long seqNum,int nanduType,int daoIndex,String daoName,int cengIndex,String cengMsg){
		this.seqNum = seqNum;
	...
	public NEWQIANCHENGTA_MANUAL_MSG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEWQIANCHENGTA_MANUAL_MSG_RES";
	}
