 ...
 * </table>
 */
public class NEW_EQUIPMENT_STRONG_RES implements ResponseMessage{
	...
	public NEW_EQUIPMENT_STRONG_RES(){
	}

	public NEW_EQUIPMENT_STRONG_RES(long seqNum,long equipmentId,short star,boolean canStrong){
		this.seqNum = seqNum;
	...
	public NEW_EQUIPMENT_STRONG_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "NEW_EQUIPMENT_STRONG_RES";
	}
