 ...
 * </table>
 */
public class SEND_CLIENT_EXTENDINFO_RES implements ResponseMessage{
	...
	public SEND_CLIENT_EXTENDINFO_RES(){
	}

	public SEND_CLIENT_EXTENDINFO_RES(long seqNum,String[] mess){
		this.seqNum = seqNum;
		this.mess = mess;
	}

	public SEND_CLIENT_EXTENDINFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "SEND_CLIENT_EXTENDINFO_RES";
	}
