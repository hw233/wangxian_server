 ...
 * 版本号：null<br>
 * 取消交易状态，服务器和客户端共享此协议，用户不接受交易请求或中途退出交易<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class DEAL_CANCEL_REQ implements RequestMessage{
	...
	public DEAL_CANCEL_REQ(){
	}

	public DEAL_CANCEL_REQ(long seqNum,String reason){
		this.seqNum = seqNum;
		this.reason = reason;
	}

	public DEAL_CANCEL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
