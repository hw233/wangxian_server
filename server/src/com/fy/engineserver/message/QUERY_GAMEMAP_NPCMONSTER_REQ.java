 ...
 * </table>
 */
public class QUERY_GAMEMAP_NPCMONSTER_REQ implements RequestMessage{
	...
	public QUERY_GAMEMAP_NPCMONSTER_REQ(){
	}

	public QUERY_GAMEMAP_NPCMONSTER_REQ(long seqNum,String mapname){
		this.seqNum = seqNum;
		this.mapname = mapname;
	}

	public QUERY_GAMEMAP_NPCMONSTER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "QUERY_GAMEMAP_NPCMONSTER_REQ";
	}
