 ...
 * </table>
 */
public class PET_RENAME_RES implements ResponseMessage{
	...
	public PET_RENAME_RES(){
	}

	public PET_RENAME_RES(long seqNum,long petEntityId,String newName){
		this.seqNum = seqNum;
		this.petEntityId = petEntityId;
		this.newName = newName;
	}

	public PET_RENAME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
