 ...
 * </table>
 */
public class SHOP_GET_REQ implements RequestMessage{
	...
	public SHOP_GET_REQ(long seqNum,String shopName){
		this.seqNum = seqNum;
		this.shopName = shopName;
	}

	public SHOP_GET_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
