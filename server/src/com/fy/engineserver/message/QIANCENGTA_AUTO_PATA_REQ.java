 ...
 * </table>
 */
public class QIANCENGTA_AUTO_PATA_REQ implements RequestMessage{
	...
	public QIANCENGTA_AUTO_PATA_REQ(){
	}

	public QIANCENGTA_AUTO_PATA_REQ(long seqNum,long playerId,int daoIndex,int action){
		this.seqNum = seqNum;
	...
	public QIANCENGTA_AUTO_PATA_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QIANCENGTA_AUTO_PATA_REQ";
	}
