 ...
 * </table>
 */
public class QUERY_ONE_AIMS_REQ implements RequestMessage{
	...
	public QUERY_ONE_AIMS_REQ(){
	}

	public QUERY_ONE_AIMS_REQ(long seqNum,long playerId,int aimId){
		this.seqNum = seqNum;
		this.playerId = playerId;
		this.aimId = aimId;
	}

	public QUERY_ONE_AIMS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
