 ...
 * </table>
 */
public class MAIL_DELETE_RES implements ResponseMessage{
	...
	public MAIL_DELETE_RES(){
	}

	public MAIL_DELETE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public MAIL_DELETE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
