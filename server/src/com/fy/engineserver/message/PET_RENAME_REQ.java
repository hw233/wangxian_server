 ...
 * </table>
 */
public class PET_RENAME_REQ implements RequestMessage{
	...
	public PET_RENAME_REQ(){
	}

	public PET_RENAME_REQ(long seqNum,long petEntityId,String newName){
		this.seqNum = seqNum;
		this.petEntityId = petEntityId;
		this.newName = newName;
	}

	public PET_RENAME_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
