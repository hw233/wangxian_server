 ...
 * </table>
 */
public class GUOZHAN_ADD_ORDER_REQ implements RequestMessage{
	...
	public GUOZHAN_ADD_ORDER_REQ(){
	}

	public GUOZHAN_ADD_ORDER_REQ(long seqNum,String name,String message){
		this.seqNum = seqNum;
		this.name = name;
		this.message = message;
	}

	public GUOZHAN_ADD_ORDER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
