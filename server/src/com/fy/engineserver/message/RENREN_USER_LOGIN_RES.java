 ...
 * </table>
 */
public class RENREN_USER_LOGIN_RES implements ResponseMessage{
	...
	public RENREN_USER_LOGIN_RES(long seqNum,byte result,String resultString,String authCode,String RecommendWelcome,String userName,String password){
		this.seqNum = seqNum;
		this.result = result;
	...
	public RENREN_USER_LOGIN_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
