 ...
 * </table>
 */
public class REQUESTBUY_QRY_BY_TERM_RES implements ResponseMessage{
	...
	public REQUESTBUY_QRY_BY_TERM_RES(){
	}

	public REQUESTBUY_QRY_BY_TERM_RES(long seqNum,int startNum,int allNum,RequestBuyInfo4Client[] requestBuyInfo4Client){
		this.seqNum = seqNum;
	...
	public REQUESTBUY_QRY_BY_TERM_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "REQUESTBUY_QRY_BY_TERM_RES";
	}
