 ...
 * </table>
 */
public class JUBAO_PLAYER_RES implements ResponseMessage{
	...
	public JUBAO_PLAYER_RES(){
	}

	public JUBAO_PLAYER_RES(long seqNum,int result,String helpMess){
		this.seqNum = seqNum;
		this.result = result;
		this.helpMess = helpMess;
	}

	public JUBAO_PLAYER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
