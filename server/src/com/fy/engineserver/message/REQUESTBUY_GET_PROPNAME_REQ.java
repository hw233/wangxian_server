 ...
 * </table>
 */
public class REQUESTBUY_GET_PROPNAME_REQ implements RequestMessage{
	...
	public REQUESTBUY_GET_PROPNAME_REQ(){
	}

	public REQUESTBUY_GET_PROPNAME_REQ(long seqNum,String first,String second){
		this.seqNum = seqNum;
		this.first = first;
		this.second = second;
	}

	public REQUESTBUY_GET_PROPNAME_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "REQUESTBUY_GET_PROPNAME_REQ";
	}
