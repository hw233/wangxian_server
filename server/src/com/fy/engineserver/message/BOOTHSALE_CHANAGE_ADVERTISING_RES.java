 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>cycle</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class BOOTHSALE_CHANAGE_ADVERTISING_RES implements ResponseMessage{
	...
	public BOOTHSALE_CHANAGE_ADVERTISING_RES(){
	}

	public BOOTHSALE_CHANAGE_ADVERTISING_RES(long seqNum,byte result,String failreason,int cycle){
		this.seqNum = seqNum;
		this.result = result;
	...
	public BOOTHSALE_CHANAGE_ADVERTISING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "BOOTHSALE_CHANAGE_ADVERTISING_RES";
	}
