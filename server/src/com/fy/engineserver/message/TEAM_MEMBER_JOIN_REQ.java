 ...
 * 版本号：null<br>
 * 服务器通知客户端，某个玩家加入到当前玩家所在的团队。新加入的玩家也会收到此指令<br>
 * 数据包的格式如下：<br><br>
 ...
 * </table>
 */
public class TEAM_MEMBER_JOIN_REQ implements RequestMessage{
	...
	public TEAM_MEMBER_JOIN_REQ(){
	}

	public TEAM_MEMBER_JOIN_REQ(long seqNum,int teamId,long playerId,String playerName){
		this.seqNum = seqNum;
		this.teamId = teamId;
	...
	public TEAM_MEMBER_JOIN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
