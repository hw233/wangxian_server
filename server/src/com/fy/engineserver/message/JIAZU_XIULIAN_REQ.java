 ...
 * </table>
 */
public class JIAZU_XIULIAN_REQ implements RequestMessage{
	...
	public JIAZU_XIULIAN_REQ(){
	}

	public JIAZU_XIULIAN_REQ(long seqNum,int shangxiangId){
		this.seqNum = seqNum;
		this.shangxiangId = shangxiangId;
	}

	public JIAZU_XIULIAN_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
