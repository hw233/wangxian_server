 ...
 * </table>
 */
public class GET_ONE_TREASUREACTIVITY_INFO_RES implements ResponseMessage{
	...
	public GET_ONE_TREASUREACTIVITY_INFO_RES(){
	}

	public GET_ONE_TREASUREACTIVITY_INFO_RES(long seqNum,int treasureId,long[] defaultArticleIds,String description){
		this.seqNum = seqNum;
	...
	public GET_ONE_TREASUREACTIVITY_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "GET_ONE_TREASUREACTIVITY_INFO_RES";
	}
