 ...
 * </table>
 */
public class INPUT_WINDOW_PNG_REQ implements RequestMessage{
	...
	public INPUT_WINDOW_PNG_REQ(){
	}

	public INPUT_WINDOW_PNG_REQ(long seqNum,int windowId,String title,String descriptionInUUB,byte inputType,byte maxSize,String defaultContent,String okStr,String cancelStr,byte[] png){
		this.seqNum = seqNum;
	...
	public INPUT_WINDOW_PNG_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
