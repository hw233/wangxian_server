 ...
 * </table>
 */
public class GUOZHAN_ADD_ORDER_RES implements ResponseMessage{
	...
	public GUOZHAN_ADD_ORDER_RES(){
	}

	public GUOZHAN_ADD_ORDER_RES(long seqNum,String[] icon,String[] name,String[] message,boolean[] removable){
		this.seqNum = seqNum;
		this.icon = icon;
		this.name = name;
	...
	public GUOZHAN_ADD_ORDER_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
