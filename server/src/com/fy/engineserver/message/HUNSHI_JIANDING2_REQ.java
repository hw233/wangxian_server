 ...
 * </table>
 */
public class HUNSHI_JIANDING2_REQ implements RequestMessage{
	...
	public HUNSHI_JIANDING2_REQ(){
	}

	public HUNSHI_JIANDING2_REQ(long seqNum,long hunshiId){
		this.seqNum = seqNum;
		this.hunshiId = hunshiId;
	}

	public HUNSHI_JIANDING2_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
