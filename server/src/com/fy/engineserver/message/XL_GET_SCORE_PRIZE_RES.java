 ...
 * </table>
 */
public class XL_GET_SCORE_PRIZE_RES implements ResponseMessage{
	...
	public XL_GET_SCORE_PRIZE_RES(){
	}

	public XL_GET_SCORE_PRIZE_RES(long seqNum,int score,boolean result){
		this.seqNum = seqNum;
		this.score = score;
		this.result = result;
	}

	public XL_GET_SCORE_PRIZE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
