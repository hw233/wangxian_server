 ...
 * </table>
 */
public class QUERY_INVALID_TIME_RES implements ResponseMessage{
	...
	public QUERY_INVALID_TIME_RES(){
	}

	public QUERY_INVALID_TIME_RES(long seqNum,long articleId,long invalidTime){
		this.seqNum = seqNum;
		this.articleId = articleId;
		this.invalidTime = invalidTime;
	}

	public QUERY_INVALID_TIME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
