 ...
 * </table>
 */
public class USER_ENTER_SERVER_REQ implements RequestMessage{
	...
	public USER_ENTER_SERVER_REQ(){
	}

	public USER_ENTER_SERVER_REQ(long seqNum,String username,String password,String authCode){
		this.seqNum = seqNum;
	...
	public USER_ENTER_SERVER_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
