 ...
 * <tr bgcolor="#FFFFFF" align="center"><td>level.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>level</td><td>String</td><td>level.length</td><td>字符串对应的byte数组</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>startNum</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * <tr bgcolor="#FAFAFA" align="center"><td>lenth</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class REQUESTBUY_QRY_BY_TERM_REQ implements RequestMessage{
	...
	public REQUESTBUY_QRY_BY_TERM_REQ(){
	}

	public REQUESTBUY_QRY_BY_TERM_REQ(long seqNum,String mainType,String subType,String articleName,int color,String level,int startNum,int lenth){
		this.seqNum = seqNum;
	...
	public REQUESTBUY_QRY_BY_TERM_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		offset += 4;
		lenth = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
	}
	...
	public String getTypeDescription() {
		return "REQUESTBUY_QRY_BY_TERM_REQ";
	}
