 ...
 * </table>
 */
public class QUERY_SKILLINFO_PET2_REQ implements RequestMessage{
	...
	public QUERY_SKILLINFO_PET2_REQ(){
	}

	public QUERY_SKILLINFO_PET2_REQ(long seqNum,int id,short level,long petId){
		this.seqNum = seqNum;
		this.id = id;
		this.level = level;
		this.petId = petId;
	...
	public QUERY_SKILLINFO_PET2_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "QUERY_SKILLINFO_PET2_REQ";
	}
	...
	/**
	 * 获取属性：
	 *	拥有这个技能的宠物id，-1000表示从宠物图鉴里查看天生技能。
	 */
