 ...
 * </table>
 */
public class RANDOM_NAME_RES implements ResponseMessage{
	...
	public RANDOM_NAME_RES(){
	}

	public RANDOM_NAME_RES(long seqNum,String name){
		this.seqNum = seqNum;
		this.name = name;
	}

	public RANDOM_NAME_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
