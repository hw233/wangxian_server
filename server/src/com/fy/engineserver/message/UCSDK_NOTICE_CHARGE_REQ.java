 ...
 * </table>
 */
public class UCSDK_NOTICE_CHARGE_REQ implements RequestMessage{
	...
	public UCSDK_NOTICE_CHARGE_REQ(){
	}

	public UCSDK_NOTICE_CHARGE_REQ(long seqNum,String channel,String os,String orderId){
		this.seqNum = seqNum;
	...
	public UCSDK_NOTICE_CHARGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "UCSDK_NOTICE_CHARGE_REQ";
	}
