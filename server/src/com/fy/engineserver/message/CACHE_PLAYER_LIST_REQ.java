 ...
 * </table>
 */
public class CACHE_PLAYER_LIST_REQ implements RequestMessage{
	...
	public CACHE_PLAYER_LIST_REQ(long seqNum,int start,int len){
		this.seqNum = seqNum;
		this.start = start;
		this.len = len;
	}

	public CACHE_PLAYER_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
