 ...
 * </table>
 */
public class CHARGE_LIST_REQ implements RequestMessage{
	...
	public CHARGE_LIST_REQ(){
	}

	public CHARGE_LIST_REQ(long seqNum,String channel){
		this.seqNum = seqNum;
		this.channel = channel;
	}

	public CHARGE_LIST_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
