 ...
 * </table>
 */
public class BOOTH_FIRST_PAGE_REQ implements RequestMessage{
	...
	public BOOTH_FIRST_PAGE_REQ(){
	}

	public BOOTH_FIRST_PAGE_REQ(long seqNum,int billboardType){
		this.seqNum = seqNum;
		this.billboardType = billboardType;
	}

	public BOOTH_FIRST_PAGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
