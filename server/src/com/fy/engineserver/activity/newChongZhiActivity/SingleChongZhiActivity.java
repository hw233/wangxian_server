...
/**
 * 单笔充值，玩家单笔充值金额是设定金额的多少倍，给多少次奖励
 */
public class SingleChongZhiActivity extends NewMoneyActivity {
	...
	public SingleChongZhiActivity(int configID, String name, int platform,
	...
	public void doActivity(Player player, long yinzi) {
		try{
			...
			logger.warn("[单笔冲] {} [{}] [{}]", new Object[]{getLogString(), player.getLogString(), yinzi});
		}catch(Exception e) {
			logger.error("单笔 doActivity", e);
		}
	}
