 ...
 *
 */
public class BillXiaoFeiBoardActivity extends NewXiaoFeiActivity {
	
	public static String DISK_CATCH = "paihangXiaoFei";
	public HashMap<Long, Long> playerMoneys = new HashMap<Long, Long>();
	public static String DISK_CATCH_1 = "paihangXiaoFeiAAA";
	...
	public BillXiaoFeiBoardActivity(int configID, int[] xt, String name, int platform,
	...
	public void creatParameter(String[] parameters) {
		try {//金额
			...
			logger.error("排行creatParameter", e);
		}
	}
