 ...
 *	首消 消费活动
 */
public class FirstXiaoFeiActivity extends NewXiaoFeiActivity {

	public static String DISK_KEY = "shouxiaofei";
	...
	public FirstXiaoFeiActivity(int configID, int[] xiaofeiType, String name,
	...
	public void sendReward(Player player) {
		try{
			...
			logger.warn("[首消得奖] {} [{}] [{}]", new Object[]{getLogString(), player.getLogString()});
		}catch(Exception e) {
			logger.error("首消发奖出错", e);
		}
	}
	...
	public void loadDiskCache() {
		try{
			...
			logger.error("首消 loadDiskCache", e);
		}
	}
