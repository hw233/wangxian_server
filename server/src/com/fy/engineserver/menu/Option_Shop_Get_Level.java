 ...
 * 
 */
public class Option_Shop_Get_Level extends Option implements NeedCheckPurview,
	...
	public boolean canSee(Player player) {
		...
		if (level == null || "".equals(level.trim())) {// 无时间限制
			rightLevel = true;
		} else {
			if (player.getLevel()>=Integer.valueOf(level)) {
				rightLevel = true ;
			}
		}
		

		return rightChannel && rightTime && rightLevel;
	}
