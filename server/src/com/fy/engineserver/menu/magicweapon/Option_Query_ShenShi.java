...
public class Option_Query_ShenShi extends Option {
	...
	public void doSelect(Game game, Player player) {
		if(game!=null && player!=null){
			OPEN_MAGICWEAPON_OPTION_RES res = new OPEN_MAGICWEAPON_OPTION_RES(GameMessageFactory.nextSequnceNum(),0,new String[0]);
