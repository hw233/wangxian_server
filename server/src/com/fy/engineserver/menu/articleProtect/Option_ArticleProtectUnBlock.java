...
public class Option_ArticleProtectUnBlock extends Option {
	...
	public Option_ArticleProtectUnBlock() {}
	...
	public void doSelect(Game game, Player player) {
		ArticleProtectManager.instance.option_unBlock(player, entityID, entityIndex, propID, propIndex);
	}
