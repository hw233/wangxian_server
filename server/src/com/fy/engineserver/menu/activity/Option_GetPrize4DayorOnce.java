 ...
 *
 */
public class Option_GetPrize4DayorOnce extends Option implements NeedCheckPurview , MConsole,NeedInitialiseOption{
...
//	private String[] articlenames;
	...
	private String mailcount=Translate.背包已满;
	@ChangeAble("背包满提示") 
	...
	public void doPrice(Game game, Player player,DefaultDiskCache ddc){
		...
		if(ae!=null){
			...
			if(issucc){
				...
				player.sendError(Translate.恭喜您获得了奖励);
			}
		}
	}
