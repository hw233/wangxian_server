...
public class Option_LingQuFanLi extends Option implements NeedCheckPurview {

	public Option_LingQuFanLi() {}
...
//		ChongZhiActivity.getInstance().option_FanLi_LinQu(player);
	}
