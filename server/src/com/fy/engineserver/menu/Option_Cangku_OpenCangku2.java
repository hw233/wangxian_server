...
import com.fy.engineserver.message.NEW_WAREHOUSE_INPUT_PASSWORD_RES;
 ...
 *
 */
public class Option_Cangku_OpenCangku2 extends Option{
	...
	public void doSelect(Game game,Player player){
		...
		if(player.getCangkuPassword() == null || player.getCangkuPassword().trim().equals("")){
			...
			NEW_WAREHOUSE_INPUT_PASSWORD_RES res = new NEW_WAREHOUSE_INPUT_PASSWORD_RES(GameMessageFactory.nextSequnceNum(), 6, description);
