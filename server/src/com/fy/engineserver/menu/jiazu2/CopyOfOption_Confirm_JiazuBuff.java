...
public class CopyOfOption_Confirm_JiazuBuff extends Option {
	...
	public void doSelect(Game game, Player player) {
		...
		try {
			...
			if (JiazuManager2.logger.isWarnEnabled()) {
				JiazuManager2.logger.warn(player.getJiazuLogString() + "[降级驻地建筑] [确认] [成功] [{}] [当前等级:{}]", new Object[] { getTemplate().getName(), getTemplate().getTypeIndex() });
			}
