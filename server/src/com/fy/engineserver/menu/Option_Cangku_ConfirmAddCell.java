 ...
 *
 */
public class Option_Cangku_ConfirmAddCell extends Option{
	...
	public void doSelect(Game game,Player player){
		...
		if(remove != null){
			...
			player.getKnapsacks_cangku().addCells(Player.每次增加格子数量);
			HINT_REQ hreq = new HINT_REQ(GameMessageFactory.nextSequnceNum(), (byte)0, Translate.translateString(Translate.增加仓库格子成功,new String[][]{{Translate.COUNT_1,player.getKnapsacks_cangku().getCells().length+""}}));
			player.addMessageToRightBag(hreq);
