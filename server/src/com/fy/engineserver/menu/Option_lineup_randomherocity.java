...
public class Option_lineup_randomherocity extends Option {
	
	public Option_lineup_randomherocity() {
	...
	public void doSelect(Game game, Player player) {
		...
		List<DownCityInfo> dcis = lum.getPlayerCanEnterRandomHeroCities(player);
		if(dcis == null) {
			return;
		}
	...
	public int getOId() {
		return OptionConstants.SERVER_FUNCTION_排队进入勇士副本选择副本;
	}
