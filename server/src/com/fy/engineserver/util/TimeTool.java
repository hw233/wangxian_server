...
public enum TimeTool {
	...
	public enum TimeDistance {
		MILLISECOND(1L, Translate.text_4626),//毫秒
		SECOND(1000L, Translate.text_6344),//秒
		MINUTE(SECOND.getTimeMillis() * 60, Translate.分钟),
		HOUR(MINUTE.getTimeMillis() * 60, Translate.小时),
		DAY(HOUR.getTimeMillis() * 24, Translate.text_jiazu_114),//天
		WEEK(DAY.getTimeMillis() * 7, Translate.周), ;
