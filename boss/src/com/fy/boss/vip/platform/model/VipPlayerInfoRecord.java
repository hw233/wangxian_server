...
@SimpleEntity(name="VipPlayerInfoRecord")
@SimpleIndices({
	@SimpleIndex(members={"username"},name="INDX_USERNAME"),
	@SimpleIndex(members={"createTime"},name="INDX_CREATETIME"),
	@SimpleIndex(members={"realname"},name="INDX_REALNAME"),
	@SimpleIndex(members={"platform"},name="INDX_PLATFORM"),
	@SimpleIndex(members={"serverName"},name="INDX_SERVERNAME"),
	@SimpleIndex(members={"playerName"},name="INDX_PLAYERNAME"),
	@SimpleIndex(members={"vipLevel"},name="INDX_VIPLEVEL"),
	@SimpleIndex(members={"playerLevel"},name="INDX_PLAYERLEVEL"),
	@SimpleIndex(members={"auditor"},name="INDX_AUDITOR"),
	@SimpleIndex(members={"operator"},name="INDX_OPERATOR")
})
public class VipPlayerInfoRecord {
	// Fields
	@SimpleId
	private long id;
