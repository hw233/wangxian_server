 ...
 * </table>
 */
public class FILE_PACKET_RES implements ResponseMessage{
	...
	public FILE_PACKET_RES(long seqNum,String[] result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public FILE_PACKET_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
