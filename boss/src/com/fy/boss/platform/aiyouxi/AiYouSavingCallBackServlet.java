...
public class AiYouSavingCallBackServlet extends HttpServlet {
	
	public static String validateIp = "202.102.39.*";
	public static String appkey = "4128b6e381f0fc3d3f733b45f8ab1411";
	...
	{
		String serialno = ParamUtils.getParameter(req, "serialno", "");
		...
		if(!StringUtils.isEmpty(serialno))
		{
			try
			{
				...
				String channelorderid = ParamUtils.getParameter(req, "serialno", "");
				String code = ParamUtils.getParameter(req, "resultCode", "");
				String msg = ParamUtils.getParameter(req, "resultMsg", "");
				String orderId = ParamUtils.getParameter(req, "gameUserId", "");
				String rmb = ParamUtils.getParameter(req, "gameGold", "");
				...
				String md5pre = (channelorderid+orderId);
					...
					if(orderForm != null)
					{
						...
						synchronized(orderForm) {
							if(orderForm.getResponseResult() != OrderForm.RESPONSE_NOBACK) {
								...
								res.setHeader("serialno",channelorderid);
								return;
							}
							String mess = "成功";
							//更新订单
			...
			catch(Exception e)
			{
				...
				res.setHeader("serialno", ParamUtils.getParameter(req, "serialno", ""));
				return;
