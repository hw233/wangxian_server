...
public class _553SavingManager {

	protected static _553SavingManager m_self = null;
	 ...
	 * @return
	 */
	public String _553SdkSaving(Passport passport, String channel, String servername, int addAmount, String os) {
		long t = System.currentTimeMillis();

		String medinfo = "充值额:" + addAmount;
		String mediumName = "番茄SDK充值";
		...
		try {
			...
			long id = order.getId();
			String orderID = "553-"  + DateUtil.formatDate(cdate, "yyyyMMddHH") + "-" + id;
			...
			PlatformSavingCenter.logger.info("[充值调用] [产生订单失败] [支付平台:553] [方式:" + mediumName + "] [用户:" + passport.getUserName() + "] [amount:" + addAmount
					+ "分] [订单号:-----]", e);
		}
		return "";
	}
	...
	public String _553SdkSaving(Passport passport, String channel, String servername, int addAmount, String os,String[]others) {
		long t = System.currentTimeMillis();
	...
	public static _553SavingManager getInstance() {
		if(m_self == null)
		{
			m_self = new _553SavingManager();
		}
		return m_self;
	}
}
