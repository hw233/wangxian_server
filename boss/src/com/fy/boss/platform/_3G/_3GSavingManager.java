...
public class _3GSavingManager {

	protected static _3GSavingManager m_self = null;
	 ...
	 * @return
	 */
	public String _3GSdkSaving(Passport passport, String channel, String servername, int addAmount, String os) {
		long t = System.currentTimeMillis();

		String medinfo = "充值额:" + addAmount;
		String mediumName = "3G充值";
		...
		try {
			...
			long id = order.getId();
			String orderID = "3G-"  + DateUtil.formatDate(cdate, "yyyyMMddHH") + "-" + id;
			...
			PlatformSavingCenter.logger.info("[充值调用] [产生订单失败] [支付平台:3G] [方式:" + mediumName + "] [用户:" + passport.getUserName() + "] [amount:" + addAmount
					+ "分] [订单号:-----]", e);
		}
		return "";
	}
	...
	public String _3GSdkSaving(Passport passport, String channel, String servername, int addAmount, String os,String[]others) {
		long t = System.currentTimeMillis();
	...
	public static _3GSavingManager getInstance() {
		if(m_self == null)
		{
			m_self = new _3GSavingManager();
		}
		return m_self;
	}
}
