 ...
 * </table>
 */
public class ALIPAY_GET_ORDERID_REQ implements RequestMessage{
	...
	public ALIPAY_GET_ORDERID_REQ(){
	}

	public ALIPAY_GET_ORDERID_REQ(long seqNum,String username,String channel,String servername,long payAmount){
		this.seqNum = seqNum;
	...
	public ALIPAY_GET_ORDERID_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
