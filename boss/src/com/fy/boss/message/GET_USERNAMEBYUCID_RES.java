 ...
 * </table>
 */
public class GET_USERNAMEBYUCID_RES implements ResponseMessage{
	...
	public GET_USERNAMEBYUCID_RES(){
	}

	public GET_USERNAMEBYUCID_RES(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public GET_USERNAMEBYUCID_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
