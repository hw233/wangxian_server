 ...
 * </table>
 */
public class NINEONE_SAVING_NEW_REQ implements RequestMessage{
	...
	public NINEONE_SAVING_NEW_REQ(){
	}

	public NINEONE_SAVING_NEW_REQ(long seqNum,String userName,int goodsCount,String payType,String cardNo,String cardPassword,int payAmount,String serverName,String channel,String mobileOs,String[] others){
		this.seqNum = seqNum;
	...
	public NINEONE_SAVING_NEW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
