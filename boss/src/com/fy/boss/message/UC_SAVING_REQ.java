 ...
 * </table>
 */
public class UC_SAVING_REQ implements RequestMessage{
	...
	public UC_SAVING_REQ(long seqNum,String uid,int goodsCount,String payType,String cardNo,String cardPassword,int payAmount,String serverName,String channel,String mobileOs){
		this.seqNum = seqNum;
		this.uid = uid;
	...
	public UC_SAVING_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
