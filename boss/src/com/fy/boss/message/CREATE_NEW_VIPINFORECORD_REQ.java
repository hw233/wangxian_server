 ...
 * </table>
 */
public class CREATE_NEW_VIPINFORECORD_REQ implements RequestMessage{
	...
	public CREATE_NEW_VIPINFORECORD_REQ(){
	}

	public CREATE_NEW_VIPINFORECORD_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public CREATE_NEW_VIPINFORECORD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CREATE_NEW_VIPINFORECORD_REQ";
	}
