 ...
 * </table>
 */
public class MODIFY_QUESTION_GET_REQ implements RequestMessage{
	...
	public MODIFY_QUESTION_GET_REQ(long seqNum,String username,String oldquestion,String oldanswer,String newquestion,String newanswer){
		this.seqNum = seqNum;
	...
	public MODIFY_QUESTION_GET_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "MODIFY_QUESTION_GET_REQ";
	}
