 ...
 * </table>
 */
public class PASSPORT_GET_REQ implements RequestMessage{
	...
	public PASSPORT_GET_REQ(){
	}

	public PASSPORT_GET_REQ(long seqNum,long id){
		this.seqNum = seqNum;
		this.id = id;
	}

	public PASSPORT_GET_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
