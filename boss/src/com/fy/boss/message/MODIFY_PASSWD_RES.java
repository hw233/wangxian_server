 ...
 * </table>
 */
public class MODIFY_PASSWD_RES implements ResponseMessage{
	...
	public MODIFY_PASSWD_RES(long seqNum,boolean isOk){
		this.seqNum = seqNum;
		this.isOk = isOk;
	}

	public MODIFY_PASSWD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
