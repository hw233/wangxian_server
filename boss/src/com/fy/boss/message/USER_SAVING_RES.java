 ...
 * </table>
 */
public class USER_SAVING_RES implements ResponseMessage{
	...
	public USER_SAVING_RES(){
	}

	public USER_SAVING_RES(long seqNum,byte result,String failreason){
		this.seqNum = seqNum;
		this.result = result;
		this.failreason = failreason;
	}

	public USER_SAVING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
