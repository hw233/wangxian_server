...
public class MORE_ARGS_ORDER_STATUS_CHANGE_REQ implements RequestMessage{
	...
	public MORE_ARGS_ORDER_STATUS_CHANGE_REQ(long seqNum,String orderId,String channel,String status,String statusDesp,String zoneid,String pfkey,String pay_token,String[] args){
		this.seqNum = seqNum;
