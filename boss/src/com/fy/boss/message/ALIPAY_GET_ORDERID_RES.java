 ...
 * </table>
 */
public class ALIPAY_GET_ORDERID_RES implements ResponseMessage{
	...
	public ALIPAY_GET_ORDERID_RES(){
	}

	public ALIPAY_GET_ORDERID_RES(long seqNum,String orderId,String orderInfo,String publicKey){
		this.seqNum = seqNum;
	...
	public ALIPAY_GET_ORDERID_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
