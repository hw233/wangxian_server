 ...
 * </table>
 */
public class GET_UCIDBYUSERNAME_REQ implements RequestMessage{
	...
	public GET_UCIDBYUSERNAME_REQ(){
	}

	public GET_UCIDBYUSERNAME_REQ(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public GET_UCIDBYUSERNAME_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
