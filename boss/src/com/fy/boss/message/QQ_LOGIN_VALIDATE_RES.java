 ...
 * </table>
 */
public class QQ_LOGIN_VALIDATE_RES implements ResponseMessage{
	...
	public QQ_LOGIN_VALIDATE_RES(){
	}

	public QQ_LOGIN_VALIDATE_RES(long seqNum,byte result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public QQ_LOGIN_VALIDATE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
