 ...
 * </table>
 */
public class APPSTORE_RECEIPT_RES implements ResponseMessage{
	...
	public APPSTORE_RECEIPT_RES(){
	}

	public APPSTORE_RECEIPT_RES(long seqNum,int result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public APPSTORE_RECEIPT_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
