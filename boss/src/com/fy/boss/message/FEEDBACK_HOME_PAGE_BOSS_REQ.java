 ...
 * </table>
 */
public class FEEDBACK_HOME_PAGE_BOSS_REQ implements RequestMessage{
	...
	public FEEDBACK_HOME_PAGE_BOSS_REQ(){
	}

	public FEEDBACK_HOME_PAGE_BOSS_REQ(long seqNum,String username,String playername,int viplevel){
		this.seqNum = seqNum;
	...
	public FEEDBACK_HOME_PAGE_BOSS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "FEEDBACK_HOME_PAGE_BOSS_REQ";
	}
