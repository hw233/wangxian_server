 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>payAmount</td><td>long</td><td>8个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class ALIPAY_GET_ORDERID_NEW_REQ implements RequestMessage{
	...
	public ALIPAY_GET_ORDERID_NEW_REQ(){
	}

	public ALIPAY_GET_ORDERID_NEW_REQ(long seqNum,String username,String channel,String servername,long payAmount,String[] others){
		this.seqNum = seqNum;
	...
	public ALIPAY_GET_ORDERID_NEW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
		...
		offset += len;
		payAmount = (long)mf.byteArrayToNumber(content,offset,8);
		offset += 8;
	...
	public String getTypeDescription() {
		return "ALIPAY_GET_ORDERID_NEW_REQ";
	}
