 ...
 * </table>
 */
public class APPSTORE_RECEIPT_REQ implements RequestMessage{
	...
	public APPSTORE_RECEIPT_REQ(){
	}

	public APPSTORE_RECEIPT_REQ(long seqNum,String username,String channel,String servername,String receipt,String deviceCode){
		this.seqNum = seqNum;
	...
	public APPSTORE_RECEIPT_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
