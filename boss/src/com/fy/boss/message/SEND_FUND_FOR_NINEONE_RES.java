 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>sum</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 ...
 * </table>
 */
public class SEND_FUND_FOR_NINEONE_RES implements ResponseMessage{
	...
	public SEND_FUND_FOR_NINEONE_RES(){
	}

	public SEND_FUND_FOR_NINEONE_RES(long seqNum,int sum,int result,String description){
		this.seqNum = seqNum;
		this.sum = sum;
		this.result = result;
	...
	public SEND_FUND_FOR_NINEONE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		sum = (int)mf.byteArrayToNumber(content,offset,4);
		offset += 4;
	...
	public String getTypeDescription() {
		return "SEND_FUND_FOR_NINEONE_RES";
	}
