 ...
 * </table>
 */
public class MIGU_COMMUNICATE_RES implements ResponseMessage{
	...
	public MIGU_COMMUNICATE_RES(){
	}

	public MIGU_COMMUNICATE_RES(long seqNum,String[] result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public MIGU_COMMUNICATE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
