 ...
 * </table>
 */
public class QQ_SAVING_RES implements ResponseMessage{
	...
	public QQ_SAVING_RES(){
	}

	public QQ_SAVING_RES(long seqNum,String orderId,byte result,String desc){
		this.seqNum = seqNum;
	...
	public QQ_SAVING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
