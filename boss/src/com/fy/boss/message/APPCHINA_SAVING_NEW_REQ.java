 ...
 * </table>
 */
public class APPCHINA_SAVING_NEW_REQ implements RequestMessage{
	...
	public APPCHINA_SAVING_NEW_REQ(){
	}

	public APPCHINA_SAVING_NEW_REQ(long seqNum,String userName,int goodsCount,String payType,String cardNo,String cardPassword,int payAmount,String serverName,String channel,String mobileOs,String[] others){
		this.seqNum = seqNum;
	...
	public APPCHINA_SAVING_NEW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "APPCHINA_SAVING_NEW_REQ";
	}
