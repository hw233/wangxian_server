 ...
 * </table>
 */
public class CREATE_UC_VID_MAIL_SEND_RECORD_RES implements ResponseMessage{
	...
	public CREATE_UC_VID_MAIL_SEND_RECORD_RES(){
	}

	public CREATE_UC_VID_MAIL_SEND_RECORD_RES(long seqNum,String[] result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public CREATE_UC_VID_MAIL_SEND_RECORD_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CREATE_UC_VID_MAIL_SEND_RECORD_RES";
	}
