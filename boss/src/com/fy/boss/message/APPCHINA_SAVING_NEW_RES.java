 ...
 * </table>
 */
public class APPCHINA_SAVING_NEW_RES implements ResponseMessage{
	...
	public APPCHINA_SAVING_NEW_RES(){
	}

	public APPCHINA_SAVING_NEW_RES(long seqNum,String orderId,byte result,String desc){
		this.seqNum = seqNum;
	...
	public APPCHINA_SAVING_NEW_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "APPCHINA_SAVING_NEW_RES";
	}
