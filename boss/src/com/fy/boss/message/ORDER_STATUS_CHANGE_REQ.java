 ...
 * </table>
 */
public class ORDER_STATUS_CHANGE_REQ implements RequestMessage{
	...
	public ORDER_STATUS_CHANGE_REQ(){
	}

	public ORDER_STATUS_CHANGE_REQ(long seqNum,String orderId,String channel,String status,String statusDesp){
		this.seqNum = seqNum;
	...
	public ORDER_STATUS_CHANGE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "ORDER_STATUS_CHANGE_REQ";
	}
