 ...
 * </table>
 */
public class CAN_SEND_UC_VID_MAIL_REQ implements RequestMessage{
	...
	public CAN_SEND_UC_VID_MAIL_REQ(){
	}

	public CAN_SEND_UC_VID_MAIL_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public CAN_SEND_UC_VID_MAIL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CAN_SEND_UC_VID_MAIL_REQ";
	}
