 ...
 * </table>
 */
public class MORE_ARGS_ORDER_STATUS_CHANGE_RES implements ResponseMessage{
	...
	public MORE_ARGS_ORDER_STATUS_CHANGE_RES(){
	}

	public MORE_ARGS_ORDER_STATUS_CHANGE_RES(long seqNum,String result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public MORE_ARGS_ORDER_STATUS_CHANGE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "MORE_ARGS_ORDER_STATUS_CHANGE_RES";
	}
