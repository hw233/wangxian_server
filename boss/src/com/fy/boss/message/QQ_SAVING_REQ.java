 ...
 * </table>
 */
public class QQ_SAVING_REQ implements RequestMessage{
	...
	public QQ_SAVING_REQ(){
	}

	public QQ_SAVING_REQ(long seqNum,String uid,int goodcount,String savingType,String serverName){
		this.seqNum = seqNum;
		this.uid = uid;
	...
	public QQ_SAVING_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
