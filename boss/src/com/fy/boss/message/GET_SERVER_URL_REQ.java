 ...
 * </table>
 */
public class GET_SERVER_URL_REQ implements RequestMessage{
	...
	public GET_SERVER_URL_REQ(){
	}

	public GET_SERVER_URL_REQ(long seqNum,String servername){
		this.seqNum = seqNum;
		this.servername = servername;
	}

	public GET_SERVER_URL_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
