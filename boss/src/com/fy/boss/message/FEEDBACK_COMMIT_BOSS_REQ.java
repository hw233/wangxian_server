 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>viplevel</td><td>int</td><td>4个字节</td><td>配置的长度</td></tr>
 * </table>
 */
public class FEEDBACK_COMMIT_BOSS_REQ implements RequestMessage{
	...
	public FEEDBACK_COMMIT_BOSS_REQ(){
	}

	public FEEDBACK_COMMIT_BOSS_REQ(long seqNum,String username,String playername,String servername,int viplevel){
		this.seqNum = seqNum;
	...
	public FEEDBACK_COMMIT_BOSS_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "FEEDBACK_COMMIT_BOSS_REQ";
	}
