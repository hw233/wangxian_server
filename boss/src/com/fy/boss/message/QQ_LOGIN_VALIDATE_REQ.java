 ...
 * </table>
 */
public class QQ_LOGIN_VALIDATE_REQ implements RequestMessage{
	...
	public QQ_LOGIN_VALIDATE_REQ(){
	}

	public QQ_LOGIN_VALIDATE_REQ(long seqNum,String uid,String sessionId){
		this.seqNum = seqNum;
		this.uid = uid;
		this.sessionId = sessionId;
	}

	public QQ_LOGIN_VALIDATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
