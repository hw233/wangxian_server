 ...
 * </table>
 */
public class CHANNEL_UER_SAVING_RES implements ResponseMessage{
	...
	public CHANNEL_UER_SAVING_RES(){
	}

	public CHANNEL_UER_SAVING_RES(long seqNum,byte result,String desc){
		this.seqNum = seqNum;
		this.result = result;
		this.desc = desc;
	}

	public CHANNEL_UER_SAVING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
