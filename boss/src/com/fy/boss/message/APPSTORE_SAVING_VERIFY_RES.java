 ...
 * </table>
 */
public class APPSTORE_SAVING_VERIFY_RES implements ResponseMessage{
	...
	public APPSTORE_SAVING_VERIFY_RES(){
	}

	public APPSTORE_SAVING_VERIFY_RES(long seqNum,int result,String description){
		this.seqNum = seqNum;
		this.result = result;
		this.description = description;
	}

	public APPSTORE_SAVING_VERIFY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "APPSTORE_SAVING_VERIFY_RES";
	}
