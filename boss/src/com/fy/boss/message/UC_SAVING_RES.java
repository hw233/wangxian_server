 ...
 * </table>
 */
public class UC_SAVING_RES implements ResponseMessage{
	...
	public UC_SAVING_RES(long seqNum,byte result,String desc){
		this.seqNum = seqNum;
		this.result = result;
		this.desc = desc;
	}

	public UC_SAVING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
