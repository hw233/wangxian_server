 ...
 * </table>
 */
public class FEEDBACK_LOOK_BOSS_RES implements ResponseMessage{
	...
	public FEEDBACK_LOOK_BOSS_RES(){
	}

	public FEEDBACK_LOOK_BOSS_RES(long seqNum,long id,String resultMess,byte result,GmTalk[] talk){
		this.seqNum = seqNum;
		this.id = id;
	...
	public FEEDBACK_LOOK_BOSS_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
