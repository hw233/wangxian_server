 ...
 * </table>
 */
public class NINEONE_SAVING_RES implements ResponseMessage{
	...
	public NINEONE_SAVING_RES(){
	}

	public NINEONE_SAVING_RES(long seqNum,String orderId,byte result,String desc){
		this.seqNum = seqNum;
	...
	public NINEONE_SAVING_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
