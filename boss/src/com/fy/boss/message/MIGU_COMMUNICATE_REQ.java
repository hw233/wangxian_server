 ...
 * </table>
 */
public class MIGU_COMMUNICATE_REQ implements RequestMessage{
	...
	public MIGU_COMMUNICATE_REQ(){
	}

	public MIGU_COMMUNICATE_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public MIGU_COMMUNICATE_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
