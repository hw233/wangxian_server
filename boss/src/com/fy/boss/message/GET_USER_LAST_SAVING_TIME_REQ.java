 ...
 * </table>
 */
public class GET_USER_LAST_SAVING_TIME_REQ implements RequestMessage{
	...
	public GET_USER_LAST_SAVING_TIME_REQ(){
	}

	public GET_USER_LAST_SAVING_TIME_REQ(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public GET_USER_LAST_SAVING_TIME_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "GET_USER_LAST_SAVING_TIME_REQ";
	}
