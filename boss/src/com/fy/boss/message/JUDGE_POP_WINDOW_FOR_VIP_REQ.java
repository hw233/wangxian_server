 ...
 * </table>
 */
public class JUDGE_POP_WINDOW_FOR_VIP_REQ implements RequestMessage{
	...
	public JUDGE_POP_WINDOW_FOR_VIP_REQ(){
	}

	public JUDGE_POP_WINDOW_FOR_VIP_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public JUDGE_POP_WINDOW_FOR_VIP_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "JUDGE_POP_WINDOW_FOR_VIP_REQ";
	}
