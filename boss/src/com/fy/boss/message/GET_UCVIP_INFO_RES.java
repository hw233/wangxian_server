 ...
 * </table>
 */
public class GET_UCVIP_INFO_RES implements ResponseMessage{
	...
	public GET_UCVIP_INFO_RES(){
	}

	public GET_UCVIP_INFO_RES(long seqNum,String[] result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public GET_UCVIP_INFO_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
