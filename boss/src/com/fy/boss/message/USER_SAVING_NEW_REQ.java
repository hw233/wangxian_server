 ...
 * </table>
 */
public class USER_SAVING_NEW_REQ implements RequestMessage{
	...
	public USER_SAVING_NEW_REQ(){
	}

	public USER_SAVING_NEW_REQ(long seqNum,String username,String playername,String servername,String channel,String os,String cardtype,String cardno,String cardpass,int mianzhi,int goodsType,int amount,String orderID,String[] others){
		this.seqNum = seqNum;
	...
	public USER_SAVING_NEW_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
