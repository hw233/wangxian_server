 ...
 * </table>
 */
public class PASSPORT_UPDATE_RES2 implements ResponseMessage{
	...
	public PASSPORT_UPDATE_RES2(){
	}

	public PASSPORT_UPDATE_RES2(long seqNum,byte result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public PASSPORT_UPDATE_RES2(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
