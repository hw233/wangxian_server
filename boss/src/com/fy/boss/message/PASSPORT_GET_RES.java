 ...
 * <tr bgcolor="#FAFAFA" align="center"><td>ucPassword.length</td><td>short</td><td>2个字节</td><td>字符串实际长度</td></tr>
 * <tr bgcolor="#FFFFFF" align="center"><td>ucPassword</td><td>String</td><td>ucPassword.length</td><td>字符串对应的byte数组</td></tr>
 ...
 * </table>
 */
public class PASSPORT_GET_RES implements ResponseMessage{
	...
	public PASSPORT_GET_RES(){
	}

	public PASSPORT_GET_RES(long seqNum,long passportid,String registerClientId,String username,String passwd,String nickName,String fromWhere,long registerDate,long lastLoginDate,String registerChannel,String lastLoginChannel,String lastLoginIp,String lastLoginClientId,String registerMobile,String registerMobileOs,String lastLoginMobileOs,String registerMobileType,String lastLoginMobileType,String registerNetworkMode,String lastLoginNetworkMode,long totalChargeAmount,long lastChargeDate,long lastChargeAmount,String lastChargeChannel,String secretQuestion,String secretAnswer,long lastQuestionSetDate,boolean isSetSecretQuestion,int status,long lastUpdateStatusDate,String ucPassword,byte result,String description){
		this.seqNum = seqNum;
	...
	public PASSPORT_GET_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
