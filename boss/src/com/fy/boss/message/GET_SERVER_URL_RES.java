 ...
 * </table>
 */
public class GET_SERVER_URL_RES implements ResponseMessage{
	...
	public GET_SERVER_URL_RES(){
	}

	public GET_SERVER_URL_RES(long seqNum,String url){
		this.seqNum = seqNum;
		this.url = url;
	}

	public GET_SERVER_URL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
