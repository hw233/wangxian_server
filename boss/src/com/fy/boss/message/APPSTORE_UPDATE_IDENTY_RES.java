 ...
 * </table>
 */
public class APPSTORE_UPDATE_IDENTY_RES implements ResponseMessage{
	...
	public APPSTORE_UPDATE_IDENTY_RES(){
	}

	public APPSTORE_UPDATE_IDENTY_RES(long seqNum,boolean isOk,byte result,String description){
		this.seqNum = seqNum;
		this.isOk = isOk;
		this.result = result;
	...
	public APPSTORE_UPDATE_IDENTY_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
	...
	public String getTypeDescription() {
		return "APPSTORE_UPDATE_IDENTY_RES";
	}
