 ...
 * </table>
 */
public class PASSPORT_GET_REQ2 implements RequestMessage{
	...
	public PASSPORT_GET_REQ2(){
	}

	public PASSPORT_GET_REQ2(long seqNum,String username){
		this.seqNum = seqNum;
		this.username = username;
	}

	public PASSPORT_GET_REQ2(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
