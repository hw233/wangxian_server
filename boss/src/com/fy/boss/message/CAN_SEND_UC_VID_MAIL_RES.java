 ...
 * </table>
 */
public class CAN_SEND_UC_VID_MAIL_RES implements ResponseMessage{
	...
	public CAN_SEND_UC_VID_MAIL_RES(){
	}

	public CAN_SEND_UC_VID_MAIL_RES(long seqNum,String[] result){
		this.seqNum = seqNum;
		this.result = result;
	}

	public CAN_SEND_UC_VID_MAIL_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CAN_SEND_UC_VID_MAIL_RES";
	}
