 ...
 * </table>
 */
public class CREATE_UC_VID_MAIL_SEND_RECORD_REQ implements RequestMessage{
	...
	public CREATE_UC_VID_MAIL_SEND_RECORD_REQ(){
	}

	public CREATE_UC_VID_MAIL_SEND_RECORD_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public CREATE_UC_VID_MAIL_SEND_RECORD_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
	...
	public String getTypeDescription() {
		return "CREATE_UC_VID_MAIL_SEND_RECORD_REQ";
	}
