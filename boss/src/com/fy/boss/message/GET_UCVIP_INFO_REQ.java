 ...
 * </table>
 */
public class GET_UCVIP_INFO_REQ implements RequestMessage{
	...
	public GET_UCVIP_INFO_REQ(){
	}

	public GET_UCVIP_INFO_REQ(long seqNum,String[] infos){
		this.seqNum = seqNum;
		this.infos = infos;
	}

	public GET_UCVIP_INFO_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
