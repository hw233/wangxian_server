 ...
 * </table>
 */
public class APPCHINA_SAVING_REQ implements RequestMessage{
	...
	public APPCHINA_SAVING_REQ(){
	}

	public APPCHINA_SAVING_REQ(long seqNum,String userName,int goodsCount,String payType,String cardNo,String cardPassword,int payAmount,String serverName,String channel,String mobileOs){
		this.seqNum = seqNum;
	...
	public APPCHINA_SAVING_REQ(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
		int len = 0;
