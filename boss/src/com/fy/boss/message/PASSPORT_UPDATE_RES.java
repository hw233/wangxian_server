 ...
 * </table>
 */
public class PASSPORT_UPDATE_RES implements ResponseMessage{
	...
	public PASSPORT_UPDATE_RES(){
	}

	public PASSPORT_UPDATE_RES(long seqNum,boolean isOk,byte result,String description){
		this.seqNum = seqNum;
		this.isOk = isOk;
		this.result = result;
	...
	public PASSPORT_UPDATE_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
