 ...
 * </table>
 */
public class QUESTION_SET_RES implements ResponseMessage{
	...
	public QUESTION_SET_RES(long seqNum,boolean isOk){
		this.seqNum = seqNum;
		this.isOk = isOk;
	}

	public QUESTION_SET_RES(long seqNum,byte[] content,int offset,int size) throws Exception{
		this.seqNum = seqNum;
