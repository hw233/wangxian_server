<%@page import="com.fy.boss.platform._3G._3GSavingManager"%>
...
<%
	...
	String channel = ParamUtils.getParameter(request, "channel", "3GSDK_MIESHI");
		...
		if(isDo)
		{
			...
			for(String orderinfo : orders)
			{
				...
				if(oss != null && oss.length == 3)
				{
					...
					{
							_3GSavingManager anZhiSavingManager = _3GSavingManager.getInstance();
							...
							String orderid = anZhiSavingManager._3GSdkSaving(pp, channel, server, payAmount,"");
...
<body>
	...
	<input type="hidden" name="isDo" value="true" />
		订单信息(username  payAmount server):<textarea rows="100" cols="100" name="orderinfos" value="<%=orderInfos%>"></textarea><br>
