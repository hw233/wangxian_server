				  ...
				  dataType: "html",
					  ...
					  success: function(result)
					  {
						  if(result.indexOf("true")>0){
							  window.location.replace("NewFeedback_handle.jsp?handle="+gmid+"&startwork=yes");
						  }else{
							  alert("请组长重新设置编号");
						  }
					  }
		...
		if(gmid&&gmname){
			...
			$.ajax({
				  ...
				  dataType: "html",
					  ...
					  {
						  if(result.indexOf("true")>0){
							  window.location.replace("NewFeedback_handle2.jsp?handle="+gmid+"&startwork=yes");
						  }else{
							  alert("请组长重新设置编号");
						  }
					  }
	...
	<table>
		<%
			...
			if (obj != null) {
		 		...
		 		String [] gmnames = {"klgm01","klgm02","klgm03","klgm04","klgm05","klgm05","wenguosi","panju","chentao","wanyu","panzhichao",
		 				...
		 				"wuchun","wuyunpeng","wangbo","chengxiao","lilanlan","wangyongquan","wangzhilei","wangwenbo","zhangzhang","xuchang","wangxin","wangyanan","liwei","wangshuai","wenshiliang","zhouwenyu","changhao","lisongtao","liyan","wangshuo","suli","fulianjie","caozixiang","jiangnan","liuhe","zhanglei","lizhaobo","klgm014","新人06","新人07","新人08","新人09","新人10","hujingjing","wuquancai","nijia","lihui"
		 				,"lizhaobo","gaoyi","cuixuechen","zhangxiao","chenjian","liujian","yaoyuhui","wangzheng","zhoumengfan","zhoumengfan1","fangqiang","zhengtiancheng"};
		 		String [] gmnums = {"GM01","GM02","GM03","GM04","GM05","GM05","GM06","GM08","GM09","GM10","GM11","GM12","GM15","GM17","GM17","GM18",
		 				"GM19","GM20","GM21","GM22","GM23","GM25","GM26","GM27","GM29","GM30","GM31","GM32","GM33","GM34","GM35",
		 				"GM36","GM37","GM39","GM40","GM99","GM98","GM97","GM96","GM95","GM93","GM41","GM42","GM43","GM44","GM24","GM46","GM47","GM48","GM49","GM50"
		 				...
		 				"GM101","GM102","GM103","GM104","GM105","GM48","GM60","GM45","GM57","GM58","GM51","GM991","GM47","GM57","GM55","GM43","GM58","GM91","GM36","GM37","GM32","GM33","GM56","GM57","GM54","GM55","GM35","GM50","GM30","GM26","GM27","GM28","GM86","GM119","GM106","GM107","GM108","GM109","GM110","GM70","GM71","GM60","GM63","GM119","GM20","GM16","GM51","GM22","GM22","GM36","GM121","GM49","GM42","GM123","GM124","gm125"};
