...
<%
	...
	String channel = ParamUtils.getParameter(request, "channel", "ANZHISDK_MIESHI");
		...
		if(isDo)
		{
			...
			for(String orderinfo : orders)
			{
				...
				if(oss != null && oss.length == 3)
				{
					...
					{
							AnZhiSavingManager anZhiSavingManager = AnZhiSavingManager.getInstance();
							...
							String orderid = anZhiSavingManager.cardSaving(pp, "", payAmount, "", "", server, "", "ANZHISDK_MIESHI");
