...
<%!
	...
	页面部门("wangsiyu","panju","wanyu","panzhichao",
				...
				"bianhaibo","niezhigang","sunmenglong",
				"yaotengfei","yangjie","goumeng","liwei","jiaohailiang","jiazhiyu","gepeng","changhao"
				,"shangwei","lisongtao","yangboxiong","zhengtiancheng","cuixuechen","dengshaoyu","limengting","wanglong","dongjunhao","liukai","liuyu","zhangjunchen","chentao","wenguosi","chenxiong","guojing","新人01","新人02","新人03","新人04","新人05","wangbo","chengxiao","zhangzhang","wangwenbo","wenshiliang","wangshuo","suli","fulianjie","lizhaobo","新人06","新人07","新人08","新人09","新人10","wangzheng","zhoumengfan","zhengtiancheng","geyunfei"),
	运营部门("huangqing","zhangjianqin","吉雅泰","chihang","qichongyang","gaoyi"),
	数据部门("liuqing","liyan01","zhangjian","luotao","liuchuan","fangqiang","wangyuxiang","wangzhilei","makang","wuyunpeng","yaoyuan","sufang","chenhao","liushaohua","xiaoyang"),
	米佳("mijia"),
	冰冰("bingbing"),
	刘洋("liuyanga"),
	张建("zhangjian1"),
	张剑琴("zhangjianqin"),
	VIP部门("liuyanga","liutao","yaoyuhui","fanlei","chenhongyuan","tanghaiping","liuhe","wangshuai","zhouwenyu","zhanglei","xuchang","hujingjing","liujian","jiangnan","wuquancai","jingtailong"),
